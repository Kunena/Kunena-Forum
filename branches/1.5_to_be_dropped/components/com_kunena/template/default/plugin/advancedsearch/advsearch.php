                                        ...
                                        <tr>
                                            <td>
                                                <select name = "titleonly">
                                                    <option value = "0" selected = "selected">B�t�n Mesajlarda ara</option>

                                                    <option value = "1">Mesaj ba�l�klar�nda ara</option>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <select name = "starteronly">
                                                    <option value = "0" selected = "selected">Kullan�c�n�n Mesajlar�n� ara</option>

                                                    <option value = "1">Kullan�c�n�n Konular�n� ara</option>
                                                </select>
                                            </td>
                                        ...
                                        <fieldset class = "fieldset">
                                            ...
                                            <div style = "padding:3px">
                                                <select name = "searchdate" style = "width:150px">
                                                    ...
                                                    <option value = "1">D�n</option>

                                                    <option value = "7">son Haftadan</option>

                                                    <option value = "14">2 Hafta �nce</option>
                                        ...
                                        <fieldset class = "fieldset">
                                            ...
                                            <div style = "padding:3px">
                                                <select name = "sortby" style = "width:150px">
                                                    <option value = "title">Ba�l�k</option>

                                                    <option value = "replycount">Cevap say�s�na g�re</option>

                                                    <option value = "views">G�r�nt�leme say�s�na g�re</option>

                                                    <option value = "threadstart">Konu Tarihine</option>

                                                    <option value = "lastpost" selected = "selected">son Mesaj</option>

                                                    <option value = "postusername">Kullan�c� ismi</option>

                                                    <option value = "forum">Forum</option>
                                                </select>

                                                <select name = "order">
                                                    <option value = "descending" selected = "selected">Azalan S�ralamas�</option>

                                                    <option value = "ascending">Y�kselen S�ralamas�</option>
                                                </select>
                                            </div>
                                        </fieldset>
                                    </td>
...
<?php echo $lists['parent']; ?>
                                                ...
                                                <div>
                                                    ...
                                                    Alt Forumlar� da aramaya dahil et</label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </td>
