										...
										<div class="tab-pane active" id="tab_basics">
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->board_title != 'Kunena')
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->send_emails != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->board_offline != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->read_only != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->fallback_english != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->time_to_create_page != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->access_component != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->legacy_urls != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->sef_redirect != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->cache_time != 60)
:
														echo 'class="changed"';
														endif; ?>>
										...
										<div class="tab-pane" id="tab_frontend">
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->threads_per_page != 20)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->messages_per_page != 6)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->messages_per_page_search != 15)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->post_dateformat != 'ago')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->post_dateformat_hover != 'datetime')
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->avataroncat != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->listcat_show_moderators != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->ordering_system != 'mesid')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->hide_ip != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->latestcategory_in != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->show_list_time != 720)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->topic_layout != 'flat')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->pickup_category != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->article_display != 'intro')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->default_sort != 'asc')
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->allow_change_subject != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->attach_start != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->disable_re != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->thankyou_max != 10)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->show_imgfiles_manage_profile != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->user_report != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->log_moderation != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->user_status != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->plain_email != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->category_subscriptions != 'post')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->topic_subscriptions != 'every')
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->email_recipient_count != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->email_recipient_privacy != 'bcc')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->email_visible_address != '')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->use_system_emails != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->utm_source != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->hold_guest_posts != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_allowed != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->hold_newusers_posts != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userdeletetmessage != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->mod_see_deleted != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->mailmod != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->mailadmin != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->statslink_allowed != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->max_links != 6)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->url_subject_topic != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->moderator_permdelete != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->captcha_post_limit != 0)
:
														echo 'class="changed"';
														endif; ?>>
											...
											<fieldset>
												...
												<table class="table table-striped">
													<tr <?php if ($this->config->stopforumspam_key != '')
:
														echo 'class="changed"';
														endif; ?>>
														<td align="left" valign="top"
										...
										<div class="tab-pane" id="tab_avatars">
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->avatar_type != 1)
:
														echo 'class="changed"';
														endif; ?>>
										...
										<div class="tab-pane" id="tab_uploads">
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->attachment_limit != 8)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->attachment_protection != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->attachment_utf8 != 1)
:
														echo 'class="changed"';
														endif; ?>>
											...
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->image_upload != 'registered')
:
														echo 'class="changed"';
														endif; ?>>
...
:
											...
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->file_upload != 'registered')
:
														echo 'class="changed"';
														endif; ?>>
										...
										<div class="tab-pane" id="tab_bbcode">
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->disemoticons != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->bbcode_img_secure != 'text')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->ebay_language != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->ebay_affiliate_id != 5337089937)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->ebay_api_key != '')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->twitter_consumer_key != '')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->twitter_consumer_secret != '')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->google_map_api_key != '')
:
														echo 'class="changed"';
														endif; ?>>
										...
										<div class="tab-pane" id="tab_rss">
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->rss_type != 'topic')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_specification != 'rss2.0')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_timelimit != 'month')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_limit != 100)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_included_categories != '')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_excluded_categories != '')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_allow_html != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_author_format != 'name')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_author_in_title != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_word_count != '0')
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_old_titles != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_cache != 900)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->rss_feedburner_url != '')
:
														echo 'class="changed"';
														endif; ?>>
										...
										<div class="tab-pane" id="tab_extra">
											<fieldset>
												...
												<table class="table table-striped">
													...
													<tbody>
													<tr <?php if ($this->config->userlist_rows != 30)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_online != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_avatar != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_posts != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_karma != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_email != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_joindate != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_lastvisitdate != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_userhits != 1)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_userhits != 0)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->userlist_userhits != 2)
:
														echo 'class="changed"';
														endif; ?>>
													...
													<tr <?php if ($this->config->show_session_starttime != 1800)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->userlist_count_users != 1)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->allow_user_edit_poll != 0)
:
														echo 'class="changed"';
														endif; ?>>
...
:
													...
													<tr <?php if ($this->config->mainmenu_id != '')
:
														echo 'class="changed"';
														endif; ?>>
														<td align="left" valign="top"
...
:
													...
													<tr <?php if ($this->config->index_id != '')
:
														echo 'class="changed"';
														endif; ?>>
														<td align="left" valign="top"
													...
													<tr <?php if ($this->config->moderators_id != '')
:
														echo 'class="changed"';
														endif; ?>>
														<td align="left" valign="top"
													...
													<tr <?php if ($this->config->topiclist_id != '')
:
														echo 'class="changed"';
														endif; ?>>
														<td align="left" valign="top"
...
:
													...
													<tr <?php if ($this->config->profile_id != '')
:
														echo 'class="changed"';
														endif; ?>>
														<td align="left" valign="top"
													...
													<tr <?php if ($this->config->search_id != '')
:
														echo 'class="changed"';
														endif; ?>>
														<td align="left" valign="top"
