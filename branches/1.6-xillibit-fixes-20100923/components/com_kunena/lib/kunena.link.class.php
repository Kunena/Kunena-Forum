...
class CKunenaLink {
	...
	function GetCreditsLink() {
		return CKunenaLink::GetHrefLink ( 'http://www.kunena.com', 'Kunena', 'Kunena', 'follow', NULL, NULL, 'target="_blank"' );
	}
	...
	function GetPDFLink($catid, $id, $name, $rel = 'nofollow', $class = '', $title = '') {
		return CKunenaLink::GetSefHrefLink ( KUNENA_LIVEURLREL . '&id=' . $id . '&catid=' . $catid . '&func=kunena_pdf', $name, $title, $rel, $class );
	}
