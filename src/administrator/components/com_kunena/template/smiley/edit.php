				...
				<table class="table table-bordered table-striped">
					<tr>
						...
						<td width="80%">
							...
							<img name="smiley_image" src="<?php echo isset($this->smiley_selected) ? $this->escape($this->ktemplate->getSmileyPath($this->smiley_selected->location, true)) : '' ?>" border="0" alt="<?php echo $this->smiley_selected->title;?>" />
						</td>
					</tr>
					<tr>
						<td>
