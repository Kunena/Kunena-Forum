...
<div class="collapse in" id="announcement<?php echo $this->announcement->id; ?>">
	<div class="alert alert-info">
		...
		<h5>
			<a class="btn-link" href="<?php echo KunenaRoute::_('index.php?option=com_kunena&view=announcement&layout=list'); ?>" title="<?php echo  $this->announcement->displayField('title')?>" rel="follow">
