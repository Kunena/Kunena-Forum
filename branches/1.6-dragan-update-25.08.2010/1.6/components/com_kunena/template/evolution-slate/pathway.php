<?php
/**
 * @version $Id: pathway.php 2999 2010-07-11 10:01:36Z fxstein $
 * Kunena Component
 * @package Kunena
 *
...
<?php
	...
	for($i = 0; $i < $jr_forum_count; $i ++) {
		if ($i == $jr_forum_count - 1) {
			...
			$firelast .= '<div class="path-element-last">' . $jr_path_menu [$i] . $fireinfo . '</div>';
			endif;
		} else {
...
?>
<?php if ($this->params->get('toppathwayShow') == '1') : ?>
