	...
	function display() {
		...
		if (CKunenaTools::isModerator ( $this->my->id, $this->catid )) {
			...
			if (!$this->config->mod_buttons) {
				...
				$this->message_split = CKunenaLink::GetTopicPostLink ( 'moderatesplit', $this->catid, $this->id, CKunenaTools::showButton ( 'split', JText::_('COM_KUNENA_BUTTON_SPLIT_TOPIC') ), 'nofollow', 'buttonmod btn-left', JText::_('COM_KUNENA_BUTTON_SPLIT_TOPIC_LONG') );
				$this->message_merge = CKunenaLink::GetTopicPostLink ( 'moderatemergemessage', $this->catid, $this->id, CKunenaTools::showButton ( 'merge', JText::_('COM_KUNENA_BUTTON_MERGE') ), 'nofollow', 'buttonmod btn-left', JText::_('COM_KUNENA_BUTTON_MERGE_LONG') );
				$this->message_move = CKunenaLink::GetTopicPostLink ( 'moderatemovemessage', $this->catid, $this->id, CKunenaTools::showButton ( 'move', JText::_('COM_KUNENA_BUTTON_MOVE') ), 'nofollow', 'buttonmod btn-left', JText::_('COM_KUNENA_BUTTON_MOVE_LONG') );
			}
			if ($message->hold == 1) {
	...
	function getView() {
		...
		if (CKunenaTools::isModerator ( $this->my->id, $this->catid )) {
			...
			if (!$this->config->mod_buttons) {
				...
				$this->thread_merge = CKunenaLink::GetTopicPostLink ( 'moderatemergetopic', $this->catid, $this->id, CKunenaTools::showButton ( 'merge', JText::_('COM_KUNENA_BUTTON_MERGE_TOPIC') ), 'nofollow', 'buttonmod btn-left', JText::_('COM_KUNENA_BUTTON_MERGE_TOPIC_LONG') );
				$this->thread_move = CKunenaLink::GetTopicPostLink ( 'moderatemovetopic', $this->catid, $this->id, CKunenaTools::showButton ( 'move', JText::_('COM_KUNENA_BUTTON_MOVE_TOPIC') ), 'nofollow', 'buttonmod btn-left', JText::_('COM_KUNENA_BUTTON_MOVE_TOPIC_LONG') );
			}
		}
