...
<table id="addban" class="<?php echo isset ( $this->objCatInfo->class_sfx ) ? ' kblocktable' . $this->objCatInfo->class_sfx : ''; ?>">
	<tbody>
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_BAN_USERNAME'); ?></b></td>
		<td class="kmiddle"><?php echo $this->escape($this->profile->username); ?> </td>
	</tr>
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_BAN_USERID'); ?></b></td>
		<td class="kmiddle"> <?php echo $this->escape($this->profile->userid); ?> </td>
	</tr>
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst" ><b><?php echo JText::_('COM_KUNENA_BAN_BANLEVEL'); ?></b></td>
	...
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_BAN_EXPIRETIME'); ?></b><br />
	...
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_BAN_PUBLICREASON'); ?></b><br />
	...
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_BAN_PRIVATEREASON'); ?></b><br />
		...
		<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_BAN_ADDCOMMENT'); ?></b><br />
	...
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_MODERATE_REMOVE_BAN'); ?></b></td>
		<td class="kmiddle"><input type="checkbox" id="ban-delban" name="delban" value="delban" class="" /></td>
	</tr>
	<?php endif; ?>
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_MODERATE_DELETE_BAD_SIGNATURE'); ?></b></td>
		<td class="kmiddle"><input type="checkbox" id="ban-delsignature" name="delsignature" value="delsignature" class="" /></td>
	</tr>
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_MODERATE_DELETE_BAD_AVATAR'); ?></b></td>
		<td class="kmiddle"><input type="checkbox" id="ban-delavatar" name="delavatar" value="delavatar" /></td>
	</tr>
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_MODERATE_DELETE_BAD_PROFILEINFO'); ?></b></td>
		<td class="kmiddle"><input type="checkbox" id="ban-delprofileinfo" name="delprofileinfo" value="delprofileinfo" /></td>
	</tr>
	<tr class="krow<?php echo ($i^=1)+1;?>">
		<td class="kfirst"><b><?php echo JText::_('COM_KUNENA_MODERATE_DELETE_ALL_POSTS'); ?></b></td>
		<td class="kmiddle"><input type="checkbox" id="ban-delposts" name="bandelposts" value="bandelposts" /></td>
	</tr>
	<tr class="krow<?php echo ($i^=1)+1;?>">
