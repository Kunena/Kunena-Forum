<?php
/**
* @version $Id: COPYRIGHT.php 529 2007-12-23 14:45:45Z danialt $
* Fireboard Component
* @package Fireboard
...
FireBoard derives from copyrighted works licensed under the GNU General
...
Fireboard includes or is derivative of works distributed under the following copyright notices:
