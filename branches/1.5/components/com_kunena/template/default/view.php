...
$document->addCustomTag('<script type="text/javascript" src="'.JB_DIRECTURL . '/template/default/plugin/chili/jquery.chili.pack.js"></script>
...
require_once (FB_COMP_C_SRC . '/fb_statsbar.php');
...
?>
                    ...
                    ?>
                        ...
                        <div class = "jr-pagenav">
                            <ul>
                                ...
                                echo $pageNav-> getPagesLinks  ( JRoute::_(JB_LIVEURLREL."&amp;func=view&amp;id=$id&amp;catid=$catid"));
                                ?>
            ...
            <table class = "fb_blocktable<?php echo $objCatInfo->class_sfx; ?>"  id="fb_views" cellpadding = "0" cellspacing = "0" border = "0" width = "100%">
                <thead>
                    <tr>
                        <th align="left">
                            ...
                            if (file_exists(FB_ABSTMPLTPATH . '/plugin/forumtools/forumtools.php')) {
                                include (FB_ABSTMPLTPATH . '/plugin/forumtools/forumtools.php');
                            }
                            else {
                                include (FB_COMP_F . '/template/default/plugin/forumtools/forumtools.php');
                            }
                        ...
                        */
                        ...
                        if (count($flat_messages) > 0)
                        {
                            foreach ($flat_messages as $fmessage)
                            {
                                ...
                                if ($leaf->parent == 0)
                                {
                                    $mainframe->setPageTitle(stripslashes($fmessage->subject) . ' - ' . $fbConfig->board_title);
                                }
                                ...
                                if ($fbConfig->pm_component == "clexuspm" && $fmessage->userid && $my->id)
                                {
                                    ...
                                    foreach ($mostables as $mostables)
                                    {
                                        ...
                                        if ($mostables->msn)
                                        $msg_msn = "<a href=\"" . JRoute::_('index.php?option=com_mypms&amp;task=showprofile&amp;user=' . $PMSName) . "\"><img src=\"" . JB_URLEMOTIONSPATH . "msn.png\" border=0 alt=\"\" /></a>";
                                ...
                                else if ($userinfo->gid > 0)
                                {
                                    ...
                                    $msg_prflink = JRoute::_(JB_LIVEURLREL.'&amp;func=fbprofile&amp;task=showprf&amp;userid=' . $fmessage->userid);
                                    $msg_profile = "<a href=\"" . JRoute::_(JB_LIVEURLREL.'&amp;func=fbprofile&amp;task=showprf&amp;userid=' . $fmessage->userid) . "\"> <img src=\"";
                                ...
                                //(JJ)
                                if (file_exists(FB_ABSTMPLTPATH . '/message.php')) {
                                    include (FB_ABSTMPLTPATH . '/message.php');
                                }
                                else {
                                    include (FB_COMP_F . '/template/default/message.php');
                                }
                ...
                ?>
                    ...
                    <tr>
                        <td>
                            <?php
                            if (file_exists(FB_ABSTMPLTPATH . '/thread.php')) {
                ...
                <tr>
                    <td>
                        <div id="fb_bottom_pathway">
                            <a href = "<?php echo JRoute::_(JB_LIVEURLREL);?>">
    <?php echo $fbIcons['forumlist'] ? '<img src="' . JB_URLICONSPATH . '' . $fbIcons['forumlist'] . '" border="0" alt="' . _GEN_FORUMLIST . '" title="' . _GEN_FORUMLIST . '">' : _GEN_FORUMLIST; ?> </a>
                            ...
                            <a href = "<?php echo JRoute::_(JB_LIVEURLREL.'&amp;func=listcat&amp;catid='.$objCatParentInfo->id);?>" rel="nofollow"> <?php echo $objCatParentInfo->name; ?> </a>

                            <?php
                            if (file_exists(JB_JABSPATH . '/templates/' . $this->getTemplate().'/images/arrow.png')) {
                                echo ' <img src="' . JB_JLIVEURL . '/templates/' . $this->getTemplate() . '/images/arrow.png" alt="" /> ';
                            }
                            else {
                                echo ' <img src="' . JB_JLIVEURL . '/images/M_images/arrow.png" alt="" /> ';
                            }
                            ...
                            <a href = "<?php echo JRoute::_(JB_LIVEURLREL.'&amp;func=showcat&amp;catid='.$catid);?>" rel="nofollow"> <?php echo $objCatInfo->name; ?> </a>
                        </div>
                    </td>
                </tr>
