...
class KunenaStream implements KunenaStreaminterface
{
    /**
    ...
    /**
     * @var KunenaStreamResourcelocator
     */
    protected static $locator;

    /**
     * @param KunenaStreamResourcelocator $locator
     */
    public static function setLocator(KunenaStreamResourcelocator $locator)
    {
