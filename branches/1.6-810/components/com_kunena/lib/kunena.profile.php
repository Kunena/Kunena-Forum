...
class CKunenaPMS {
	function showPMIcon($userinfo) {
		...
		if ($kunenaConfig->pm_component == "cb")
		{
		...
		if ($kunenaConfig->pm_component == "jim")
		{
		...
		if ($kunenaConfig->pm_component == "pms")
		{
			//we should offer the user a PMS link
			//first get the username of the user to contact
			$PMSName = $userinfo->username;
...
class CKunenaProfile {
	...
	public function &getInstance() {
		...
		if (!self::$instance) {
			...
			else if ($kunenaConfig->pm_component == 'jomsocial' || $kunenaConfig->kunena_profile == 'jomsocial' || $kunenaConfig->avatar_src == 'jomsocial')
			{
