...
<div id="mb_pmread" style="display: none; color:#999;background:#fff;position:relative;">
	...
	<div class="tk-mb-pmread" style="text-align:center;color:#666;">
		<span><br /><?php echo JText::_('COM_KUNENA_TEMPLATE_YOU_HAVE'); ?> <?php if ($pm == 0) echo JText::_('COM_KUNENA_TEMPLATE_YOU_HAVE_NOT'); else echo ''; echo $pm; ?>
		<?php echo JText::_('COM_KUNENA_TEMPLATE_UNREAD_PRIVATE'); ?> <?php if (empty($this->privateMessagesLink)) echo JText::_('COM_KUNENA_TEMPLATE_MESSAGES'); elseif ($pm == 1) echo JText::_('COM_KUNENA_TEMPLATE_MESSAGE'); elseif ($pm > 1) echo JText::_('COM_KUNENA_TEMPLATE_MESSAGES'); ?></span>
	</div>
