...
;(function($){
	...
	if (Joomla !== undefined) {
		$.fn.datepicker.dates['kunena'] = {
			...
			monthsShort: [Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_JANUARY'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_FEBRUARY'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_MARCH'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_APRIL'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_MAY'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_JUNE'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_JULY'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_AUGUST'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_SEPTEMBER'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_OCTOBER'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_NOVEMBER'), Joomla.Text._('COM_KUNENA_BOOTSTRAP_DATEPICKER_MONTHSSHORT_DECEMBER')],
