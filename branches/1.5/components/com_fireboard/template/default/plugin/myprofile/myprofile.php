...
<table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
        ...
        <td class = "fb_myprofile_right" valign = "top">
            ...
            switch ($do)
            {
                ...
                case "updateavatar":
                    ...
                    echo _USER_RETURN_A . ' <a href="' . JRoute::_(JB_LIVEURLREL . "&amp;func=uploadavatar") . '">' . _USER_RETURN_B . "</a><br /><br />";
            ?>

                <script language = "javascript">
                    setTimeout("location='<?php echo JRoute::_(JB_LIVEURLREL . '&func=uploadavatar');?>'", 3500);
                </script>
                ...
                case "updateset":
                    ...
                    echo _USER_RETURN_A . ' <a href="' . JRoute::_(JB_LIVEURLREL . "&amp;func=myprofile&amp;do=showset") . '">' . _USER_RETURN_B . "</a><br /><br />";
                ?>

                <script language = "javascript">
                    setTimeout("location='<?php echo JRoute::_(JB_LIVEURLREL . '&func=myprofile&do=showset');?>'", 3500);
                </script>
    ...
    if (!$rowu->store()) {
        ...
        exit();
                        ...
                        echo _USER_RETURN_A . ' <a href="' . JRoute::_(JB_LIVEURLREL . "&amp;func=myprofile&amp;do=showsig") . '">' . _USER_RETURN_B . "</a><br /><br />";
                ?>



                <script language = "javascript">
                    setTimeout("location='<?php echo JRoute::_(JB_LIVEURLREL . '&func=myprofile&do=profileinfo');?>'", 3500);
                </script>
<?php
            ...
            <?php
                    ...
                    {
                        echo _USER_RETURN_A . " <a href=\"" . JRoute::_(JB_LIVEURLREL . '&amp;func=myprofile&amp;do=showsub') . "\">" . _USER_RETURN_B . "</a><br /><br />";
            ?>

                    <script language = "javascript">
                        setTimeout("location='<?php echo JRoute::_(JB_LIVEURLREL . '&func=myprofile&do=showsub');?>'", 3500);
                    </script>
            ...
            <?php
                    ...
                    {
                        echo _USER_RETURN_A . " <a href=\"" . JRoute::_(JB_LIVEURLREL . '&amp;func=myprofile&amp;do=showfav') . "\">" . _USER_RETURN_B . "</a><br /><br />";
            ?>

                    <script language = "javascript">
                        setTimeout("location='<?php echo JRoute::_(JB_LIVEURLREL . '&func=myprofile&do=showfav');?>'", 3500);
                    </script>
