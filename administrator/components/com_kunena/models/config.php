...
class KunenaAdminModelConfig extends KunenaModel {
	function getConfiglists() {
		...
		$username_list = array ();
		$username_list = JHTML::_('select.option', 0,JText::_('COM_KUNENA_COM_A_USERNAME_DISPLAY_NOTHING'));
		$username_list = JHTML::_('select.option', 1,JText::_('COM_KUNENA_COM_A_USERNAME_SHOW_USERNAME')); // username
		$username_list = JHTML::_('select.option', 2,JText::_('COM_KUNENA_COM_A_USERNAME_SHOW_REALNAME')); //name
		$username_list = JHTML::_('select.option', 3,JText::_('COM_KUNENA_COM_A_USERNAME_SHOW_DISPLAYNAME'));
