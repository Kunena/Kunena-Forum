				...
				<div class="span12 column-item">
					<fieldset>
						...
						<div class="control-group" id="kanynomous-check-name"
							...
							<div class="controls">
								<input type="text" id="kauthorname" name="authorname" size="35"
									...
									class="input-xlarge" maxlength="35" tabindex="4"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="email" name="email" size="35"
										...
										class="input-xlarge" maxlength="35" tabindex="5"
						...
						<?php if (!empty($this->topicIcons)) : ?>
							<div class="control-group">
								<label
									class="control-label"><?php echo JText::_('COM_KUNENA_GEN_TOPIC_ICON'); ?></label>
						...
						<?php if ($this->message->exists() && $this->config->editmarkup) : ?>
							<div class="control-group" id="modified_reason">
								...
								<div class="controls">
									<textarea class="input-xlarge" name="modified_reason" size="40" maxlength="200"
										type="text" value="<?php echo $this->modified_reason; ?>"></textarea>
								</div>
							</div>
						<?php endif; ?>
						<?php if ($this->allowedExtensions) : ?>
							<div class="control-group krow<?php echo 1 + $this->k ^= 1; ?>" id="kpost-attachments">
								...
								<div class="controls">
									<button class="btn" id="kshow_attach_form" type="button"><i
											class="icon-flag-2 icon-white"></i> <?php echo JText::_('COM_KUNENA_EDITOR_ATTACHMENTS'); ?>
									</button>
