...
/**
 * The HTML Kunena Files View
 *
 * @package		Kunena
 * @subpackage	com_kunena
 * @version		1.0
 */
class KunenaViewFiles extends JView
{
	/**
	 * Display the view
	 *
	...
	function buildDefaultToolBar()
	{
		...
		JToolBarHelper::custom('file.unpublish', 'unpublish.png', 'unpublish_f2.png', 'Unpublish', true);
		JToolBarHelper::deleteList('', 'file.delete');
		JToolBarHelper::custom('file.edit', 'edit.png', 'edit_f2.png', 'Edit', true);
		JToolBarHelper::custom('file.new', 'new.png', 'new_f2.png', 'New', false);
	}
}
