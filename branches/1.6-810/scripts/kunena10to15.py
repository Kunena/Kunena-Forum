...
'KUNENA_ROOT_PATH\s*\.DS\.\s*(["\'])images/kunenafiles':'KUNENA_PATH_UPLOADED .DS. \\1',
...
'global\s*\$kunenaConfig;':'$kunenaConfig =& CKunenaConfig::getInstance();',
#'(\s*)(global )\s*\$kunenaConfig,\s*(.*?;)':'\\1\\2\\3\n\\1$kunenaConfig =& CKunenaConfig::getInstance();',
'(\s*)(global .*?),\s*\$kunenaConfig;':'\\1\\2;\n\\1$kunenaConfig =& CKunenaConfig::getInstance();',
'\$acl':'$kunena_acl',
'\$my(\W)':'$kunena_my\\1',
'\$database':'$kunena_db',
'mosCountModules\(':'JDocumentHTML::countModules(',
'\$GLOBALS\[\"kunenaConfig\"\]':'$kunenaConfig',
