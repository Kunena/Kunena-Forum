...
<div class="kmsgtitle kleft">
	...
	<span class="kmsgdate" title="<?php echo CKunenaTimeformat::showDate($this->escape($this->msg->time), 'config_post_dateformat_hover') ?>">
...
<div id="kreply<?php echo $this->escape($this->id) ?>_form" class="kreply-form" style="display: none">
	<?php
	?>
	<form action="<?php echo CKunenaLink::GetPostURL(); ?>" method="post" name="postform" enctype="multipart/form-data">
		...
		<?php endif; ?>
		<input type="text" name="subject" size="35" class="inputbox" maxlength="<?php echo $this->escape($this->config->maxsubject); ?>" value="<?php echo  $this->escape($this->resubject) ?>" /><br />
