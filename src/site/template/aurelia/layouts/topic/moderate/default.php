		...
		<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena&view=topic') ?>" method="post" name="myform" id="myform" class="form-horizontal">
			...
			<div>
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" id="tab1-tab" data-bs-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="true"><?php echo Text::_('COM_KUNENA_TITLE_MODERATE_TAB_BASIC_INFO'); ?></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" id="tab2-tab" data-bs-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"><?php echo Text::_('COM_KUNENA_TITLE_MODERATE_TAB_MOVE_OPTIONS'); ?></a>
					</li>
					<?php if (isset($this->message) && $this->message->getAuthor()->id != 0) :
					?>
						<li class="nav-item">
							<a class="nav-link" id="tab3-tab" data-bs-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false"><?php echo Text::_('COM_KUNENA_TITLE_MODERATE_TAB_BAN_HISTORY'); ?></a>
						</li>
				...
				<div class="tab-content" id="myTabContent">
								...
								?>
									...
									?>
										<label class="radio inline" for="radio<?php echo $icon->id; ?>">
											...
											<img loading=lazy src="<?php echo Uri::root() . 'media/kunena/topic_icons/' . $this->category->iconset . '/user/svg/' . $icon->svg; ?>" alt="<?php echo $icon->name; ?>" width="32" height="32" />
					...
					<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
						...
						<div class="control-group">
							<label class="control-label" for="modcategorieslist"> <?php echo Text::_('COM_KUNENA_MODERATION_DEST_CATEGORY'); ?> </label>

							<div class="controls" id="modcategorieslist"> <?php echo $this->getCategoryList(); ?> </div>
						</div>
						<div class="control-group">
							<label class="control-label" for="modtopicslist"> <?php echo Text::_('COM_KUNENA_MODERATION_DEST_TOPIC'); ?> </label>
						...
						<div class="control-group" id="kmod_targetid" style="display: none;">
							<label class="control-label" for="modtopicslist"> <?php echo Text::_('COM_KUNENA_MODERATION_TARGET_TOPIC_ID'); ?> </label>
						...
						<div class="control-group" id="kmod_subject">
							<label class="control-label" for="kmod_subject"> <?php echo Text::_('COM_KUNENA_MODERATION_TITLE_DEST_SUBJECT'); ?> </label>
			...
			<div class="control-group center">
				<button name="submit" type="submit" class="btn btn-outline-success btn-md">
					<?php echo KunenaIcons::save() . ' ' . Text::_('COM_KUNENA_POST_MODERATION_PROCEED'); ?>
				</button>

				<a href="javascript:window.history.back();" class="btn btn-outline-primary border"> <?php echo KunenaIcons::cancel() . ' ' . Text::_('COM_KUNENA_BACK'); ?> </a>
			</div>
		</form>
	</div>
</div>