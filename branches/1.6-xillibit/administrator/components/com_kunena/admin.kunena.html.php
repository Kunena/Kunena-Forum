		...
		<dd>
			...
			<fieldset>
				...
				<table cellpadding="4" cellspacing="0" border="0" width="100%" class="kadmin-adminform">
					...
					<tr align="center" valign="middle">
						<td align="left" valign="top"><?php echo JText::_('COM_KUNENA_COM_A_AUTOSUBCRIBCATS') ?>
						</td>
								<td align="left" valign="top"><?php echo $lists ['catsautosubscribed'];
						?>
						</td>
								<td align="left" valign="top"><?php echo JText::_('COM_KUNENA_COM_A_AUTOSUBCRIBCATS_DESC') ?>
						</td>
					</tr>
				</table>
			</fieldset>
