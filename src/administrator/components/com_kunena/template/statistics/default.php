...
<div id="j-main-container" class="span10">
	<div class="well well-small">
		<div class="module-title nav-header"><i class="icon-chart" alt="<?php echo JText::_('COM_KUNENA_MENU_STATISTICS') ?>"></i> <?php echo JText::_('COM_KUNENA_MENU_STATISTICS') ?></div>
