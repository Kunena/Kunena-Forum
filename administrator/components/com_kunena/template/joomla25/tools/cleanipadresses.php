					...
					<form action="<?php echo KunenaRoute::_('administrator/index.php?option=com_kunena&view=tools') ?>" method="post" id="adminForm" name="adminForm">
						...
						<fieldset>
							...
							<table class="table table-bordered table-striped">
								<tr>
									<td width="20%"><?php echo JText::_('COM_KUNENA_CLEAN_ADRESSES_IP_LEGEND_FROMDAYS') ?></td>
									<td>
										<div class="input-append">
											<input class="span1" type="text" name="cleanadressesip_days" value="30" />
											<span class="add-on"><?php echo JText::_('COM_KUNENA_CLEAN_ADRESSES_IP_LEGEND_DAYS') ?></span>
										</div>
									</td>
								</tr>
							</table>
