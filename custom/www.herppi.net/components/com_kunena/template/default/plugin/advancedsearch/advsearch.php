...
$options = array ();
$options[] = mosHTML::makeOption('0', _KUNENA_SEARCH_SEARCHIN_ALLCATS);
            ...
            <tr class = "fb_sectiontableentry1">
                <td class = "td-1" width="50%">
                    <fieldset class = "fieldset">
                        ...
                        <div style="line-height: 28px">
                            <input type = "text" class = "bof-inputbox" name = "searchword" size = "35" value = "<?php echo $searchword; ?>" style = "width:250px"/>
                ...
                <td class = "td-1" width="50%">
                    <fieldset class = "fieldset">
                        ...
                        <div style="line-height: 28px">
                            ...
                            <label for = "cb_exactname"><input type = "checkbox" name = "exactname" value="1" <?php if ($exactname) echo $checked; ?> />
                            <?php echo _KUNENA_SEARCH_EXACT; ?></label>
                        </div>
                        <div id = "userfield" style="line-height: 28px">
                            <input class="fbs bginput" type = "text" name = "searchuser" value = "<?php echo $searchuser; ?>" style = "width:250px"/>
...
*/ ?>
                    ...
                    <fieldset class = "fieldset">
                        ...
                        <div>
                            <input class="fbs bginput" type = "text" name = "limitstart" value = "<?php echo $limitstart; ?>" size="5" />
                ...
                <td class = "td-1" width="50%">
                    <fieldset class = "fieldset">
                        ...
                        <div>
                            ...
                            <div>
                                <label for = "cb_childforums"><input type = "checkbox" name = "childforums" value = "1" <?php if ($childforums) echo 'checked="checked"'; ?> />
