...
<div id="kprofile-rightcolbot">
	<div class="kprofile-rightcol2">
		<ul>
			...
			<?php if ($this->me->isAdmin()&& !$this->profile->hideEmail =1): ?><li><span class="kicon-profile kicon-profile-email"></span><?php echo JHTML::_('email.cloak', $this->user->email) ?></li><?php endif; ?>
