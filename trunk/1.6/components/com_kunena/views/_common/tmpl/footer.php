					...
					<div class="corner4">
						<div class="stats_box">
								...
								<div class="stats_items">	
									...
									<p><?php echo JText::_('K_TODAY_OPEN'); ?>: <span>13</span> | <?php echo JText::_('K_YESTERDAY_OPEN'); ?>: <span>22</span> | <?php echo JText::_('K_TODAY_TOTAL_ANSWERED'); ?>: <span>15</span> | <?php echo JText::_('K_YESTERDAY_TOTAL_ANSWERED'); ?>: <span>47</span></p>
