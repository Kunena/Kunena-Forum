...
<div id="kunena" class="admin override">
	...
	<div id="j-main-container" class="span10">
		<div class="well well-small">
			<div class="module-title nav-header"><i class="icon-flag-2" alt="<?php echo JText::_('COM_KUNENA_CPANEL_LABEL_FILES') ?>"></i> <?php echo JText::_('COM_KUNENA_CPANEL_LABEL_FILES') ?></div>
