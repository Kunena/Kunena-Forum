...
<?php endif; ?>
<tr >
  <td class="hidden-phone span1"> <?php echo $this->getTopicLink ( $this->topic, 'unread', $this->topic->getIcon() ) ?> </td>
  <td class="span6">
  ...
  <td class="span1">
    ...
    <span class="hidden-phone"> <?php echo $this->topic->getLastPostAuthor()->getLink( $this->topic->avatar ) ?></span>
    <?php endif; ?>
  </td>
  <td class="span2"> <span class="hasTooltip" title="<?php echo $this->topic->getLastPostAuthor() ;?>">
    <?php
				echo $this->topic->getLastPostAuthor()->getLink();
			?>
    </span> <br />
    <span class="hasTooltip" title="<?php echo KunenaDate::getInstance($this->topic->last_post_time)->toKunena('config_post_dateformat_hover'); ?>"><?php echo $this->getTopicLink ( $this->topic, 'last', JText::_('COM_KUNENA_GEN_LAST_POST') ); ?></span> </td>
