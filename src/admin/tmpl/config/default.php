...
<div class="row">
    <div class="col-md-12">
        <div id="j-main-container" class="j-main-container">
            <form action="<?php echo KunenaRoute::_('administrator/index.php?option=com_kunena&view=config'); ?>" method="post" id="adminForm" name="adminForm">
                <article class="data-block">
                    <div class="data-container">
                        <?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', ['active' => 'tab_basics']); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_basics', Text::_('COM_KUNENA_A_BASICS')); ?>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col" class="w-25">
                                            <?php echo Text::_('COM_KUNENA_TABLEHEAD_TITLE') ?>
                                        </th>
                                        <th scope="col" class="w-25">
                                ...
                                <tbody>
                                    <tr <?php if ($this->config->boardTitle != 'Kunena') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_boardTitle" value="<?php echo $this->escape($this->config->boardTitle) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->email != '') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_email" value="<?php echo $this->escape($this->config->email) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if (
                                        ...
                                        <td>
                                            <textarea name="cfg_offlineMessage" rows="3" cols="50"><?php echo $this->escape($this->config->offlineMessage) ?></textarea>
                                        </td>
                                    ...
                                    <tr <?php if ($this->escape($this->config->sessionTimeOut) != 1800) :
                                        ...
                                        <td><input type="text" class="form-control" name="cfg_sessionTimeOut" value="<?php echo $this->escape($this->config->sessionTimeOut);
                                                                                                                        ?>" /></td>
                        ...
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_frontend', Text::_('COM_KUNENA_A_FRONTEND')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr <?php if ($this->config->threadsPerPage != 20) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_threadsPerPage" value="<?php echo $this->escape($this->config->threadsPerPage) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->messagesPerPage != 6) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_messagesPerPage" value="<?php echo $this->escape($this->config->messagesPerPage) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->messagesPerPageSearch != 15) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_messagesPerPageSearch" value="<?php echo $this->escape($this->config->messagesPerPageSearch) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->historyLimit != 6) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_historyLimit" value="<?php echo $this->escape($this->config->historyLimit) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->ratingEnabled != 0) :
                                        ...
                                        <td align="left" valign="top" width="25%"><?php echo Text::_('COM_KUNENA_CONFIGURATION_RATING_ENABLED') ?></td>
                                        <td align="left" valign="top" width="25%"><?php echo $this->lists['ratingEnabled'] ?></td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_CONFIGURATION_RATING_DESC') ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->attachStart != 0) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_attachStart" value="<?php echo $this->escape($this->config->attachStart) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->attachEnd != 14) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_attachEnd" value="<?php echo $this->escape($this->config->attachEnd) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->datePickerFormat) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_datePickerFormat" value="<?php echo $this->escape($this->config->datePickerFormat) ?>" />
                                        </td>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_users', Text::_('COM_KUNENA_A_USERS')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->thankYouMax != 10) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_thankYouMax" value="<?php echo $this->escape($this->config->thankYouMax) ?>" />
                                        </td>
                                        <td><?php echo Text::_('COM_KUNENA_A_DISPLAY_THANKYOU_NUMBERS') ?></td>
                                    </tr>
                                    ...
                                    <tr <?php if ($this->config->userEditTime != 0) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_userEditTime" value="<?php echo $this->escape($this->config->userEditTime) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->userEditTimeGrace != 600) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_userEditTimeGrace" value="<?php echo $this->escape($this->config->userEditTimeGrace) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->maxSig != 300) :
                                        ...
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_SIGNATURE') ?></td>
                                        <td align="left" valign="top"><input type="text" class="form-control" name="cfg_maxSig" value="<?php echo $this->escape($this->config->maxSig) ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_SIGNATURE_DESC') ?></td>
                                    </tr>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_emails', Text::_('COM_KUNENA_SUBSCRIPTIONS')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr <?php if ($this->config->emailHeader != 'media/kunena/email/hero-wide.png') :
                                        ...
                                        <td><input name="cfg_emailHeader" type="text" class="inputbox form-control" value="<?php echo $this->escape($this->config->emailHeader) ?>">
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->emailHeaderSizeY != 560) :
                                        ...
                                        <td><input name="cfg_emailHeaderSizeY" type="text" class="inputbox form-control" value="<?php echo $this->escape($this->config->emailHeaderSizeY) ?>">
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->emailHeaderSizeX != 560) :
                                        ...
                                        <td><input name="cfg_emailHeaderSizeX" type="text" class="inputbox form-control" value="<?php echo $this->escape($this->config->emailHeaderSizeX) ?>">
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->emailRecipientCount != 0) :
                                        ...
                                        <td><?php echo HTMLHelper::_('select.integerlist', 0, 100, 5, 'cfg_emailRecipientCount', 'class="inputbox form-select" size="1"', $this->escape($this->config->emailRecipientCount)) ?></td>
                                    ...
                                    <tr <?php if ($this->config->emailVisibleAddress != '') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_emailVisibleAddress" value="<?php echo $this->escape($this->config->emailVisibleAddress) ?>" />
                                        </td>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_security', Text::_('COM_KUNENA_A_SECURITY')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->holdNewUsersPosts != 0) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_holdNewUsersPosts" class="ksm-field" value="<?php echo $this->escape($this->config->holdNewUsersPosts) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->floodProtection != 0) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_floodProtection" value="<?php echo $this->escape($this->config->floodProtection) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->maxLinks != 6) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_maxLinks" value="<?php echo $this->escape($this->config->maxLinks) ?>" />
                                        </td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->captchaPostLimit != 0) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_captchaPostLimit" value="<?php echo $this->escape($this->config->captchaPostLimit) ?>" />
                                        </td>
                        ...
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                <tr <?php if ($this->config->stopForumSpamKey != '') :
                                    ...
                                    <td align="left" valign="top" width="25%"><?php echo Text::_('COM_KUNENA_STOP_FORUM_SPAM_KEY') ?></td>
                                    <td align="left" valign="top" width="25%">
                                        <input type="text" class="form-control ksm-field-large" name="cfg_stopForumSpamKey" value="<?php echo $this->escape($this->config->stopForumSpamKey); ?>" />
                                    </td>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_avatars', Text::_('COM_KUNENA_A_AVATARS')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->defaultAvatar != 'nophoto.png') :
                                        ...
                                        <td><input type="text" class="form-control" name="cfg_defaultAvatar" value="<?php echo $this->escape($this->config->defaultAvatar) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->defaultAvatarSmall != 's_nophoto.png') :
                                        ...
                                        <td><input type="text" class="form-control" name="cfg_defaultAvatarSmall" value="<?php echo $this->escape($this->config->defaultAvatarSmall) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->avatarTypes != 'gif, jpeg, jpg, png') :
                                        ...
                                        <td><input type="text" class="form-control" name="cfg_avatarTypes" value="<?php echo $this->escape($this->config->avatarTypes) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->avatarSize != 2048) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_avatarSize" value="<?php echo $this->escape($this->config->avatarSize) ?>" />
                                            kB
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr <?php if ($this->config->avatarQuality != 75) :
                                        ...
                                        <td class="nowrap">
                                            <input type="text" class="form-control ksm-field" name="cfg_avatarQuality" value="<?php echo $this->escape($this->config->avatarQuality) ?>" />
                                            %
                                        </td>
                                        <td></td>
                                    </tr>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_uploads', Text::_('COM_KUNENA_A_UPLOADS')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr <?php if ($this->config->attachmentLimit != 8) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_attachmentLimit" value="<?php echo $this->escape($this->config->attachmentLimit) ?>" />
                                        </td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->imageTypes != 'jpg,jpeg,gif,png') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_imageTypes" value="<?php echo $this->escape($this->config->imageTypes) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->imageMimeTypes != 'image/jpeg,image/jpg,image/gif,image/png') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_imageMimeTypes" value="<?php echo $this->escape($this->config->imageMimeTypes) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->imageSize != 150) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_imageSize" value="<?php echo $this->escape($this->config->imageSize) ?>" />
                                            kB
                                        </td>
                                        <td>
                                            <?php
                                    ...
                                    <tr <?php if ($this->config->imageWidth != 800) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_imageWidth" value="<?php echo $this->escape($this->config->imageWidth) ?>" />
                                            px
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->imageHeight != 800) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_imageHeight" value="<?php echo $this->escape($this->config->imageHeight) ?>" />
                                            px
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->thumbWidth != 32) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_thumbWidth" value="<?php echo $this->escape($this->config->thumbWidth) ?>" />
                                            px
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->thumbHeight != 32) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_thumbHeight" value="<?php echo $this->escape($this->config->thumbHeight) ?>" />
                                            px
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->imageQuality != 50) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_imageQuality" value="<?php echo $this->escape($this->config->imageQuality) ?>" />
                                            %
                                        </td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->fileTypes != 'txt,rtf,pdf,zip,tar.gz,tgz,tar.bz2') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_fileTypes" value="<?php echo $this->escape($this->config->fileTypes) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->fileSize != 120) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field" name="cfg_fileSize" value="<?php echo $this->escape($this->config->fileSize) ?>" /> <?php echo Text::_('COM_KUNENA_A_FILESIZE_KB') ?>
                                        </td>
                                        <td>
                                            <?php
                                            echo Text::sprintf(
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_ranking', Text::_('COM_KUNENA_A_RANKING')); ?>
                        <fieldset class="option-fieldset options-form">
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_bbcode', Text::_('COM_KUNENA_A_BBCODE')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->trimLongUrlsFront != 40) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_trimLongUrlsFront" value="<?php echo $this->escape($this->config->trimLongUrlsFront) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->trimLongUrlsBack != 20) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_trimLongUrlsBack" value="<?php echo $this->escape($this->config->trimLongUrlsBack) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->ebayAffiliateId != 5337089937) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_ebayAffiliateId" value="<?php echo $this->escape($this->config->ebayAffiliateId) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->ebayApiKey != '') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_ebayApiKey" value="<?php echo $this->escape($this->config->ebayApiKey) ?>" />
                                        </td>
                                        <td><?php echo Text::_('COM_KUNENA_CONFIGURATION_EBAY_API_KEY_DESC') ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->ebayCertId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td><?php echo Text::_('COM_KUNENA_CONFIGURATION_EBAY_CERTID_KEY_LABEL') ?></td>
                                        <td>
                                            <input type="text" class="form-control" name="cfg_ebayCertId" value="<?php echo $this->escape($this->config->ebayCertId) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->googleMapApiKey != '') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_googleMapApiKey" value="<?php echo $this->escape($this->config->googleMapApiKey) ?>" />
                                        </td>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_rss', Text::_('COM_KUNENA_ADMIN_RSS')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->rssLimit != 100) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_rssLimit" value="<?php echo $this->escape($this->config->rssLimit) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->rssFeedBurnerUrl != '') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control ksm-field-large" name="cfg_rssFeedBurnerUrl" value="<?php echo $this->escape($this->config->rssFeedBurnerUrl) ?>" />
                                        </td>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_extra', Text::_('COM_KUNENA_ADMIN_CONFIG_EXTRA')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr <?php if ($this->config->userlistRows != 30) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_userlistRows" value="<?php echo $this->escape($this->config->userlistRows) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->showSessionStartTime != 1800) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_showSessionStartTime" value="<?php echo $this->escape($this->config->showSessionStartTime) ?>" />
                                        </td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->popUserCount != 5) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_popUserCount" value="<?php echo $this->escape($this->config->popUserCount) ?>" />
                                        </td>
                                        <td><?php echo Text::_('COM_KUNENA_USERNUM') ?></td>
                                    </tr>
                                    ...
                                    <tr <?php if ($this->config->popSubjectCount != 5) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_popSubjectCount" value="<?php echo $this->escape($this->config->popSubjectCount) ?>" />
                                        </td>
                                        <td><?php echo Text::_('COM_KUNENA_NUMPOP') ?></td>
                                    </tr>
                                    ...
                                    <tr <?php if ($this->config->popPollsCount != 5) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_popPollsCount" value="<?php echo $this->escape($this->config->popPollsCount) ?>" />
                                        </td>
                                        <td><?php echo Text::_('COM_KUNENA_POLLSPOP') ?></td>
                                    </tr>
                                    ...
                                    <tr <?php if ($this->config->popThanksCount != 5) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_popThanksCount" value="<?php echo $this->escape($this->config->popThanksCount) ?>" />
                                        </td>
                                        <td><?php echo Text::_('COM_KUNENA_THANKSPOP') ?></td>
                                    </tr>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if ($this->config->pollNbOptions != 4) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_pollNbOptions" value="<?php echo $this->escape($this->config->pollNbOptions) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->pollTimeBtVotes != '00:15:00') :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_pollTimeBtVotes" value="<?php echo $this->escape($this->config->pollTimeBtVotes) ?>" />
                                        </td>
                                    ...
                                    <tr <?php if ($this->config->pollNbVotesByUser != 100) :
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="cfg_pollNbVotesByUser" value="<?php echo $this->escape($this->config->pollNbVotesByUser) ?>" />
                                        </td>
                        ...
                        <?php echo HTMLHelper::_('uitab.endTab'); ?>
                        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'tab_menu', Text::_('COM_KUNENA_ADMIN_MENU_SETTINGS')); ?>
                        <fieldset class="option-fieldset options-form">
                            ...
                            <table class="table">
                                <thead>
                                    <tr <?php if ($this->config->activeMenuItem != '') :
                                        ...
                                        <td align="left" valign="top" width="5%"><?php echo Text::_('COM_KUNENA_A_ACTIVEMENU') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_activeMenuItem" value="<?php echo $this->escape($this->config->activeMenuItem); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_ACTIVEMENU_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->mainMenuId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="5%"><?php echo Text::_('COM_KUNENA_A_MAINMENU') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_mainMenuId" value="<?php echo $this->escape($this->config->mainMenuId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_MAINMENU_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->homeId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="5%"><?php echo Text::_('COM_KUNENA_A_HOMEID') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_homeId" value="<?php echo $this->escape($this->config->homeId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_HOMEID_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->indexId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="15%"><?php echo Text::_('COM_KUNENA_A_INDEXID') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_indexId" value="<?php echo $this->escape($this->config->indexId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_INDEXID_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->moderatorsId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="15%"><?php echo Text::_('COM_KUNENA_A_MODERATORSID') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_moderatorsId" value="<?php echo $this->escape($this->config->moderatorsId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_MODERATORSID_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->topicListId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="15%"><?php echo Text::_('COM_KUNENA_A_TOPICLISTID') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_topicListId" value="<?php echo $this->escape($this->config->topicListId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_TOPICLISTID_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->miscId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="15%"><?php echo Text::_('COM_KUNENA_A_MISCID') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_miscId" value="<?php echo $this->escape($this->config->miscId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_MISCID_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->profileId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="15%"><?php echo Text::_('COM_KUNENA_A_PROFILEID') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_profileId" value="<?php echo $this->escape($this->config->profileId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_PROFILEID_DESC'); ?></td>
                                    </tr>
                                    <tr <?php if ($this->config->searchId != '') :
                                            echo 'class="changed"';
                                        endif; ?>>
                                        <td align="left" valign="top" width="15%"><?php echo Text::_('COM_KUNENA_A_SEARCHID') ?></td>
                                        <td align="left" valign="top" width="5%"><input type="text" class="form-control" name="cfg_searchId" value="<?php echo $this->escape($this->config->searchId); ?>" />
                                        </td>
                                        <td align="left" valign="top"><?php echo Text::_('COM_KUNENA_A_SEARCHID_DESC'); ?></td>
                                    </tr>
                                </thead>
                            </table>
                        </fieldset>
