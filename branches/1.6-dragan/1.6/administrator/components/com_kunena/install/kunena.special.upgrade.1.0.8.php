...
if ($temporary) {
	...
	$kunena_db->query() or check_dbwarning("Unable to remove temporary table (#__fb_favorites_temp).");
}
...
if ($temporary) {
	...
	$kunena_db->query() or check_dbwarning("Unable to remove temporary table (#__fb_subscriptions_temp).");
}
