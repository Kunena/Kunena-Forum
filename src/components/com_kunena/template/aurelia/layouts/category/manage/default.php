											...
											<fieldset>
												<table class="table table-striped">
													...
													<tr>
														...
														<td><?php echo $this->lists['accesstypes']; ?></td>
												...
												<fieldset>
													<table class="table table-striped">
														...
														<tr>
															...
															<td><?php echo $this->lists['allow_anonymous']; ?></td>
														...
														<tr>
															...
															<td><?php echo $this->lists['post_anonymous']; ?></td>
														...
														<tr>
															...
															<td><?php echo $this->lists['topic_ordering']; ?></td>
														...
														<tr>
															...
															<td><?php echo $this->lists['category_iconset']; ?></td>
														...
														<tr>
															...
															<td><?php echo $this->lists['allow_ratings']; ?></td>
											...
											<fieldset>
												...
												<table class="table table-striped">
													<tr>
														...
														<td><?php echo $this->lists['display_parent']; ?></td>
													...
													<tr>
														...
														<td><?php echo $this->lists['display_children']; ?></td>
