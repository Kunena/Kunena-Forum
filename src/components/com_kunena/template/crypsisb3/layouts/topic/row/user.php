	...
	<td class="col-md-2 hidden-xs">
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="col-md-3">
					<?php echo $author->getLink($avatar, Text::sprintf('COM_KUNENA_VIEW_USER_LINK_TITLE', KunenaFactory::getProfile()->getProfileName($this->topic->getLastPostAuthor())), '', '', KunenaTemplate::getInstance()->tooltips(), $category->id); ?>
				</div>
				<div class="col-md-9">
					<?php else : ?>
					<div class="col-md-12">
