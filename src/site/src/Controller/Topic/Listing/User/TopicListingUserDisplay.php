...
use Kunena\Forum\Libraries\Event\KunenaGetUserTopics;
    ...
    protected function before()
    {
        ...
        switch ($this->state->get('list.mode')) {
            ...
            case 'plugin':
                ...
                $dispatcher->dispatch('onKunenaGetUserTopics', new KunenaGetUserTopics('onKunenaGetUserTopics', [$pluginmode, &$finder, &$order, &$categoryIds, $this]));
                break;
