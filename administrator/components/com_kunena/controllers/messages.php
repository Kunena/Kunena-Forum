 ...
 * @since 2.0
 */
class KunenaAdminControllerMessages extends KunenaController {
	protected $baseurl = null;
	protected $baseurl2 = null;

	public function __construct($config = array()) {
		parent::__construct($config);
		$this->baseurl = 'administrator/index.php?option=com_kunena&view=messages';
		$this->baseurl2 = 'administrator/index.php?option=com_kunena&view=messages';
	}
