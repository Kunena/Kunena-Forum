					...
					<div class="col-md-12">
						...
						<div class="col-md-3 pull-right">
							...
							<?php if (!empty($websiteName) && $websiteURL != 'http://') : ?>
								<a class="btn btn-default btn-sm" rel="nofollow" target="_blank" href="<?php echo $websiteURL ?>"><?php echo KunenaIcons::globe(); ?><?php echo $websiteName ?></a>
							<?php elseif(empty($websiteName) && $websiteURL != 'http://') : ?>
								<a class="btn btn-default btn-sm" href="<?php echo $websiteURL ?>"><?php echo KunenaIcons::globe(); ?><?php echo $websiteURL ?></a>
							<?php elseif(!empty($websiteName) && $websiteURL == 'http://') : ?>
								<button class="btn btn-default btn-sm"><?php echo KunenaIcons::globe(); ?> <?php echo $websiteName ?></button>
							<?php endif; ?>
						</div>
					</div>
				</div>
