...
<div class="kheader">
  <h3 class="page-header"><span><?php echo JText::_('COM_KUNENA_PROFILE_EDIT_PROFILE_TITLE'); ?></span></h3>
</div>
	...
	?>">
      <tbody>
        ...
        <tr class="krow1">
          ...
          <td class="kcol-mid"> <span class="editlinktip hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE_DESC'); ?>" >
        ...
        <tr class="krow2">
          ...
          <td class="kcol-mid"> <span class="editlinktip hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME_DESC'); ?>" >
        ...
        <tr class="krow1">
          ...
          <td class="kcol-mid"> <span class="editlinktip hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL_DESC'); ?>" >
        ...
        <tr class="krow<?php echo (++$i & 1)+1;?>">
          ...
          <td class="kcol-mid"> <span class="editlinktip hasTip" title="<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}"); ?>::<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}_DESC"); ?>" >
        ...
        <tr class="krow<?php echo (++$i & 1)+1;?>">
          ...
          <td class="kcol-mid"> <span class="editlinktip hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE_DESC'); ?>" >
