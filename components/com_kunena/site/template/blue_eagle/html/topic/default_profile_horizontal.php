...
<ul id="kpost-profiletop">
	<?php if ($this->profile->exists()): ?>
		<li class="kpost-smallicons">
			...
			<div>
				<?php if ($this->userposts) : ?>
					<span
						class="kpost-userposts"><?php echo JText::_('COM_KUNENA_POSTS') . intval($this->userposts); ?></span>
				<?php endif ?>
				<?php if ($this->userthankyou) : ?>
					<span
						class="kpost-userposts"><?php echo JText::_('COM_KUNENA_MYPROFILE_THANKYOU_RECEIVED') . ' ' . intval($this->userthankyou); ?></span>
				<?php endif ?>
				<?php if ($this->userpoints) : ?>
					<span
						class="kpost-userposts"><?php echo JText::_('COM_KUNENA_AUP_POINTS') . intval($this->userpoints); ?></span>
				<?php endif ?>
			</div>
		</li>
		...
		<?php endif ?>
	<?php endif; ?>
	<?php $avatar = $this->profile->getAvatarImage('kavatar', 'welcome');
	if ($avatar) : ?>
