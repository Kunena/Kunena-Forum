...
DEFINE('_KUNENA_SEARCH_ERR_NOPOSTS', 'Nem található az Ön által megadott keresési kifejezéseket tartalmazó hozzászólás.');
...
DEFINE('_POST_NOT_MODERATOR', 'Önnek nincsenek moderátori jogai!');
DEFINE('_POST_NO_FAVORITED_TOPIC', 'Ezt a témát <b>NEM</b> adta hozzá a kedvenceihez');
DEFINE('_COM_C_SYNCEUSERSDESC', 'A Kunena felhasználói tábla szinkronizálása a Joomla felhasználói táblával');
DEFINE('_POST_FORGOT_EMAIL', 'Elfelejtette megadni az e-mail címét.  Kattintson a böngészője Vissza gombjára a visszalépéshez, s próbálja meg újra.');
...
DEFINE('_KUNENA_SAMPLE_FORUM1_TITLE', 'Üdv, Mátyás!');
...
');
DEFINE('_KUNENA_SAMPLE_FORUM1_HEADER', '[b]Üdvözli a Kunena fórum![/b]

Írjon saját magáról nekünk és a tagjainknak, miért tetszik ez a weblap, és miért lett a tagja.
Szívesen látunk minden új tagot, s reméljük, hogy sokszor látjuk viszont!
');
DEFINE('_KUNENA_SAMPLE_FORUM2_TITLE', 'Ötletláda');
DEFINE('_KUNENA_SAMPLE_FORUM2_DESC', 'Van valamilyen megosztandó ötlete vagy észrevétele?
Írja meg nyugodtan nekünk. Örömmel hallunk önfelől, ugyanis azon fáradozunk, hogy vendégeink és tagjaink számára egyaránt jobbá és felhasználóbarátabbá tegyük a weblapunkat.');
DEFINE('_KUNENA_SAMPLE_FORUM2_HEADER', 'Ez az ötletláda tetszőleges fórumfejléce.
');
DEFINE('_KUNENA_SAMPLE_POST1_SUBJECT', 'Üdvözli a Kunena!');
DEFINE('_KUNENA_SAMPLE_POST1_TEXT', '[size=4][b]Üdvözli a Kunena![/b][/size]

Köszönjük, hogy a Kunenát választotta közössége fórummegoldásaként a Joomlához.
...
DEFINE('_COM_A_HIGHLIGHTCODE_DESC', 'Engedélyezi a Kunena kódszövegkiemelő javascriptet. Ha a tagok a code címkék közé zárt PHP vagy hasonló kódrészleteket küldenek be, ennek a beállításnak a bekapcsolásával színkódolással jelenítheti meg a kódot. Ha a fórumban nem küldenek be ilyen programozási nyelves hozzászólásokat, akkor kikapcsolhatja, ezáltal elkerülheti a kód címkék hibás formázását.');
DEFINE('_COM_A_RSS_TYPE', 'Alapértelmezett RSS típus');
DEFINE('_COM_A_RSS_TYPE_DESC', 'A téma vagy hozzászólás szerinti RSS-csatorna közül választhat. A téma szerint azt jelenti, hogy témánként csak egy tétel kerül listázásra az RSS-csatornában, függetlenül attól, hogy hányan szóltak hozzá ahhoz a témához. A téma szerinti beállítás rövidebb és tömörebb RSS-csatornát eredményez, de nem listáz ki minden választ.');
...
DEFINE('_COM_A_RSS_HISTORY_DESC', 'Itt választhatja ki, hogy hány előzményt tartalmazzon az RSS-csatorna. Alapértelmezés az 1 hónap, azonban nagy forgalmú helyeken korlátozhatja 1 hétre.');
...
DEFINE('_COM_A_FBDEFAULT_PAGE_DESC', 'Itt választhatja ki a fórum hivatkozására kattintáskor megjelenő alapértelmezett Kunena oldalt, ahol kezdetben a fórumba belépés történik. Az Új viták az alapértelmezés. A default_ex sablontól eltérő választása esetén a Kategóriákra állítsa. A Vitáim választásakor a vendégek alapértelmezése az Új viták lesz.');
...
DEFINE('_POST_FORGOT_NAME_ALERT', 'Elfelejtette beírni a nevét.');
DEFINE('_POST_FORGOT_EMAIL_ALERT', 'Elfelejtette beírni az e-mail címét.');
DEFINE('_POST_FORGOT_SUBJECT_ALERT', 'Elfelejtette beírni a tárgyat.');
DEFINE('_KUNENA_EDIT_TITLE', 'Adatmódosítás');
DEFINE('_KUNENA_YOUR_NAME', 'Az Ön neve:');
...
DEFINE('_POST_SPLIT_HINT', '<br />Tanács: Egy hozzászólást témapozícióba teheti, ha a kijelöli a második oszlopban, és nem jelöl be semmi szétbontandót.<br />');
...
// Additional
DEFINE('_POST_UNFAVORITED_TOPIC', 'Ez a téma eltávolításra került a kedvenceiből.');
DEFINE('_POST_NO_UNFAVORITED_TOPIC', 'Ez a téma <b>NEM</b> került eltávolításra a kedvenceiből');
DEFINE('_POST_SUCCESS_UNFAVORITE', 'A kedvencekből történő eltávolításának kérését feldolgoztuk.');
...
DEFINE('_POST_SUCCESS_UNSUBSCRIBE', 'A témafigyelésből történő eltávolításának kérését feldolgoztuk.');
DEFINE('_POST_NO_DEST_CATEGORY', 'Nem választotta ki a célkategóriát. Nem került semmi sem áthelyezésre.');
// Default_EX template
...
DEFINE('_KUNENA_POST_DEL_ERR_TXT', 'Nem törölhető(k) a hozzászólás(ok) szövege(i). Frissítse kézzel az adatbázist (mesid=%id%).');
...
DEFINE('_KUNENA_POST_MOV_ERR_DB', "Súlyos adatbázishiba. Frissítse kézzel az adatbázist, hogy a témákba beküldött hozzászólások a fórummal is egyezzenek");
...
DEFINE('_KUNENA_NO_ACCESS', 'A hozzáférés ehhez a fórumhoz az Ön számára nem engedélyezett!');
...
DEFINE('_COM_A_USER_EDIT_TIME_DESC', 'Korlátlan időtartamhoz írjon be 0-t, különben az ablak másodpercben a 
...
DEFINE('_KUNENA_HELPPAGE_IN_KUNENA_DESC','Az &quot;Igen&quot; választása esetén a súgó tartalma a Kunenaban lesz elérhető, és a Súgó külső oldal hivatkozása nem fog működni. <b>Megjegyzés:</b> Meg kell adnia a "Súgó tartalom-azonosítóját" .');
DEFINE('_KUNENA_HELPPAGE_CID','A Súgó tartalom-azonosítója');
DEFINE('_KUNENA_HELPPAGE_CID_DESC','Válassza az <b>"IGEN"</b> "A súgó megjelenítése a Kunenában" lehetőséget.');
...
DEFINE('_KUNENA_RULESPAGE_IN_KUNENA_DESC','Az &quot;Igen&quot; választása esetén a szabályok szövege a Kunenaban lesz elérhető, és a szabályok külső oldal hivatkozása nem fog működni. <b>Megjegyzés:</b> Meg kell adnia a "Szabályok tartalom-azonosítóját" .');
DEFINE('_KUNENA_RULESPAGE_CID','A Szabályok tartalom-azonosítója');
DEFINE('_KUNENA_RULESPAGE_CID_DESC','Válassza az <b>"IGEN"</b> "A szabályok megjelenítése a Kunenában" lehetőséget.');
...
DEFINE('_KUNENA_WELCOME','Üdvözli a Kunena!');
DEFINE('_KUNENA_WELCOME_DESC','Köszönjük, hogy fórummegoldásként a Kunenát választotta. Ezen a lapon röviden áttekintheti a fórum különféle statisztikáit. A bal oldali menüpontokból a fórum beállításának testreszabását végezheti el. Mindegyik oldalon talál az eszközök használatát ismertető utasításokat.');
...
define('_PERM_NO_READ','Ön nem rendelkezik eme fórumhoz történő hozzáféréshez szükséges engedélyekkel.');
...
DEFINE('_KUNENA_HIDETEXT','Kérjük, hogy jelentkezzen be e tartalom megtekintéséhez!');
...
DEFINE('_KUNENA_CAPTCHA_DESC','Itt kapcsolhatja be/ki az antispam és antibot CAPTCHA rendszert');
DEFINE('_KUNENA_CAPDESC','Írja be ide a kódot');
DEFINE('_KUNENA_CAPERR','Pontatlan a kód!');
DEFINE('_KUNENA_COM_A_REPORT', 'Hozzászólás bejelentése');
DEFINE('_KUNENA_COM_A_REPORT_DESC', 'Ha engedélyezni kívánja a hozzászólások felhasználók által történő bejelentését, akkor válassza az igent.');
DEFINE('_KUNENA_REPORT_MSG', 'Bejelentett üzenet');
DEFINE('_KUNENA_REPORT_REASON', 'Indok');
DEFINE('_KUNENA_REPORT_MESSAGE', 'Az Ön üzenete');
...
DEFINE('_KUNENA_REPORT_INTRO', 'küldött Önnek egy üzenetet, mert');
...
DEFINE('_KUNENA_EMOTICONS_PICK_A_SMILEY', 'Válasszon a hangulatjelek közül');
...
DEFINE('_KUNENA_MYPROFILE_ICQ_DESC', 'Az Ön ICQ-száma');
DEFINE('_KUNENA_MYPROFILE_AIM', 'AIM');
DEFINE('_KUNENA_MYPROFILE_AIM_DESC', 'Az Ön AOL Instant Messenger beceneve');
DEFINE('_KUNENA_MYPROFILE_YIM', 'YIM');
DEFINE('_KUNENA_MYPROFILE_YIM_DESC', 'Az Ön Yahoo! Instant Messenger beceneve');
DEFINE('_KUNENA_MYPROFILE_SKYPE', 'Skype');
DEFINE('_KUNENA_MYPROFILE_SKYPE_DESC', 'Az Ön Skype-neve');
DEFINE('_KUNENA_MYPROFILE_GTALK', 'GTalk');
DEFINE('_KUNENA_MYPROFILE_GTALK_DESC', 'Az Ön GTalk beceneve');
...
DEFINE('_KUNENA_MYPROFILE_MSN_DESC', 'Az Ön MSN Messenger e-mail címe');
...
DEFINE('_KUNENA_QMESSAGE_NOTE', 'Megjegyzés: bár a fórumkód és a hangulatjelek nem láthatók, attól függetlenül még használhatja őket');
...
DEFINE ('_KUNENA_USRL_SEARCH_ALERT','Kérjük, hogy írja be a keresendő értéket!');
...
DEFINE('_KUNENA_DBMETHOD','Kérjük, válassza ki, hogy melyik módszerrel akarja befejezni a telepítést:');
...
DEFINE('_KUNENA_SELECTANITEMTO','Válassza ki az elemet a következő művelethez:');
...
DEFINE('_KUNENA_CHMOD1','Állítsa 766-ra az engedélyt, hogy frissíthető legyen a fájl.');
...
DEFINE('_KUNENA_SELECTTEMPLATE','Válasszon sablont');
...
DEFINE('_KUNENA_SELECTMODTO','Válasszon moderátort...');
DEFINE('_KUNENA_CHOOSEFORUMTOPRUNE','Ki kell választania a kitakarítandó fórumot!');
...
DEFINE('_KUNENA_INSTALL1','<strong>Kunena Fórum</strong> komponens <em>Joomla! CMS-hez</em> <br />&copy; 2006 - 2008 by Best Of Joomla<br />Minden jog fenntartva.');
...
DEFINE('_KUNENA_FORUMPRRDESC','Ha telepítette a Clexus PM vagy a Community Builder komponenst, akkor beállíthatja úgy a Kunenát, hogy használja a profillapot.');
...
DEFINE('_KUNENA_ERROR1','Meg kell adnia a kategória / fórum nevét');
// Forum Configuration (New in Kunena)
DEFINE('_KUNENA_SHOWSTATS','Statisztika megjelenítése');
DEFINE('_KUNENA_SHOWSTATSDESC','Ha meg akarja jeleníteni a statisztikát, akkor válassza az Igent');
DEFINE('_KUNENA_SHOWWHOIS','A jelenlévő felhasználók kijelzése');
DEFINE('_KUNENA_SHOWWHOISDESC','Ha ki akarja jelezni a jelenlévő felhasználókat, akkor válassza az Igent');
DEFINE('_KUNENA_STATSGENERAL','Általános statisztika megjelenítése');
DEFINE('_KUNENA_STATSGENERALDESC','Ha meg akarja jeleníteni az általános statisztikát, akkor válassza az Igent');
DEFINE('_KUNENA_USERSTATS','A legaktívabb felhasználók statisztikájának megjelenítése');
DEFINE('_KUNENA_USERSTATSDESC','Ha meg akarja jeleníteni a legaktívabbak statisztikáját, akkor válassza az Igent');
...
DEFINE('_KUNENA_USERPOPULARDESC','Ha meg akarja jeleníteni a legkedveltebb témákat, akkor válassza az Igent');
...
DEFINE('_KUNENA_NOMODSAV','Egy lehetséges moderátor sem található. Olvassa el az alábbi \'megjegyzést\'.');
DEFINE('_KUNENA_NOTEUS',
   'MEGJEGYZÉS: Itt csak azok a felhasználók láthatók, akiknek a Kunena profiljában be van jelölve a moderátor jelző. Hogy hozzá lehessen rendelni egy moderátort, jelölje be a felhasználó moderátor jelzőjét, nyissa meg a <a href="index2.php?option=com_kunena&task=profiles">Felhasználók kezelése</a> funkciót, és keresse meg a moderátorrá kinevezendő felhasználót. Majd válassza ki a profilját és frissítse. A moderátor jelzőt csak adminisztrátor állíthatja be. ');
...
DEFINE('_KUNENA_PARENTDESC',
   'Megjegyzés: Kategória létrehozásához a \'Felső szintű kategóriát\' válassza szülőként. A kategória a fórumok tárolója.<br />Fórumot <strong>csak</strong> kategóriában lehet létrehozni egy már létrehozott kategória kiválasztásával a fórum szülőjeként.<br /> Kategóriába <strong>NEM</strong> lehet beküldeni hozzászólásokat; csak fórumokba.');
...
DEFINE('_KUNENA_PUBACCDESC',
   'Zártkörű fórum létrehozása esetén itt adhatja meg azt a legalacsonyabb felhasználói szintet, amelyik megtekintheti/beléphet a fórumba. A legalacsonyabb felhasználói szint alapértelmezett beállítása a &quot;Mindenki&quot;.<br /><b>Megjegyzés</b>: ha egy teljes kategóriában bizonyos csoport(ok) számára korlátozza a hozzáférést, akkor az el fogja rejteni a tartalmazott fórumokat azok számára, akik nem rendelkeznek megfelelő jogokkal a kategóriában, <b>még akkor is</b>, ha ezen fórumok egynémelyikének alacsonyabbra állították a hozzáférési szintjét! Ez vonatkozik a moderátorokra is; fel kell vennie egy moderátort a kategória moderátorlistájára, ha a kategória megtekintéséhez nem a megfelelő csoportszinten van.<br /> Ez független attól a ténytől, hogy a kategóriákat nem lehet moderálni; moderátorokoat azért még fel lehet venni a moderátorlistára.');
...
DEFINE('_KUNENA_ADMINLEVELDESC',
   'Ha nyilvános hozzáférés korlátozású fórumot hoz létre, akkor itt adhat meg további adminisztrációs hozzáférési szintet.<br /> Ha a fórumhoz történő hozzáférést egy speciális nyilvános felhasználói oldali felhasználócsoportra korlátozza, és nem adja meg itt a nyilvános kiszolgálói oldali csoportot, akkor az adminisztrátorok nem tudnak majd belépni a fórumba, ill. megtekinteni azt.');
...
DEFINE('_USER_UNFAVORITE_YES','Ön törölte ezt a témát a kedvencei közül');
...
DEFINE('_USER_NOFAVORITES','Nincs kedvenc témám');
DEFINE('_POST_SUCCESS_FAVORITE','A téma hozzáadása az Ön kedvenceihez megtörtént.');
...
DEFINE('_KUNENA_USE_JOOMLA_STYLE_DESC','Ha a Joomla stílusát akarja használni, akkor válassza az IGEN-t. (osztály: mint a sectionheader, sectionentry1 ...) ');
DEFINE('_KUNENA_SHOW_CHILD_CATEGORY_ON_LIST','Az alfórum ikonjának megjelenítése');
DEFINE('_KUNENA_SHOW_CHILD_CATEGORY_ON_LIST_DESC','Ha ikonnal akarja megjeleníteni az alkategóriát a fórumlistában, akkor válassza az IGEN-t. ');
...
DEFINE('_KUNENA_ANN_MODID_DESC','Írja be ide a felhasználói azonosítókat a közlemények moderálásához, pl. 62,63,73 . A közleménymoderátorok tehetik közzé, módosíthatják vagy törölhetik a közleményeket.');
//
...
// profilebox
DEFINE('_PROFILEBOX_WELCOME','Üdvözöljük');
...
DEFINE('_PROFILEBOX_LOGIN','jelentkezzen be');
DEFINE('_PROFILEBOX_REGISTER','regisztráljon');
DEFINE('_PROFILEBOX_LOGOUT','Kijelentkezés');
DEFINE('_PROFILEBOX_LOST_PASSWORD','Elfelejtette jelszavát?');
...
DEFINE ('_USRL_SEARCH_ALERT','Kérjük, hogy írja be a keresendő értéket!');
...
DEFINE('_MODERATION_DELETE_MESSAGE','Biztosan törölni akarja ezt a hozzászólást? \n\n MEGJEGYZÉS: A törölt hozzászólások visszanyerésére NINCS mód!');
...
DEFINE('_COM_A_MOSBOT_DESC',  'A DiscussBot teszi lehetővé, hogy a felhasználók megvitassák az oldalon olvasottakat. A tartalom címe egyben témaként is szolgál.' 
          . '<br />Ha a téma nem létezik még, akkor készül egy új. Ha létezik már a téma, akkor megmutatja a felhasználónak a témát, és hozzá tud szólni.' . '<br /><strong>A mambotot külön kell letöltenie és telepítenie.</strong>'
          . '<br />További információ a <a href="http://www.bestofjoomla.com">Best of Joomla</a> webhelyén.' . '<br />Telepítés után a következő mambotsorokat kell beszúrnia a tartalmi elembe:' . '<br />{mos_KUNENA_discuss:<em>catid</em>}'
          . '<br />A <em>kategória-azonosító</em> azt a kategóriát jelöli, amelyben a tartalmi elem megvitatható. A megfelelő kategória-azonosító megtalálásához nézzen bele a fórumba ' . 'és az URL-ből kiolvashatja a kategória-azonosítót.'
...
DEFINE('_COM_FORUM_RULES_DESC','<ul><li>A joomlagyökér/administrator/components/com_kunena/language/hungarian.php fájl rules.php szakaszának megfelelő sorában írhatja le a szabályokat:</li><li>2. szabály</li><li>3. szabály</li><li>4. szabály</li><li>...</li></ul>');
//smile.class.php
...
DEFINE('_COM_A_RULESPAGE_DESC',
   'Az &quot;Igen&quot; választása esetén a fejlécmenüben megjelenik a Szabályok oldalra mutató hivatkozás. Ezen az oldalon ismertetheti a fórum használati szabályait. Ennek a fájlnak a tartalmát a components/com_kunena könyvtárban található rules.php fájl megnyitásával változtathatja meg. <em>Mindig legyen biztonsági másolata erről a fájlról, mert frissítéskor felülírásra kerül!</em>');
DEFINE('_MOVED_TOPIC','ÁTHELYEZVE:');
DEFINE('_COM_A_PDF','A PDF létrehozás engedélyezése');
DEFINE('_COM_A_PDF_DESC',
   'Az &quot;Igen&quot; választásával engedélyezheti a felhasználóknak, hogy egyszerű PDF dokumentumként letölthessék egy téma tartalmát.<br />Ez egy <u>egyszerű</u> PDF dokumentum; de tartalmazza a téma összes szövegét.');
DEFINE('_GEN_PDFA','Kattintson erre a gombra a téma PDF dokumentumának elkészítéséhez (új ablakban nyílik meg).');
DEFINE('_GEN_PDF', 'PDF');
//new in 1.0.4 stable
DEFINE('_VIEW_PROFILE','Kattintson ide a felhasználó profiljának megtekintéséhez');
DEFINE('_VIEW_ADDBUDDY','Kattintson ide a felhasználó címjegyzékbe történő felvételéhez');
...
DEFINE('_COM_A_AVATAR_SRC_DESC',
   'Ha telepítette a JomSocial, a Clexus PM vagy a Community Builder komponenst, akkor konfigurálhatja úgy a Kunenát, hogy a felhasználó avatárja a Clexus PM vagy a Community Builder felhasználói profiljából jöjjön. MEGJEGYZÉS: Community Builder esetén engedélyeznie kell a bélyegkép beállítást, mert a fórum a bélyegkép felhasználói képeket használja, nem az eredetieket.');
DEFINE('_COM_A_KARMA','A Karma kijelzése');
DEFINE('_COM_A_KARMA_DESC','Az &quot;Igen&quot; választása esetén látható a felhasználó Karmája és a hozzátartozó gombok (növelés / csökkentés), ha aktiválta a Felhasználói Statisztikát.');
DEFINE('_COM_A_DISEMOTICONS','A hangulatjelek letiltása');
DEFINE('_COM_A_DISEMOTICONS_DESC','Az &quot;Igen&quot; választásával kikapcsolhatja a hangulatjeleket.');
...
DEFINE('_POST_NO_PUBACCESS3','Kattintson ide a regisztrációhoz.');
//==================================================================================================
//Changed in 1.0.4
...
DEFINE('_KARMA_WAIT','Egy felhasználó karmáját csak 6 óránként módosíthatja. <br/>Várjon, amíg lejár ez az idő, és csak utána módosítsa valamelyik felhasználó karmáját.');
DEFINE('_KARMA_SELF_DECREASE','Kérjük, hogy ne csökkentse a saját karmáját!');
DEFINE('_KARMA_SELF_INCREASE','A karmája csökkent, mert növelni szerette volna!');
DEFINE('_KARMA_DECREASED','A felhasználó karmáját csökkentette. Ha nem tér néhány pillanaton belül vissza a témához,');
DEFINE('_KARMA_INCREASED','A felhasználó karmáját megnövelte. Ha nem tér néhány pillanaton belül vissza a témához,');
DEFINE('_COM_A_TEMPLATE','Sablon');
DEFINE('_COM_A_TEMPLATE_DESC','Válassza ki a használni kívánt sablont.');
DEFINE('_COM_A_TEMPLATE_IMAGE_PATH','Képkészletek');
DEFINE('_COM_A_TEMPLATE_IMAGE_PATH_DESC','Válassza ki a sablonhoz használni kívánt képkészletet.');
...
DEFINE('_COM_A_POSTSTATSCOLOR_DESC','Adja meg a Statisztika sávhoz használandó színek számát');
DEFINE('_LATEST_REDIRECT',
   'A Kunenának (ismét) meg kell állapítania az Ön hozzáférési jogait, mielőtt elkészíti a legutóbbi hozzászólások listáját.\nAggodalomra semmi ok, mivel 30 percnél is több inaktivitás vagy újbóli bejelentkezés után ez normális jelenség.\nKüldje el újra a keresési kérést.');
...
DEFINE('_IMAGE_SELECT_FILE','Válassza ki a csatolandó képfájlt');
DEFINE('_FILE_SELECT_FILE','Válassza ki a csatolandó fájlt');
DEFINE('_FILE_NOT_UPLOADED','A fájl feltöltése nem sikerült. Próbálja meg újra, vagy módosítsa a hozzászólást.');
DEFINE('_IMAGE_NOT_UPLOADED','A kép feltöltése nem sikerült. Próbálja meg újra, vagy módosítsa a hozzászólást.');
...
DEFINE('_COM_A_SUBJECTLENGTH_DESC',
   'A Tárgy mező hossza. Az adatbázis által támogatott hossz legfeljebb 255 karakter. Ha több bájtos karakterkészletet használ a webhelyen, mint az Unicode, az UTF-8 vagy a nem ISO-8599-x, akkor ezzel a képlettel csökkentheti:<br/><tt>round_down(255/(karakterenkénti legnagyobb karakterkészlet bájtméret))</tt><br/>Példa UTF-8-hoz, melynél a karakterenkénti legnagyobb karakter bájtméret 4 bájt: 255/4=63.');
...
DEFINE('_COM_A_NEWCHAR_DESC','Itt határozhatja meg, hogy mit kell használni az új hozzászólások jelzésére (pl. &quot;!&quot; vagy &quot;Új!&quot;)');
...
DEFINE('_IMAGE_ERROR_TYPE','Kérjük, hogy csak JPG, GIF vagy PNG típusú képet töltsön fel');
DEFINE('_IMAGE_ERROR_EMPTY','Válassza ki a fájlt a feltöltés előtt');
...
DEFINE('_COM_A_IMAGEREGUPLOAD_DESC','Az &quot;Igen&quot; választásával engedélyezheti a regisztrált és bejelentkezett felhasználóknak a képfeltöltést.<br/> Megjegyzés: A (fő)adminisztrátorok és a moderátorok mindig tudnak képeket feltölteni.');
  //New since preRC4-II:
...
DEFINE('_FILE_ERROR_EMPTY','Kérjük, hogy válassza ki a fájlt a feltöltés előtt');
...
DEFINE('_COM_A_FILEALLOWEDTYPES_DESC','Adja meg a feltölthető fájltípusokat. Vesszővel elválasztott szóköz nélküli <strong>kisbetűs</strong> listát használjon.<br />Például: zip,txt,exe,htm,html');
...
DEFINE('_HELP_SUBMIT','Kattintson ide a hozzászólás elküldéséhez');
DEFINE('_HELP_PREVIEW','Kattintson ide a hozzászólás előzetes megtekintéséhez');
DEFINE('_HELP_CANCEL','Kattintson ide a hozzászólás törléséhez');
DEFINE('_POST_DELETE_ATT','Ha bejelöli ezt a jelölőnégyzetet, akkor a törölni kívánt hozzászólások kép- és fájlmellékletei is törlésre kerülnek (ajánlott).');
...
DEFINE('_UPLOAD_ERROR_GENERAL','Hiba történt az avatár feltöltésekor. Kérjük, hogy próbálja meg újra, vagy értesítse a rendszergazdát!');
...
DEFINE('_COM_A_IMGB_ENLARGE','Kattintson a képre a teljes méretű kép megtekintéséhez');
DEFINE('_COM_A_IMGB_DOWNLOAD','Kattintson a fájl képére a letöltéshez');
DEFINE('_COM_A_IMGB_DUMMY_DESC',
   'A &quot;Helyettesítés álképpel&quot; beállítás álképre cseréli a kiválasztott képet.<br /> Ezáltal a postázás megszakítása nélkül távolíthatja el a tényleges fájlt.<br /><small><em>A csere megjelenítéséhez esetenként frissíteni kell az oldalt a böngészőben.</em></small>');
...
DEFINE('_COM_A_IMGB_CONFIRM','Teljesen biztos, hogy törli ezt a fájlt? \n A fájl törlése tönkreteheti a hozzászólásban lévő hivatkozást.');
DEFINE('_COM_A_IMGB_VIEW','Üzenet megnyitása (szerkesztésre)');
DEFINE('_COM_A_IMGB_NO_POST','Nincs hivatkozó üzenet!');
DEFINE('_USER_CHANGE_VIEW','Ezen beállítások módosításai a fórum következő felkeresésekor lépnek érvénybe.<br /> A nézettípust a fórum menüsoráról hozzáférhető beállításokkal válthatja át &quot;Mid-Flight&quot;-ra.');
DEFINE('_MOSBOT_DISCUSS_A','Szóljon hozzá a fórumban. (');
...
DEFINE('_SEARCH_REDIRECT','A Kunenának szüksége van az Ön hozzáférési jogaira, mielőtt a keresést végrehajtja.\nEz akár 30 másodpercet is igénybe vehet, ami normális dolog.\nKüldje el újra a keresési kérést.');
//====================
...
//DEFINE('_COM_A_VIEW_TYPE_DESC','Válasszon a füzérszerű és a sima nézet közül');
...
DEFINE('_COM_A_PUBWRITE_DESC','Az &quot;Igen&quot; választásával mindenki számára engedélyezi a hozzászólást. A &quot;Nem&quot; választása esetén a látogatók olvashatják a fórumot, de csak a regisztrált felhasználók küldhetnek be hozzászólásokat.');
DEFINE('_COM_A_USER_EDIT','Felhasználók módosításai');
DEFINE('_COM_A_USER_EDIT_DESC','Az &quot;Igen&quot; választásával engedélyezheti a regisztrált felhasználóknak a saját hozzászólásaik módosítását.');
DEFINE('_COM_A_MESSAGE','A fenti értékek változtatásainak mentéséhez nyomja meg fent a &quot;Mentés&quot; gombot.');
...
DEFINE('_COM_A_FLOOD_DESC','Azon másodpercek száma, ameddig a felhasználónak várnia kell két egymás utáni hozzászólás között. Az áradásvédelem kikapcsolásához állítsa 0 (nulla) értékre. MEGJEGYZÉS: Az áradásvédelem <em>lassíthatja</em> a működést.');
...
DEFINE('_COM_A_RANKING_DESC','Az &quot;Igen&quot; választása esetén a regisztrált felhasználók rangot kapnak a beküldött hozzászólások száma alapján.<br/><strong>Ehhez a Felhasználói oldal fülön is engedélyeznie kell a Felhasználói statisztika megjelenítését.');
...
//email and stuff
$_COM_A_NOTIFICATION ="Új hozzászólás érkezett ebbe a fórumba: ";
$_COM_A_NOTIFICATION1 = "Új hozzászólás érkezett egy olyan témára, amelynek Ön megrendelte a figyelését a következő fórumban: ";
$_COM_A_NOTIFICATION2 = "A témafigyeléseit a fórum kezdőlapján található 'Profil' hivatkozás követésével kezelheti, miután bejelentkezett a webhelyre. A profiljában le is mondhatja a témafigyelést.";
$_COM_A_NOTIFICATION3 = "Ne válaszoljon erre az értesítésre, ez egy automatikusan generált e-mail.";
$_COM_A_NOT_MOD1 = "Új hozzászólás érkezett egy olyan fórumba, amelynek Ön a moderátora a következő fórumban: ";
$_COM_A_NOT_MOD2 = "Kérjük, hogy tekintse meg, miután bejelentkezett!";
...
DEFINE('_COM_A_PRUNE_DESC',
   'A Fórumok kitakarítása funkcióval azokat a témákat távolíthatja el, melyekbe nem érkeztek új hozzászólások a megadott napok óta. A kiemelt vagy a nyíltan lezárt témákat nem távolítja el; ezeket kézzel kell törölnie. A lezárt fórumokban lévő témák nem takaríthatók ki.');
...
DEFINE('_COM_A_PRUNE_USERS_DESC',
   'Ezzel a funkcióval a Kunena felhasználók névsorát takaríthatja ki a Joomla! webhely felhasználólista alapján. Minden olyan Kunena felhasználó profilját fogja törölni, melyek törlésre kerültek a Joomla! keretrendszerből.<br/>Amikor biztosan akarja folytatni, akkor a fenti menüsávban kattintson a &quot;Kitakarítás indítása&quot; hivatkozásra.');
//general
...
DEFINE('_UPLOAD_SELECT_FILE','Válassza ki a fájlt');
DEFINE('_UPLOAD_ERROR_TYPE','Csak JPG, GIF vagy PNG képet válasszon');
DEFINE('_UPLOAD_ERROR_EMPTY','Kérjük, hogy válassza ki a fájlt a feltöltés előtt');
...
DEFINE('_UPLOAD_ERROR_CHOOSE',"Nem választhat avatárt a galériából.");
DEFINE('_UPLOAD_UPLOADED','Az avatár feltöltése sikerült.');
DEFINE('_UPLOAD_GALLERY','Válasszon az avatárgalériából:');
...
DEFINE('_LISTCAT_INFORM','Tájékoztassa őket, és mondja meg nekik, hogy siessenek!');
...
// post.php
DEFINE('_POST_ABOUT_TO_DELETE','Ön a következő hozzászólás törlésére készül');
DEFINE('_POST_ABOUT_DELETE','<strong>MEGJEGYZÉSEK:</strong><br/>
- Ha töröl egy témát (egy téma első hozzászólását), akkor minden további hozzászólás is törlésre kerül! 
...
DEFINE('_POST_CLICK','kattintson ide');
DEFINE('_POST_ERROR','A felhasználónév/e-mail cím nem található. Súlyos adatbázishiba nem szerepel a listán.');
DEFINE('_POST_ERROR_MESSAGE','Ismeretlen SQL hiba történt, és a hozzászólás beküldése nem történt meg.  Ha a probléma továbbra is fennáll, akkor értesítse az adminisztrátort.');
DEFINE('_POST_ERROR_MESSAGE_OCCURED','Ismeretlen hiba történt, és a hozzázólás módosítása nem történt meg.  Kérjük, próbálja meg újra.  Ha a hiba továbbra is fennáll, akkor értesítse az adminisztrátort.');
DEFINE('_POST_ERROR_TOPIC','Hiba történt a törlés során. Kérjük, ellenőrizze az alábbi hibákat');
DEFINE('_POST_FORGOT_NAME','Elfelejtette megadni a nevét. Kattintson a böngésző Vissza gombjára, és próbálja újra.');
DEFINE('_POST_FORGOT_SUBJECT','Elfelejtette megadni a tárgyat. Kattintson a böngésző Vissza gombjára, és próbálja újra.');
DEFINE('_POST_FORGOT_MESSAGE','Elfelejtette megírni a hozzászólást. Kattintson a böngésző Vissza gombjára, és próbálja újra.');
...
DEFINE('_POST_NOTIFIED','Jelölje be, ha szeretne értesítést kapni a beérkezett hozzászólásokról.');
...
DEFINE('_POST_SUCCESS_REQUEST','A kérés feldolgozása megtörtént. Ha nem jut vissza néhány pillanaton belül a témához,');
...
DEFINE('_POST_TOPIC_FLOOD3','Kattintson a böngésző Vissza gombjára a fórumba való visszatéréshez.');
DEFINE('_POST_EMAIL_NEVER','Az Ön e-mail címe sohasem jelenik meg az oldalakon.');
DEFINE('_POST_EMAIL_REGISTERED','Az Ön e-mail címét csak a regisztrált felhasználók látják.');
...
DEFINE('_USER_ERROR_A','Ön hiba miatt érkezett erre az oldalra. Kérjük, értesítse az adminisztrátort, hogy melyik hivatkozásokra ');
DEFINE('_USER_ERROR_B','kattintott, amik ide irányították Önt. Ő majd javítja a hibát.');
...
DEFINE('_USER_MODERATOR_NONE','Nem található Önhöz hozzárendelt fórum');
...
DEFINE('_USER_PROFILE_NOT_A','Az Ön profilja ');
DEFINE('_USER_PROFILE_NOT_B','nem');
DEFINE('_USER_PROFILE_NOT_C',' frissíthető.');
DEFINE('_USER_PROFILE_UPDATED','A profilt módosítottuk.');
DEFINE('_USER_RETURN_A','Ha néhány pillanaton belül nem irányítjuk vissza a profiljához, akkor ');
DEFINE('_USER_RETURN_B','kattintson ide!');
DEFINE('_USER_SUBSCRIPTIONS','Témafigyeléseim');
DEFINE('_USER_UNSUBSCRIBE','Lemondás');
DEFINE('_USER_UNSUBSCRIBE_A','Ön nem');
DEFINE('_USER_UNSUBSCRIBE_B','mondhatja le');
DEFINE('_USER_UNSUBSCRIBE_C',' ennek a témának a figyelését.');
DEFINE('_USER_UNSUBSCRIBE_YES','A témafigyelés lemondása megtörtént.');
DEFINE('_USER_DELETEAV',' Jelölje be, ha törölni akarja az avatárt');
//New 0.9 to 1.0
...
DEFINE('_NON_SELECTED','Önnek még nincs avatárja <br />');
...
DEFINE('_FORUM_UNAUTHORIZIED2','Ha már regisztrált, akkor jelentkezzen előbb be!');
...
DEFINE('_COM_A_WRAP_DESC',
   'Adja meg egy szó lehetséges maximális hosszát. Ez lehetővé teszi, hogy a hozzászólások a használt sablonhoz igazodjanak.<br/> A 70 karakter elfogadható érték, de a tapasztalata szerint változtathat rajta. Az URL-eket nem érinti a tördelés.');
...
DEFINE('_COM_A_BOARD_OFSET_DESC','Némelyik fórum a felhasználókétól eltérő időzónában lévő kiszolgálókon működik. Állítsa be órában a Kunena által a hozzászólásokban használandó időeltolódást. Pozitív és negatív értéket egyaránt megadhat.');
//New in RC2
...
DEFINE('_COM_A_PMS_DESC',
   'Ha telepítette valamelyik magánüzenet-küldő komponenst, akkor válassza itt ki a megfelelőt. A Clexus PM választása a ClexusPM felhasználói profillal kapcsolatos beállításokat (mint ICQ, AIM, Yahoo, MSN) és a profilhivatkozásokat is engedélyezni fogja, ha a felhasznált Kunena sablon támogatja.');
DEFINE('_VIEW_PMS','Kattintson ide, ha magánüzenetet akar küldeni ennek a felhasználónak');
//new in RC3
DEFINE('_POST_RE','Vá: ');
...
DEFINE('_BBCODE_HINT','BBCode súgó - Tanács: A BBCode-ot kijelölt szöveghez használhatja!');
DEFINE('_COM_A_TAWIDTH','A szövegterület szélessége');
DEFINE('_COM_A_TAWIDTH_DESC','Állítsa be a sablonnak megfelelően a hozzászólás/válasz szövegterületének szélességét. <br/>A hangulatjel eszköztárat két sorba fogja tördelni, ha a szélesség <= 420 képpont');
 DEFINE('_COM_A_TAHEIGHT','A szövegterület magassága');
DEFINE('_COM_A_TAHEIGHT_DESC','Állítsa be a sablonnak megfelelően a hozzászólás/válasz szövegterületének magasságát');
DEFINE('_COM_A_ASK_EMAIL','Az e-mail cím kérése');
DEFINE('_COM_A_ASK_EMAIL_DESC','Meg kell adniuk hozzászóláskor a felhasználóknak vagy a látogatóknak az e-mail címüket. Válassza a &quot;Nem&quot;-et, ha mellőzni akarja ez a funkciót a felhasználói oldalon. Nem fogjuk kérni a látogatók e-mail címét.');
