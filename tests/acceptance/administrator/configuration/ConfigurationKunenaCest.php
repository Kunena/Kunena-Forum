...
class ConfigurationKunenaCest
{
	...
	public function ConfigurationKunena(\AcceptanceTester $I)
	{
		...
		$I->waitForText('Configuration saved.', '5', ['id' => 'system-message-container']);
