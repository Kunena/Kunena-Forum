...
/**
 * Posts model for the Kunena package.
 *
 * @package		Kunena
 * @subpackage	com_kunena
 * @version		1.0
 */
class KunenaModelPosts extends JModel
{
	/**
	...
	function &getItems()
	{
		...
		$key = $this->_getStoreId('kunena.posts');
		...
		//$store = $this->_getStoreId('posts_list');
	...
	function getTotal()
	{
		...
		// Try to load the value from cache.
		//$cache = &JFactory::getCache('com_kunena', 'output');
		//$store = $this->_getStoreId('posts_total');
