		...
		<table class="table table-striped adminlist" id="attachmentsList">
			<thead>
				<tr>
					...
					<th><?php echo JHtml::_('grid.sort', 'Title', 'filename', $listDirection, $listOrdering ); ?></th>
					<th><?php echo JHtml::_('grid.sort', 'Type', 'filetype', $listDirection, $listOrdering ); ?></th>
					<th><?php echo JHtml::_('grid.sort', 'Size', 'size', $listDirection, $listOrdering ); ?>
					<th><?php echo JHtml::_('grid.sort', 'COM_KUNENA_A_IMGB_DIMS', 'img_dims', $listDirection, $listOrdering ); ?></th>
					<th><?php echo JHtml::_('grid.sort', 'COM_KUNENA_ATTACHMENTS_USERNAME', 'username', $listDirection, $listOrdering ); ?></th>
					<th><?php echo JHtml::_('grid.sort', 'Post', 'post', $listDirection, $listOrdering ); ?></th>
				...
				<tr>
					...
					<td class="nowrap">
						...
						<input class="input-block-level input-filter filter" type="text" name="filter_type" id="filter_type" placeholder="<?php echo 'Filter'; ?>" value="<?php echo $filterType; ?>" title="<?php echo 'Filter'; ?>" />
					</td>
					<td class="nowrap">
						<label for="filter_size" class="element-invisible"><?php echo 'Search in';?></label>
						<input class="input-block-level input-filter filter" type="text" name="filter_size" id="filter_size" placeholder="<?php echo 'Filter'; ?>" value="<?php echo $filterSize; ?>" title="<?php echo 'Filter'; ?>" />
					</td>
					<td class="nowrap">
						<label for="filter_dims" class="element-invisible"><?php echo 'Search in';?></label>
						<input class="input-block-level input-filter filter" type="text" name="filter_dims" id="filter_dims" placeholder="<?php echo 'Filter'; ?>" value="<?php echo $filterDimensions; ?>" title="<?php echo 'Filter'; ?>" />
					</td>
					<td class="nowrap">
					...
					<td class="nowrap">
						...
						<input class="input-block-level input-filter filter" type="text" name="filter_post" id="filter_post" placeholder="<?php echo 'Filter'; ?>" value="<?php echo $filterPost; ?>" title="<?php echo 'Filter'; ?>" />
					</td>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo number_format ( intval ( $row->size ) / 1024, 0, '', ',' ) . ' KB'; ?></td>
