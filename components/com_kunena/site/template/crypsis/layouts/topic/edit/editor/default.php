...
<!-- Start expendable secondary toolbar -->
<tr>
	<td class="kpostbuttons">
		...
		<?php if (!$this->message->parent && isset($this->poll)) : ?>
			<div id="kbbcode-poll-options" style="display: none;" class="kpoll">
				...
				<i id="kbutton-poll-add" class="icon-plus btn btn-small"
					onmouseover="document.id('helpbox').set('value', '<?php echo JText::_('COM_KUNENA_EDITOR_HELPLINE_ADDPOLLOPTION', true); ?>')" alt="<?php echo JText::_('COM_KUNENA_POLL_ADD_POLL_OPTION'); ?>"> </i>
				<i id="kbutton-poll-rem" class="icon-minus btn btn-small" onmouseover="document.id('helpbox').set('value', '<?php echo JText::_('COM_KUNENA_EDITOR_HELPLINE_REMPOLLOPTION', true); ?>')" alt="<?php echo JText::_('COM_KUNENA_POLL_REMOVE_POLL_OPTION'); ?>"> </i>
		...
		if (!$this->config->disemoticons) :
			...
			$style = 'ul#kbbcode-toolbar li a#kbbcode-smilies-button {'
...
<!-- end of expendable secondary toolbar -->
<div class="control-group">
	<div class="controls">
