...
<div>
  <h3 class="page-header"><span><?php echo JText::_('COM_KUNENA_PROFILE_EDIT_USER_TITLE') ?></span></h3>
</div>
...
<div class="kheader">
  <h3 class="page-header"><span><?php echo JText::_('COM_KUNENA_GLOBAL_SETTINGS'); ?></span></h3>
</div>
<div class="kcontainer">
  <div class="kbody">
    <table class="table">
      <tbody class="kmyprofile_params">
        ...
        <tr class="krow<?php echo ($i^=1)+1;?>">
          <td class="kcol-first"> <?php echo $userparam->label ?> </td>
          <td class="kcol-mid"> <?php echo $userparam->input ?> </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
