...
class KunenaAdminModelConfig extends KunenaModel {
	function getConfiglists() {
		...
		$lists ['mod_see_deleted'] = JHTML::_('select.genericlist', $seerestoredeleted, 'cfg_mod_see_deleted', 'class="inputbox" size="1"', 'value', 'text', $config->mod_see_deleted);
		...
		$lists ['pubprofile'] = JHTML::_('select.genericlist', $yesno, 'cfg_pubprofile', 'class="inputbox" size="1"', 'value', 'text', $config->pubprofile);
		...
		$lists ['category_subscriptions'] = JHTML::_ ( 'select.genericlist', $category_subscriptions, 'cfg_category_subscriptions', 'class="inputbox" size="1"', 'value', 'text', $config->category_subscriptions );
		...
		$lists ['lazyload'] = JHTML::_('select.genericlist', $yesno, 'cfg_lazyload', 'class="inputbox" size="1"', 'value', 'text', $config->lazyload);
