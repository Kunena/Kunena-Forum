...
class CKunenaUpload
{
	 ...
	 *
	 * @param   string  $errormsg  Set the error message
	 *
	 * @return void
	 */
	...
	/**
	 * Method to get if the file has right been uploaded or not
	 *
	 * @return boolean
	 */
	function getStatus()
	...
	/**
	 * Method to define allowed extensions to be uploaded
	 *
	 * @param   array  $imageExts  List of image extensions allowed
	 * @param   array  $fileExts   List of file extensions allowed
	 *
	 * @return void
	 */
	...
	/**
	 * Method to set the size of image for the resize
	 *
	 * @param   int  $size       Size of the image
	 * @param   int  $maxwidth   Maximum width
	 * @param   int  $maxheight  Maximum height
	 * @param   int  $quality    Quality for the resize
	 *
	 * @return void
	 */
	...
	function checkFileSize($fileSize)
	{
		...
		elseif (($this->_isfile && ($fileSize > $this->_config->filesize * 1024))||
	...
	/**
	 * Method to retrieve file send by the browser
	 *
	 * @param   string  $input  Retrieve file send by the browser
	 *
	 * @return boolean
	 */
	...
	/**
	 * Method to check valid extensions against file name
	 *
	 * @param   array  $validExts  List of valid extensions
	 *
	...
	/**
	 * Method to upload a file on the filesystem
	 *
	 * @param   string   $uploadPath  Define the path where the file will be uploaded
	 * @param   string   $input       File send by the browser
	 * @param   string   $filename    Set the name of the file after the upload
	 * @param   boolean  $ajax        Define if we are using ajax
	 *
	 * @return boolean
	 */
