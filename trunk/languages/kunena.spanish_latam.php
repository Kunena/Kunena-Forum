...
*
*              Language: Spanish
* For Kunena version: 1.0.7b
*              Encoding: UTF-8
*            Translator: Gonzalo R Meneses A.
*               Website: http://www.oshavenezuela.com
*                E-mail: alakentu2003@gmail.com
*   Translation version: 1.0
**/

// Dont allow direct linking
defined( '_JEXEC' ) or defined ('_VALID_MOS') or die('El acceso directo a está pagina no está permitido.');
...
DEFINE('_KUNENA_PDF_VERSION', 'Versión del componente Kunena: %versión%');
...
DEFINE('_KUNENA_ADMIN', 'Administración de Kunena');
