						...
						<td class="span1 hidden-phone"> <?php echo $this->getCategoryLink($category, $this->getCategoryIcon($category), '') ?> </td>
							<td class="span6">
								<div class="kthead-title kl">
									...
									?>
									<a href="" rel="follow"><span class="kicon kmark-read" title="mark category read"></span></a>
									<?php if($this->getCategoryRSSURL($category->id)): ?><a href="<?php echo $this->getCategoryRSSURL($category->id) ?>" rel="follow"><span class="kicon krss-small" title="get the latest posts directly to your desktop"></span></a> </span> </div><?php endif; ?>
							...
							if ($last->exists()) { ?>
								<td class="span2 hidden-phone"><span class="kcat-topics-number"><?php echo $this->formatLargeNumber ( $category->getTopics() ) ?></span> <span class="kcat-topics"><?php echo JText::_('COM_KUNENA_TOPICS');?></span> <br/>
									<span class="kcat-replies-number"><?php echo $this->formatLargeNumber ( $category->getReplies() ) ?></span> <span class="kcat-replies"><?php echo JText::_('COM_KUNENA_GEN_REPLIES');?> </span>
								</td>
							<?php } else { ?>
								<td class="span2 hidden-phone">
									<div class="kinfo">
										<span class="kcat-topics-number"><?php echo $this->formatLargeNumber ( $category->getTopics() ) ?></span> <span class="kcat-topics"><?php echo JText::_('COM_KUNENA_TOPICS');?></span> <br/>
										<span class="kcat-replies-number"><?php echo $this->formatLargeNumber ( $category->getReplies() ) ?></span> <span class="kcat-replies"><?php echo JText::_('COM_KUNENA_GEN_REPLIES');?> </span>
									</div>
								</td>
