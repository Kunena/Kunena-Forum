...
<table
	...
	<tbody>
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_PERSONALTEXT'); ?></td>
			<td class="kmiddle"><input type="text" maxlength="<?php echo $this->config->maxpersotext; ?>" name="personnaltext" value="<?php echo kunena_htmlspecialchars ($this->profile->personalText); ?>"  /></td>
		</tr>
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE'); ?></td>
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_LOCATION'); ?></td><td class="kmiddle"><input type="text" name="location" value="<?php echo $this->profile->location; ?>" /></td>
		</tr>
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_GENDER'); ?></td><td class="kmiddle"><?php
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME'); ?></td><td class="kmiddle"><input type="text" name="websitename" value="<?php echo $this->profile->websitename; ?>" /></td>
		</tr>
		<tr class="krow1">
			<td class="kfirst km kcenter">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_TWITTER'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_FACEBOOK'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_MYSPACE'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_LINKEDIN'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_FRIENDFEED'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_DIGG'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_YIM'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_AIM'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_GTALK'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_ICQ'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_MSN'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_BLOGSPOT'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_FLICKR'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow1">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_BEBO'); ?></td>
			<td class="kmiddle">
		...
		<tr class="krow2">
			<td class="kfirst km kcenter"><?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE'); ?></td>
