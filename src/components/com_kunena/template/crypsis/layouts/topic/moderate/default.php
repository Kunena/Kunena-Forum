	...
	<div>
		<ul class="nav nav-tabs">
			...
			<?php if (isset($this->message) && $this->message->getAuthor()->id != 0) : ?>
				<li><a href="#tab3"
				       data-toggle="tab"><?php echo Text::_('COM_KUNENA_TITLE_MODERATE_TAB_BAN_HISTORY'); ?></a></li>
		...
		<div class="tab-content">
					...
					<div class="control-group">
						<div class="controls">
							<label class="checkbox">
								...
								<?php echo Text::_('COM_KUNENA_MODERATION_TOPIC_KEEP_POLL'); ?> </label>
						</div>
					</div>
				<?php endif; ?>
				<?php if (!isset($this->message)) : ?>
			...
			<div class="control-group center">
				...
				<a href="javascript:window.history.back();" class="btn"> <?php echo Text::_('COM_KUNENA_BACK'); ?> </a>
			</div>
		</div>
	</div>
</form>
