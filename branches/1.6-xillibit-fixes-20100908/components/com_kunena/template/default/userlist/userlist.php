	...
	<div class="kcontainer" id="searchuser_tbody">
		<div class="kbody">
			<div class="search-user">
				<form name="usrlform" method="post" action="<?php echo CKunenaLink::GetUserlistURLNoIntegration(); ?>" onsubmit="return validate()">
...
<div class="kblock">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler close"  rel="userlist-tbody"></a></span>
		<h2><span><?php echo JText::_('COM_KUNENA_USRL_USERLIST'); ?></span></h2>
	</div>
	<div class="kcontainer" id="userlist-tbody">
		<div class="kbody">
				<form action="<?php echo CKunenaLink::GetUserlistURLNoIntegration(); ?>" method="post" name="adminForm">
					<table>
