...
$document->addCustomTag('<script type="text/javascript" src="'.KUNENA_DIRECTURL . '/template/default/plugin/chili/jquery.chili.pack.js"></script>
...
require_once (KUNENA_COMP_C_SRC . '/fb_statsbar.php');
...
?>
                    ...
                    <tr>
                        <th align="left">
                            ...
                            if (file_exists(KUNENA_ABSTMPLTPATH . '/plugin/forumtools/forumtools.php')) {
                                ...
                                include (KUNENA_COMP_F . '/template/default/plugin/forumtools/forumtools.php');
                            }
                        ...
                        if (count($flat_messages) > 0)
                        {
                            foreach ($flat_messages as $fmessage)
                            {
                                ...
                                else if ($userinfo->gid > 0)
                                {
                                    ...
                                    $msg_profile = "<a href=\"" . JRoute::_(KUNENA_LIVEURLREL.'&amp;func=fbprofile&amp;task=showprf&amp;userid=' . $fmessage->userid) . "\"> <img src=\"";
                                ...
                                if (file_exists(KUNENA_ABSTMPLTPATH . '/message.php')) {
                                    ...
                                    include (KUNENA_COMP_F . '/template/default/message.php');
                                }
    ...
    <?php echo $fbIcons['forumlist'] ? '<img src="' . KUNENA_URLICONSPATH . '' . $fbIcons['forumlist'] . '" border="0" alt="' . _GEN_FORUMLIST . '" title="' . _GEN_FORUMLIST . '">' : _GEN_FORUMLIST; ?> </a>
                            ...
                            <?php
                            if (file_exists(KUNENA_JABSPATH . '/templates/' . $this->getTemplate().'/images/arrow.png')) {
