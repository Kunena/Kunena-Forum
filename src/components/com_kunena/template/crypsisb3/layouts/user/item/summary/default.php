					...
					<div class="col-md-12">
						...
						<div class="col-md-3 pull-right">
							...
							<?php if (!empty($websiteName) && $websiteURL != 'http://') : ?>
								<a class="btn btn-default btn-sm" rel="nofollow" target="_blank" href="<?php echo $websiteURL ?>"><?php echo KunenaIcons::bookmark(); ?><?php echo $websiteName ?></a>
							<?php elseif(empty($websiteName) && $websiteURL != 'http://') : ?>
								<a class="btn btn-default btn-sm" href="<?php echo $websiteURL ?>"><?php echo KunenaIcons::bookmark(); ?><?php echo $websiteURL ?></a>
							<?php elseif(!empty($websiteName) && $websiteURL == 'http://') : ?>
