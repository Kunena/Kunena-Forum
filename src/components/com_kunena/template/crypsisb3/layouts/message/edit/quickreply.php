...
<div class="col-md-12 qreplyform" id="kreply<?php echo $message->displayField('id'); ?>_form"
	 style="position: relative; top: 10px; left: -20px; right: -10px; width:100%; z-index: 1;display: none;" data-backdrop="false">
...
<?php endif; ?>
			<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena&view=topic'); ?>" method="post"
				...
				<div class="modal-header">
					<button type="button" class="close kreply-cancel" data-dismiss="modal"><span aria-hidden="true">×</span><span
					...
					<?php if ($config->askemail && !$me->exists()): ?>
						<div class="form-group">
							...
							<input type="text" id="email" name="email"
								   ...
								   class="inputbox col-md-12 form-control" maxlength="45" value="" required/>
						</div>
					<?php endif; ?>
