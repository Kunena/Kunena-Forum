<?php
/**
* @version $Id:001(first v.) kunena.german.php  / formal 2009-04-04 11:25:00 Lintzy $
**
* Kunena Component
* @package Kunena
*
...
DEFINE('_KUNENA_SEARCH_DATE_OLDER', 'Und &auml;lter');
DEFINE('_KUNENA_SEARCH_SORTBY', 'Sortiere Ergebnisse nach');
DEFINE('_KUNENA_SEARCH_SORTBY_TITLE', 'Titel');
DEFINE('_KUNENA_SEARCH_SORTBY_POSTS', 'Anzahl von Beitr&auml;gen');
...
DEFINE('_POST_NOT_MODERATOR', 'Sie haben keine Moderatorenrechte');
DEFINE('_POST_NO_FAVORITED_TOPIC', 'Dieses Thema wurde <b>nicht</b> zu Ihren Favoriten hinzuge&uuml;gt');
DEFINE('_COM_C_SYNCEUSERSDESC', 'Synchronisiert die Kunena Datenbank mit der Joomla Userdatenbank');
DEFINE('_POST_FORGOT_EMAIL', 'Sie haben vergessen, Ihre E-Mail-Adresse einzutragen. Bitte klicken Sie auf den Return-Button Ihres Browsers und versuchen es noch einmal.');
...
DEFINE('_KUNENA_SAMPLE_MAIN_CATEGORY_TITLE', 'Kategorie');
...
DEFINE('_KUNENA_SAMPLE_MAIN_CATEGORY_HEADER', 'Um Ihren Besuchern und Mitgliedern Extra-Informationen zukommen zu lassen koennen Sie im Kopf des Forums im obersten Bereich ausgewählter Kategorien Textnachrichten unterbringen.');
DEFINE('_KUNENA_SAMPLE_FORUM1_TITLE', 'Eingangsbereich');
DEFINE('_KUNENA_SAMPLE_FORUM1_DESC', 'Wir laden unsere neuen Mitglieder ein, eine kurze Vorstellung über sich selbst in dieses Forum zu posten. Lernen Sie sich besser kennen und teilen Sie Ihre gemeinsamen Interessen miteinander.');
DEFINE('_KUNENA_SAMPLE_FORUM1_HEADER', '[b]Willkommen im Kunena Forum[/b]

Erzählen Sie uns und unseren Mitgliedern wer Sie sind, was Sie mögen und wieso Sie ein Mitglied dieser Site geworden sind.

Wir begrüßen alle neuen Mitglieder und hoffen Sie oft wiederzusehen!');
DEFINE('_KUNENA_SAMPLE_FORUM2_TITLE', 'Ideen-Forum');
DEFINE('_KUNENA_SAMPLE_FORUM2_DESC', 'Haben Sie ein Feedback für uns oder einen Verbesserungsvorschlag?

Nur Mut! Hinterlassen Sie uns eine Nachricht, denn wir sind stets bemüht unsere Site zu verbessern, um sie attraktiver für unsere Besucher und Mitglieder zu gestalten.');
...
Danke, dass Sie Kunena als Ihr Community Forum für Ihr Joomla! CMS gewählt haben.

Kunena, heißt übersetzt aus Suaheli: "Reden", und wird von einem Team aus Opensource Spezialisten entwickelt, das sich zum Ziel gesetzt hat, eine hochqualitative sowie eng an Joomla! angepasste Lösung zu bieten. Außerdem unterstützt Kunena  Social Networking Komponenten wie Community Builder und JomSocial.
...
DEFINE('_COM_A_HIGHLIGHTCODE_DESC', 'Aktiviert das Kunena-JavaScript f&uuml;r die Code-Hervorhebung. Wenn Ihre Mitglieder PHP-Code oder vergleichbaren Code in ihrem Beitrag zwischen  Code-Tags setzen, wird er farblich hervorgehoben. Wenn Ihr Forum diese Funktion nicht ben&ouml;tigt, sollten Sie diese deakivieren, damit Code-Tags nicht zerst&ouml;rt werden.');
DEFINE('_COM_A_RSS_TYPE', 'Standard RSS-Typ');
DEFINE('_COM_A_RSS_TYPE_DESC', 'W&auml;hlen Sie zwischen RSS-Feeds eines Themas oder eines Beitrags. &quot;Nach Thema&quot; bedeutet, dass nur ein Eintrag pro Thema im RSS-Feed gelistet wird, unabh&auml;ngig davon, wie viele Beitr&auml;ge in diesem Thema geschrieben wurden. &quot;Nach Thema&quot; bedeutet somit, dass ein kleinerer RSS-Feed generiert wird, der nicht alle geschriebenen Antworten beinhalten wird.');
DEFINE('_COM_A_RSS_BY_THREAD', 'Nach Thema');
DEFINE('_COM_A_RSS_BY_POST', 'Nach Beitrag');
DEFINE('_COM_A_RSS_HISTORY', 'RSS History');
DEFINE('_COM_A_RSS_HISTORY_DESC', 'W&auml;hlen Sie aus, wie viele Beitr&auml;ge im RSS-Verlauf enthalten sein sollen. Standard ist 1 Monat, aber eventuell sollten Sie es auf 1 Woche beschr&auml;nken, wenn Ihre Website sehr ausgelastet ist.');
...
DEFINE('_POST_FORGOT_NAME_ALERT', 'Sie haben vergessen, Ihren Namen einzugeben.');
DEFINE('_POST_FORGOT_EMAIL_ALERT', 'Sie haben vergessen, Ihre E-Mail Adresse einzugeben.');
DEFINE('_POST_FORGOT_SUBJECT_ALERT', 'Sie haben vergessen, einen Betreff anzugeben.');
DEFINE('_KUNENA_EDIT_TITLE', 'Registrierdaten bearbeiten');
DEFINE('_KUNENA_YOUR_NAME', 'Ihr Name:');
...
DEFINE('_POST_SPLIT_HINT', '<br />Hinweis: Sie k&ouml;nnen einen Beitrag an die erste Position eines Themas bringen, wenn Sie im ersten Beitrag eines Themas auf trennen klicken. Markieren Sie den Beitrag, der nach oben soll in der zweiten Spalte und w&auml;hlen Sie sonst nichts zum Teilen aus.<br />');
...
// Additional
DEFINE('_POST_UNFAVORITED_TOPIC', 'Dieses Thema wurde von Ihren Favoriten entfernt!');
DEFINE('_POST_NO_UNFAVORITED_TOPIC', 'Dieses Thema wurde <b>NICHT</b> von Ihren Favoriten entfernt!');
DEFINE('_POST_SUCCESS_UNFAVORITE', 'Ihre Anweisung zur L&ouml;schung von den Favoriten wurde durchgef&uuml;hrt!');
DEFINE('_POST_UNSUBSCRIBED_TOPIC', 'Dieses Thema wurde von Ihrer Aboliste gel&ouml;scht!');
DEFINE('_POST_NO_UNSUBSCRIBED_TOPIC', 'Dieses Thema wurde <b>NICHT</b> von Ihrer Aboliste gel&ouml;scht!');
DEFINE('_POST_SUCCESS_UNSUBSCRIBE', 'Ihre Anweisung zur L&ouml;schung von der Aboliste wurde durchgef&uuml;hrt!');
...
DEFINE('_KUNENA_CSS_SAVE', 'Speichern Sie die CSS-Datei hier... Datei="%file%"');
...
DEFINE('_KUNENA_POST_DEL_ERR_TXT', 'Der Text konnte nicht gel&ouml;scht werden! Bitte aktualisieren Sie die Datenbank manuell (mesid=%id%)!');
DEFINE('_KUNENA_POST_DEL_ERR_USR', 'Alles gel&ouml;scht! Aber die Benutzerstatistik konnte nicht aktualisiert werden!');
DEFINE('_KUNENA_POST_MOV_ERR_DB', "Datenbankfehler gefunden! Bitte aktualisieren Sie Ihre Datenbank manuell, damit die Antworten zum neuen Forum passen.");
...
DEFINE('_KUNENA_A_MAIL_ADMIN_DESC', 'W&auml;hlen Sie &quot;Ja&quot;, wenn Sie wollen, dass eine E-Mail-Benachrichtigung bei jedem neuen Beitrag an die Administration geschickt werden soll.');
...
DEFINE('_KUNENA_INSTALL_CLICK_TO_CONTINUE', 'Klicken Sie hier, um fortzufahren...');
DEFINE('_KUNENA_INSTALL_APPLY', 'Durchf&uuml;hren!');
DEFINE('_KUNENA_NO_ACCESS', 'Sie haben keinen Zugang zu diesem Forum!');
...
DEFINE('_COM_A_USER_EDIT_TIME_DESC', 'Stellen Sie &quot;0&quot; f&uuml;r eine unbegrenzte Bearbeitungzeit ein. Oder geben Sie in Sekunden an, wie lange ein Benutzer seinen Beitrag ver&auml;ndern darf, nachdem er ihn geschrieben bzw. zuletzt bearbeitet hat.');
...
DEFINE('_KUNENA_HELPPAGE_IN_KUNENA_DESC','Wenn &quot;Ja&quot;, dann wird der Hilfeinhalt in Kunena eingef&uuml;gt und der Link zur externen Hilfeseite wird nicht mehr funktionieren. <b>Hinweis:</b> Sie m&uuml;ssen eine &quot;Hilfeinhalt-ID&quot; eintragen!');
DEFINE('_KUNENA_HELPPAGE_CID','Hilfeinhalt-ID');
DEFINE('_KUNENA_HELPPAGE_CID_DESC','Sie sollten <b>&quot;Ja&quot;</b> in &quot;Hilfe in Kunena anzeigen&quot; aktiviert haben.');
DEFINE('_KUNENA_HELPPAGE_LINK',' Externe Hilfeseite');
DEFINE('_KUNENA_HELPPAGE_LINK_DESC','Wenn Sie eine externe Hilfeseite benutzen wollen, so stellen Sie bitte unter &quot;Hilfe in Kunena anzeigen&quot; <b>&quot;Nein&quot;</b> ein.');
...
DEFINE('_KUNENA_RULESPAGE_IN_KUNENA_DESC','Wenn &quot;Ja&quot;, dann wird der Regelinhalt in Kunena eingef&uuml;gt und die externe Regelseite wird nicht mehr funktionieren. <b>Hinweis:</b> Sie m&uuml;ssen eine &quot;Regelinhalt-ID&quot; eintragen.');
DEFINE('_KUNENA_RULESPAGE_CID','Regelinhalt-ID');
DEFINE('_KUNENA_RULESPAGE_CID_DESC','Sie sollten <b>&quot;Ja&quot;</b> in &quot;Regeln in Kunena anzeigen&quot; aktiviert haben.');
DEFINE('_KUNENA_RULESPAGE_LINK','Externe Regelseite');
DEFINE('_KUNENA_RULESPAGE_LINK_DESC','Wenn Sie eine externe Regelseite benutzen wollen, so stellen Sie bitte unter &quot;Regeln in Kunena anzeigen&quot; <b>&quot;Nein&quot;</b> ein.');
...
DEFINE('_KUNENA_GD_NOT_INSTALLED','GD ist nicht installiert! Sie k&ouml;nnen weitere Informationen erhalten&#32; ');
...
DEFINE('_KUNENA_WELCOME_DESC','Danke, dass Sie sich f&uuml;r Kunena als Ihr Forensystem entschieden haben. Diese Ansicht gibt Ihnen einen schnellen &Uuml;berblick &uuml;ber mehrere Statistiken Ihres Forums. Die Links auf der linken Seite dieser Ansicht geben Ihnen die M&ouml;glichkeit jeden Aspekt Ihres Forums zu bearbeiten. Jede Seite hat n&auml;here Informationen, wie Sie diese Tools einsetzen k&ouml;nnen.');
...
DEFINE('_COM_A_STATSPAGE_DESC','Wenn auf &quot;Ja&quot;, dann wird ein Link im oberen Bereich des Forums angezeigt, der zur Statistikseite f&uuml;hrt. Diese Seite enh&auml;lt einige Statistiken &uuml;ber Ihr Forum. <em>Die Statistikseite wird dem Admin immer zur Verf&uuml;gung stehen, egal was hier eingestellt wird!</em>');
DEFINE('_COM_C_JBSTATS','Statistik');
DEFINE('_COM_C_JBSTATS_DESC','Forum Statistiken');
DEFINE('_GEN_GENERAL','Allgemein');
DEFINE('_PERM_NO_READ','Sie haben nicht gen&uuml;gend Rechte, um auf dieses Forum zuzugreifen!');
...
DEFINE('_KUNENA_HIDETEXT','Bitte melden Sie sich an, damit Sie diesen Inhalt sehen k&ouml;nnen!');	
...
DEFINE('_KUNENA_COM_A_REPORT_DESC', 'W&auml;hlen Sie &quot;Ja&quot; und der Benutzer kann Beitr&auml;ge der Administration melden.');
DEFINE('_KUNENA_REPORT_MSG', 'Beitrag wurde gemeldet!');
DEFINE('_KUNENA_REPORT_REASON', 'Grund');
DEFINE('_KUNENA_REPORT_MESSAGE', 'Ihre Nachricht');
...
DEFINE('_KUNENA_REPORT_INTRO', 'wurde Ihnen eine Nachricht geschickt, weil');
...
DEFINE('_KUNENA_EMOTICONS_PICK_A_SMILEY', 'W&auml;hlen Sie einen Smiley');
...
DEFINE('_KUNENA_MYPROFILE_MYAVATAR', 'Ihr Avatar');
...
DEFINE('_KUNENA_MYPROFILE_MY_POSTS', 'Ihre Beitr&auml;ge');
DEFINE('_KUNENA_MYPROFILE_MY_SUBSCRIBES', 'Ihre Abos');
DEFINE('_KUNENA_MYPROFILE_MY_FAVORITES', 'Ihre Favoriten');
...
DEFINE('_KUNENA_MYPROFILE_ICQ_DESC', 'Das ist Ihre &quot;ICQ&quot;-Nummer.');
DEFINE('_KUNENA_MYPROFILE_AIM', 'AIM');
DEFINE('_KUNENA_MYPROFILE_AIM_DESC', 'Das ist Ihr &quot;AOL Instant Messenger&quot;-Nickname.');
DEFINE('_KUNENA_MYPROFILE_YIM', 'YIM');
DEFINE('_KUNENA_MYPROFILE_YIM_DESC', 'Das ist Ihr &quot;Yahoo! Instant Messenger&quot;-Nickname.');
DEFINE('_KUNENA_MYPROFILE_SKYPE', 'SKYPE');
DEFINE('_KUNENA_MYPROFILE_SKYPE_DESC', 'Das ist Ihr &quot;Skype&quot;-Name.');
DEFINE('_KUNENA_MYPROFILE_GTALK', 'GTALK');
DEFINE('_KUNENA_MYPROFILE_GTALK_DESC', 'Das ist Ihr &quot;Gtalk&quot;-Name.');
...
DEFINE('_KUNENA_MYPROFILE_MSN_DESC', 'Das ist Ihre &quot;MSN Messenger&quot;-E-Mail-Adresse.');
...
DEFINE('_KUNENA_QMESSAGE_NOTE', 'Beachten Sie: Forencode und Smiley-Button sind nicht sichtbar, aber trotzdem nutzbar!');
...
DEFINE ('_KUNENA_USRL_SEARCH_ALERT','Bitte geben Sie ein Suchwort ein!');
...
DEFINE('_KUNENA_DBMETHOD', 'Bitte w&auml;hlen Sie die Methode aus, mit der Sie die Installation abschlie&szlig;en wollen:');
...
DEFINE('_KUNENA_SELECTANITEMTO', 'W&auml;hlen Sie ein Objekt zum');
...
DEFINE('_KUNENA_YOURCONFIGFILEIS', 'Ihre Konfigurationsdatei ist');
...
DEFINE('_KUNENA_SELECTMODTO', 'W&auml;hlen Sie einen Moderator aus, um zu');
DEFINE('_KUNENA_CHOOSEFORUMTOPRUNE', 'Sie m&uuml;ssen ein Forum zum Bereinigen ausw&auml;hlen!');
...
DEFINE('_KUNENA_FORUMPRRDESC', 'Wenn Sie &quot;Clexus PM&quot; f&uuml;r den &quot;Community Builder&quot; installiert haben, dann k&ouml;nnen Sie Kunena so einstellen, dass &quot;Clexus&quot; die Profilseite des Benutzers benutzt.');
DEFINE('_KUNENA_USERPROFILE_PROFILE', 'Profil');
DEFINE('_KUNENA_USERPROFILE_PROFILEHITS', '<b>Profilanzeige</b>');
DEFINE('_KUNENA_USERPROFILE_MESSAGES', 'Ihre Forumbeitr&auml;ge');
...
DEFINE('_KUNENA_SUBSCRIPTIONSCHECKED_DESC', 'Auf &quot;Ja&quot; einstellen, wenn Sie wollen, dass die Abobox immer ausgew&auml;hlt ist');
...
DEFINE('_KUNENA_SHOWSTATSDESC', 'Wenn Sie Statistiken anzeigen wollen, dann w&auml;hlen Sie &quot;Ja&quot; aus');
DEFINE('_KUNENA_SHOWWHOIS', '&quot;Wer ist online&quot; anzeigen');
DEFINE('_KUNENA_SHOWWHOISDESC', 'Wenn Sie &quot;Wer ist online&quot; anzeigen wollen, dann w&auml;hlen Sie &quot;Ja&quot; aus');
DEFINE('_KUNENA_STATSGENERAL', '&quot;Allgemeine Statistiken&quot; anzeigen');
DEFINE('_KUNENA_STATSGENERALDESC', 'Wenn Sie &quot;allgemeine Statistiken&quot; anzeigen wollen, dann w&auml;hlen Sie &quot;Ja&quot; aus');
DEFINE('_KUNENA_USERSTATS', '&quot;Beliebte Benutzer&quot; Statistiken anzeigen');
DEFINE('_KUNENA_USERSTATSDESC', 'Wenn Sie &quot;beliebte Benutzer&quot; Statistiken anzeigen wollen, dann w&auml;hlen Sie &quot;Ja&quot; aus');
DEFINE('_KUNENA_USERNUM', 'Anzahl &quot;Beliebte Benutzer&quot;');
DEFINE('_KUNENA_USERPOPULAR', '&quot;Beliebte Beitr&auml;ge&quot; anzeigen');
DEFINE('_KUNENA_USERPOPULARDESC', 'Wenn Sie &quot;beliebte Beitr&auml;ge&quot; anzeigen wollen, dann w&auml;hlen Sie &quot;Ja&quot; aus');
...
DEFINE('_KUNENA_CSSERROR', 'Bitte beachten Sie: Die CSS-Template-Datei darf nicht schreibgesch&uuml;tzt sein, damit die &Auml;nderungen &uuml;bernommen werden k&ouml;nnen.');
// User Management
...
DEFINE('_KUNENA_NOMODSAV', 'Es wurden keine geeigneten Moderatoren gefunden. Lesen Sie den &quot;Hinweis&quot; unten.');
DEFINE('_KUNENA_NOTEUS',
    'HINWEIS: Nur Benutzer, die in ihrem Kunena-Profil als Moderator eingestuft sind, werden hier angezeigt. Um einen Moderator hinzuzuf&uuml;gen m&uuml;ssen Sie ihm Moderatorenrechte geben. Gehen Sie hierzu in die <a href="index2.php?option=com_Kunena&task=profiles">Benutzer-Administration</a> und suchen Sie nach dem jeweiligen Benutzer. W&auml;hlen Sie dann sein Profil aus und &auml;ndern Sie es entsprechend. Der Moderationsstatus kann nur von Administratoren gesetzt werden.');
...
DEFINE('_KUNENA_PARENTDESC',
    'Bitte denken Sie dran: Um ein Forum erstellen zu k&ouml;nnen brauchen Sie eine &quot;Kategorie&quot;. Diese Kategorie bildet die oberste Ebene und beinhaltet Foren samt Unterforen.<br />Ein Forum kann <strong>nur</strong> unter einer Kategorie erstellt werden. Ein Unterforum wird in einem &uuml;bergeordneten Forum erstellt.<br /> Beitr&auml;ge k&ouml;nnen <strong>NICHT</strong> in Kategorien geschrieben werden, sondern nur in Foren und Unterforen.');
...
DEFINE('_KUNENA_ADMINLEVELDESC',
    'Wenn Sie ein Forum mit &ouml;ffentlichem Zugang im Frontend erstellen, k&ouml;nnen Sie hier einen zus&auml;tzlichen Administrationslevel f&uuml;r das Backend definieren.<br /> Wenn Sie den Zugang auf eine bestimmte Beutzergruppe des Frontends beschr&auml;nken, aber hier keine zus&auml;tzliche Benutzergruppe f&uuml;r das Backend ausw&auml;hlen, wird es Administratoren nicht m&ouml;glich sein das Forum zu sehen.');
...
DEFINE('_KUNENA_MODDESC',
    'Auf &quot;Ja&quot; einstellen, wenn Sie diesem Forum Moderatoren zuweisen m&ouml;chten.<br /><strong>Hinweis:</strong> Das hei&szlig;t nicht, dass neue Beitr&auml;ge erst &uuml;berpr&uuml;ft werden m&uuml;ssen, bevor sie ver&ouml;ffentlicht werden!<br /> Daf&uuml;r m&uuml;ssen Sie die Option &quot;Beitr&auml;ge &uuml;berpr&uuml;fen&quot; unter dem Tab &quot;Erweitert&quot; aktivieren.<br /><br /> <strong>Wichtig!:</strong> Nachdem Sie &quot;Moderiert&quot; auf &quot;Ja&quot; gestellt haben, m&uuml;ssen Sie Ihre Einstellungen abspeichern, bevor Sie Moderatoren hinzuf&uuml;gen k&ouml;nnen.');
...
// Kunena 1.0.0
//
DEFINE('_COM_A_FAVORITES','Favoriten zulassen');
DEFINE('_COM_A_FAVORITES_DESC','Auf &quot;Ja&quot; setzen, wenn Sie registrierten Benutzern erlauben wollen, Themen zu den Favoriten hinzuzuf&uuml;gen ');
...
DEFINE('_USER_UNFAVORITE_YES','Das Thema wurde aus Ihren Favoriten entfernt!');
...
DEFINE('_POST_SUCCESS_FAVORITE','Ihre Anweisung zum Hinzuf&uuml;gen in die Aboliste wurde durchgef&uuml;hrt!');
...
DEFINE('_KUNENA_USE_JOOMLA_STYLE_DESC','Wenn Sie die Joomla!-CSS-Klassen benutzen wollen, dann bitte auf &quot;Ja&quot; setzen. (Klassen: wie sectionheader, sectionentry1 ...) ');
...
DEFINE('_KUNENA_SHOW_LATEST_MESSAGES_DESC','W&auml;hlen Sie &quot;Ja&quot; aus, wenn die neuesten Beitr&auml;ge in einer extra Box angezeigt werden sollen.');
...
DEFINE('_KUNENA_ANN_MODID_DESC','Hier f&uuml;gen Sie die IDs der Benutzer, die Ank&uuml;ndigungen verfassen oder moderieren k&ouml;nnen, ein, z.B. 62, 63, 73. Diese Benutzer k&ouml;nnen Ank&uuml;ndigungen hinzuf&uuml;gen, &auml;ndern oder l&ouml;schen.');
//
DEFINE('_KUNENA_FORUM_TOP', 'W&auml;hlen Sie ein Forum&#32;');
...
DEFINE('_USER_FAVORITES', 'Ihre Favoriten');
...
DEFINE('_USRL_SEARCH_ALERT', 'Bitte geben Sie ein Suchwort ein!');
...
DEFINE('_COM_A_MOSBOT_DESC', 'Der &quot;Discuss-Bot&quot; erm&ouml;glicht den Benutzern, &uuml;ber Artikel im Forum zu diskutieren. Der Titel wird als Betreff im Forum gew&auml;hlt. Falls noch kein Diskussionsthema besteht, wird ein neues erstellt. Falls es schon existiert, bekommt der Benutzer das Thema gezeigt und kann antworten.' . '<br /><strong>Sie m&uuml;ssen den &quot;Discuss-Bot&quot; separat herunterladen.</strong>'
           . '<br /><br />Besuchen Sie die <a href="http://www.kunena.com" target="_blank">Kunena-Homepage</a> f&uuml;r weitere Informationen. Nach der Installation m&uuml;ssen Sie folgenden Text f&uuml;r den Bot in Ihren Beitrag einbinden:' . '<br />{mos_KUNENA_discuss:catid}'
           . '<br />Die <em>catid</em> geh&ouml;rt zu dem Forum, in welchem die Diskussion stattfindet. Um die richtige &quot;CatID&quot; zu finden, schauen Sie einfach im Forum nach und pr&uuml;fen die Kategorie-Id der URL  aus der Browser-Statusleiste.'
           . '<br /><br />Beispiel: Soll der Beitrag mit der &quot;CatID&quot; 26 diskutiert werden, sollte der Bot-Tag wie folgt aussehen: {mos_KUNENA_discuss:26}'
...
DEFINE('_COM_FORUM_RULES_DESC', '<ul><li>bearbeiten Sie folgende Datei um die Regeln einzuf&uuml;gen joomlaroot/administrator/components/com_kunena/language/kunena.german.php</li><li>Rule 2</li><li>Rule 3</li><li>Rule 4</li><li>...</li></ul>');
//smile.class.php
DEFINE('_COM_BOARDCODE','Forencode');
// moderate_messages.php
DEFINE('_MODERATION_APPROVE_SUCCESS','Ihr Beitrag wurde akzeptiert');
...
DEFINE('_COM_A_RULESPAGE_DESC',
    'Wenn Sie &quot;Ja&quot; w&auml;hlen, wird im Men&uuml; von Kunena der Link zu den Regeln angezeigt. Sie k&ouml;nnen die Regeln in der rules.php in &quot;/joomla_root/components/com_Kunena&quot; bearbeiten. <em>Vor der n&auml;chsten Aktualisierung, sollten Sie diese Datei sichern!</em>');
DEFINE('_MOVED_TOPIC','Verschoben:');
DEFINE('_COM_A_PDF','PDF-Generierung aktivieren');
DEFINE('_COM_A_PDF_DESC',
    'Wenn Sie &quot;Ja&quot; w&auml;hlen, kann von jedem Thema ein PDF-Dokument generiert werden.<br />Es ist nur ein <u>einfaches</u> PDF-Dokument; ohne Besonderheiten...<br /><strong>Wichtig:</strong><ul><li>Diese Funktion l&auml;uft erst ab Mambo 4.5.2 aufw&auml;rts!</li><li>Die Funktion wurde nicht auf Mambo 4.5.1 getestet, aber man kann es versuchen. Dennoch wird es keinen offiziellen Support f&uuml;r 4.5.1 geben.</li><li>Es funktioniert nicht mit Mambo 4.5.0 (getestet)!</li></ul>');
DEFINE('_GEN_PDFA','Klicken Sie auf diesen Button, um ein neues PDF-Dokument zu generieren! (&ouml;ffnet in einem neuen Fenster).');
DEFINE('_GEN_PDF', 'PDF');
//new in 1.0.4 stable
DEFINE('_VIEW_PROFILE','Hier klicken, um das Profil dieses Benutzers zu sehen');
DEFINE('_VIEW_ADDBUDDY','Hier klicken, um diesen Benutzer Ihrer Freundesliste hinzuzuf&uuml;gen');
DEFINE('_POST_SUCCESS_POSTED','Ihr Beitrag wurde erfolgreich gespeichert!');
...
DEFINE('_COM_A_BADWORDS_DESC','Stellen Sie auf &quot;Ja&quot;, wenn Sie Worte, die in Beitr&auml;gen geschrieben wurden, filtern m&ouml;chten. Welche W&ouml;rter gefiltert werden sollen, stellen Sie bitte in der &quot;Badword&quot;-Komponente ein. Bedenken Sie, dass Sie die Komponente vorher installieren m&uuml;ssen!');
DEFINE('_COM_A_BADWORDS_NOTICE','* Diese Nachricht wurde zensiert, da der Administrator bestimmte W&ouml;rter in Ihrer Nachricht blockiert hat *');
DEFINE('_COM_A_AVATAR_SRC','Avatar-Bild nutzen von');
DEFINE('_COM_A_AVATAR_SRC_DESC',
    'Wenn Sie &quot;Clexus PM&quot; f&uuml;r den &quot;Community Builder&quot; installiert haben, dann k&ouml;nnen Sie Kunena so konfigurieren, dass das Avatar-Bild von &quot;myPMS Pro&quot; oder dem &quot;Community Builder&quot; benutzt werden kann. HINWEIS: Beim &quot;Community Builder&quot; m&uuml;ssen Sie die Thumbnail-Funktion aktivieren, da das Forum die Thumbnails verwendet und nicht die originalen Bilder.');
DEFINE('_COM_A_KARMA','Karma zeigen');
DEFINE('_COM_A_KARMA_DESC','W&auml;hlen Sie &quot;Ja&quot;, um das Benutzerkarma und die Bewertungsbuttons (Applaudieren / Peinigen) zu zeigen, sofern die Benutzer-Statistiken aktiviert sind.');
DEFINE('_COM_A_DISEMOTICONS','Smilies deaktivieren');
DEFINE('_COM_A_DISEMOTICONS_DESC','W&auml;hlen Sie &quot;Ja&quot;, um Smilies komplett zu deaktivieren.');
...
DEFINE('_POST_SUCCESS_REQUEST2','Ihre Anfrage ist in Arbeit');
DEFINE('_POST_NO_PUBACCESS3','Klicken Sie hier, um sich zu registrieren.');
//==================================================================================================
//Changed in 1.0.4
...
DEFINE('_POST_SUCCESS_POST','Ihr Eintrag wurde gespeichert.');
DEFINE('_POST_SUCCESS_SUBSCRIBE','Ihr Abo l&auml;uft.');
//==================================================================================================
//new in 1.0.3 stable
//Karma
DEFINE('_KARMA','Karma');
...
DEFINE('_KARMA_WAIT','Sie k&ouml;nnen das Karma eines Benutzers nur alle 6 Stunden &auml;ndern. <br/>Bitte warten Sie, bis die Zeit verstrichen ist, dann k&ouml;nnen Sie erneut ein Karma &auml;ndern.');
DEFINE('_KARMA_SELF_DECREASE','Bitte versuchen Sie nicht Ihr eigenes Karma zu ver&auml;ndern!');
DEFINE('_KARMA_SELF_INCREASE','Ihr Karma wurde verringert, weil Sie versucht haben, es selbst aufzuwerten!');
DEFINE('_KARMA_DECREASED','Das Karma des Benutzers wurde verringert. Falls Sie nicht gleich zum Thema weiter geleitet werden,');
DEFINE('_KARMA_INCREASED','Das Karma des Benutzers wurde erh&ouml;ht. Falls Sie nicht gleich zum Thema weiter geleitet werden,');
DEFINE('_COM_A_TEMPLATE','Template');
DEFINE('_COM_A_TEMPLATE_DESC','W&auml;hlen Sie das gew&uuml;nschte Template aus.');
DEFINE('_COM_A_TEMPLATE_IMAGE_PATH', 'Bildersets');
DEFINE('_COM_A_TEMPLATE_IMAGE_PATH_DESC', 'W&auml;hlen Sie ein Bilderset f&uuml;r das Template aus.');
DEFINE('_PREVIEW_CLOSE','Das Fenster schlie&szlig;en');
//==========================================
//new in 1.0 Stable
DEFINE('_COM_A_POSTSTATSBAR','Benutzen Sie die Themen-Statistik');
DEFINE('_COM_A_POSTSTATSBAR_DESC','W&auml;hlen Sie &quot;Ja&quot;, um die Anzahl der Beitr&auml;ge des Benutzer grafisch in einem Statistik-Balken darzustellen.');
DEFINE('_COM_A_POSTSTATSCOLOR','Farbnummer des Statistik-Balkens');
DEFINE('_COM_A_POSTSTATSCOLOR_DESC','Tragen Sie hier die Farbnummer ein, um die Farbe f&uuml;r den Statistik-Balken festzulegen');
DEFINE('_LATEST_REDIRECT','Kunena ben&ouml;tigt erneut Ihre Zugangsdaten, um eine aktuelle Liste der letzten Beitr&auml;ge seit der letzten Anmeldung zu erstellen (Das ist normal, nach drei&szlig;ig Minuten Inaktivit&auml;t nach dem Einloggen). Diese Liste bleibt 30 Minuten aktiv.');
...
DEFINE('_FILE_NOT_UPLOADED','Die Datei konnte nicht &uuml;bertragen werden. Bitte versuchen Sie es noch einmal');
DEFINE('_IMAGE_NOT_UPLOADED','Das Bild konnte nicht &uuml;bertragen werden. Bitte versuchen Sie es noch einmal');
DEFINE('_BBCODE_IMGPH','Platzhalter [img] einfuegen fuer Bildanhang');
DEFINE('_BBCODE_FILEPH','Platzhalter [file] einfuegen fuer Dateianhang');
...
DEFINE('_COM_A_SUBJECTLENGTH_DESC',
    'Maximale &Uuml;berschriftenl&auml;nge. Die Datenbank erlaubt maximal 255 Zeichen. Falls Ihre Website mit &quot;multi-byte character&quot; arbeitet, wie z.B. Unicode, UTF-8, non-ISO-8599-x verringern Sie das Maximum durch die Verwendung folgender Formel:<br/><tt>round_down(255/(Maximale Zeichensatz Bytegr&ouml;&szlig;e pro Zeichen))</tt><br/> Beispiel f&uuml;r Utf-8, f&uuml;r welches die maximale Zeichenbytegr&ouml;&szlig;e pro Zeichen 4 Bytes ist: 255/4=63.');
...
DEFINE('_COM_A_SHOWNEW_DESC','Wenn Sie auf &quot;Ja&quot; stellen, dann zeigt Kunena durch eine Kennzeichnung dem Benutzer, in welchem Forum und Thema es seit seinem letzten Besuch Neuigkeiten gegeben hat.');
DEFINE('_COM_A_NEWCHAR','&quot;Neu&quot;-Kennzeichnung');
DEFINE('_COM_A_NEWCHAR_DESC','Definieren Sie hier, wie ein neuer Beitrag gekennzeichnet werden soll (wie z.B. durch &quot;!&quot; oder &quot;Neu!&quot;)');
...
DEFINE('_IMAGE_DIMENSIONS','Ihr Bild darf maximal haben (Breite x H&ouml;he - Gr&ouml;&szlig;e)');
DEFINE('_IMAGE_ERROR_TYPE','Bitte benutzen Sie nur Jpeg-, Gif- oder Png-Bilder');
DEFINE('_IMAGE_ERROR_EMPTY','Bitte markieren Sie ein Bild, bevor Sie es hochladen!');
...
DEFINE('_IMAGE_UPLOADED','Ihr Bild wurde hochgeladen.');
...
DEFINE('_COM_A_IMAGEUPLOAD_DESC','Stellen Sie auf &quot;Ja&quot;, wenn Sie es erm&ouml;glichen m&ouml;chten, dass Jeder (auch ein Besucher) Bilder hochladen darf.');
DEFINE('_COM_A_IMAGEREGUPLOAD','Erlauben Sie nur registrierten Benutzern Bilder hochzuladen');
DEFINE('_COM_A_IMAGEREGUPLOAD_DESC','Stellen Sie auf &quot;Ja&quot;, wenn Sie m&ouml;chten, dass registrierte und angemeldete Benutzer Bilder hochladen d&uuml;rfen.<br/> Wichtig!: (Super)Administratoren und Moderatoren d&uuml;rfen immer Bilder hochladen.');
//New since preRC4-II:
DEFINE('_COM_A_UPLOADS','Hochladen');
DEFINE('_FILE_TYPES','Ihre Datei darf vom Type sein - max. Gr&ouml;szlig;e');
DEFINE('_FILE_ERROR_TYPE','Sie k&ouml;nnen nur Dateien mit folgende Endungen hochladen:\n');
DEFINE('_FILE_ERROR_EMPTY','Bitte markieren Sie eine Datei, bevor Sie sie hochladen!');
...
DEFINE('_COM_A_FILEALLOWEDTYPES_DESC','Hier k&ouml;nnen Sie angeben, welche Endungen f&uuml;r Dateien erlaubt sind. Benutzen Sie das Komma zur Trennung <strong>(alles klein schreiben und ohne Leerzeichen)</strong>.<br />Beispiel: zip,txt,exe,htm,html');
DEFINE('_COM_A_FILESIZE','Max. Dateig&ouml;&szlig;e<br/><em>in Kilobyte</em>');
DEFINE('_COM_A_FILEUPLOAD','Erlauben Sie jedem Benutzer Dateien hochzuladen');
DEFINE('_COM_A_FILEUPLOAD_DESC','Stellen Sie auf &quot;Ja&quot;, wenn Sie m&ouml;chten, dass jeder Benutzer Dateien hochladen darf.');
DEFINE('_COM_A_FILEREGUPLOAD','Erlauben Sie nur registrierten Benutzern Dateien hochzuladen');
DEFINE('_COM_A_FILEREGUPLOAD_DESC','Stellen Sie auf &quot;Ja&quot;, wenn Sie m&ouml;chten, dass registrierte und angemeldete Benuter Dateien hochladen d&uuml;rfen.<br/> Bedenken Sie: (Super)Administratoren und Moderatoren d&uuml;rfen immer Dateien hochladen.');
DEFINE('_SUBMIT_CANCEL','Die Erstellung Ihres Beitrags wurde abgebrochen');
DEFINE('_HELP_SUBMIT','Klicken Sie hier, um Ihre Nachricht zu senden');
DEFINE('_HELP_PREVIEW','Klicken Sie hier, um eine Vorschau Ihrer Nachricht zu sehen');
DEFINE('_HELP_CANCEL','Klicken Sie hier, um Ihre Nachricht zu l&ouml;schen');
...
DEFINE('_COM_A_USER_MARKUP_DESC','W&auml;hlen Sie &quot;Ja&quot;, wenn Sie m&ouml;chten, dass im Beitrag des Benutzers, der den Beitrag ge&auml;ndert hat, der Name des Benutzers sowie das Datum angezeigt werden soll.');
DEFINE('_EDIT_BY','Beitrag ge&auml;ndert von:');
DEFINE('_EDIT_AT','am:');
DEFINE('_UPLOAD_ERROR_GENERAL','Ein Fehler ist beim Hochladen des Avatar aufgetreten! Versuchen Sie es noch einmal oder informieren Sie den Administrator!');
...
DEFINE('_COM_A_IMGB_ENLARGE','Klicken Sie auf das Bild, um es in voller Gr&ouml;&szlig;e zu sehen');
DEFINE('_COM_A_IMGB_DOWNLOAD','Klicken Sie auf das Bild, um es herunterzuladen');
DEFINE('_COM_A_IMGB_DUMMY_DESC',
    'Die Option &quot;Mit Dummy ersetzen&quot; ersetzt das markierte Bild mit einem Dummybild.<br /> Das erm&ouml;glicht Ihnen, die aktuelle Datei zu entfernen, ohne den Beitrag zu verschieben.<br /><small><em>Bitte beachten Sie, dass manchmal erst eine Aktualisierung des Browsers die &Auml;nderung sichtbar macht!</em></small>');
...
DEFINE('_COM_A_IMGB_CONFIRM','Sind Sie absolut sicher, dass Sie diese Datei l&ouml;schen m&ouml;chten? \n Eine Datei zu l&ouml;schen f&uuml;hrt zur ungenauen Darstellung des referenzierten Beitrags...');
...
DEFINE('_LISTCAT_RSS','die neusten Beitr&auml;ge direkt auf Ihrem Desktop erhalten');
DEFINE('_SEARCH_REDIRECT','Das Forum muss Ihre Zugangsprivilegien (neu)&uuml;berpr&uuml;fen, bevor es Ihre Suchanforderung ausf&uuml;hren kann. \nKeine Sorge, dass ist normal nach 30 Minuten Inaktivit&auml;t.\nBitte geben Sie die Suchanforderung erneut ein.');
//====================
...
DEFINE('_COM_A_REG_ONLY_DESC','W&auml;hlen Sie &quot;Ja&quot;, wenn nur registrierte Benutzer dieses Forum sehen und darin schreiben d&uuml;rfen, setzen Sie es auf &quot;Nein&quot; damit auch nicht registrierte Besucher dieses Forum sehen d&uuml;rfen. Die Schreibrechte der nicht registrierten Besucher werden unter &quot;&Ouml;ffentliches Schreiben&quot; definiert');
DEFINE('_COM_A_PUBWRITE','&Ouml;ffentliches Schreiben');
DEFINE('_COM_A_PUBWRITE_DESC','W&auml;hlen Sie &quot;Ja&quot; wenn jeder, auch ein unregistrierter Besucher im Forum schreiben darf, w&auml;hlen Sie &quot;Nein&quot; und jeder kann das Forum sehen, aber nur registrierte Benutzer d&uuml;rfen schreiben.');
DEFINE('_COM_A_USER_EDIT','Benutzerrechte');
DEFINE('_COM_A_USER_EDIT_DESC','W&auml;hlen Sie &quot;Ja&quot;, um registrierten Benutzern zu erlauben ihre eigenen Beitr&auml;ge zu bearbeiten.');
DEFINE('_COM_A_MESSAGE','Um die &Auml;nderungen zu speichern, dr&uuml;cken Sie den &quot;Save&quot;-Button oben.');
DEFINE('_COM_A_HISTORY','Verlauf des Themas anzeigen');
DEFINE('_COM_A_HISTORY_DESC','W&auml;hlen Sie &quot;Ja&quot;, damit beim Antworten der Verlauf des Themas unterhalb des Antwortfeldes angezeigt wird (empfohlen)');
DEFINE('_COM_A_SUBSCRIPTIONS','Abonnieren erlauben');
DEFINE('_COM_A_SUBSCRIPTIONS_DESC','W&auml;hlen Sie &quot;Ja&quot; und registrierte Benutzer k&ouml;nnen Themen abonnieren und bekommen bei Antwort eine E-Mail-Benachrichtung.');
DEFINE('_COM_A_HISTLIM','Maximale Beitr&auml;ge im Verlauf');
...
DEFINE('_COM_A_MODERATION_DESC','W&auml;hlen Sie &quot;Ja&quot; falls der Moderator bei Antworten in den von ihm moderierten Foren per E-Mail informiert werden soll. Achtung!: Ist diese Option eingeschaltet, bekommt der Superadministrator auch alle diese Mails!');
DEFINE('_COM_A_SHOWMAIL','E-Mail anzeigen');
DEFINE('_COM_A_SHOWMAIL_DESC','W&auml;hlen Sie &quot;Nein&quot;, damit E-Mail-Adressen niemals angezeigt werden, auch nicht den registrierten Benutzern.');
DEFINE('_COM_A_AVATAR','Avatare erlauben');
DEFINE('_COM_A_AVATAR_DESC','W&auml;hlen Sie &quot;Ja&quot; und registrierte Benutzer k&ouml;nnen Avatare benutzen (zum Verwalten ihrer Profile)');
...
DEFINE('_COM_A_USERSTATS_DESC','W&auml;hlen Sie &quot;Ja&quot; und Benutzerstatistiken werden angezeigt: Anzahl der Beitr&auml;ge, Rang u.s.w. (Admin, Moderator, Benutzer, etc.).');
DEFINE('_COM_A_AVATARUPLOAD','Avatar hochladen');
DEFINE('_COM_A_AVATARUPLOAD_DESC','W&auml;hlen Sie &quot;Ja&quot; und Benutzer k&ouml;nnen eigene Avatare hochladen');
DEFINE('_COM_A_AVATARGALLERY','Benutzung der Avatar-Gallerie');
DEFINE('_COM_A_AVATARGALLERY_DESC','W&auml;hlen Sie &quot;Ja&quot; und registrierte Benutzer d&uuml;rfen die Avatar-Galerie benutzen! (components/com_Kunena/avatars/gallery).');
DEFINE('_COM_A_RANKING_DESC','W&auml;hlen Sie &quot;Ja&quot;, wenn der Benutzerrang auf der Anzahl der geschriebenen Beitr&auml;ge beruhen soll.<br/><strong>Wenn &quot;Ja&quot;, muss auch die Statistikfunktion eingeschaltet sein!');
DEFINE('_COM_A_RANKINGIMAGES','Rangbilder benutzen');
DEFINE('_COM_A_RANKINGIMAGES_DESC','W&auml;hlen Sie &quot;Ja&quot; wenn der Benutzerrang per Grafik angezeigt werden soll. (in components/com_kunena/ranks). Ist diese Option ausgeschaltet, wird der Rang als Text angezeigt. &Uuml;berpr&uuml;fen Sie die Dokumentation auf <a href="http://www.kunena.com" target="_blank">Kunena</a> f&uuml;r weitere Informationen bez&uuml;glich Rangbildern');
//email and stuff
$_COM_A_NOTIFICATION ="Es wurde ein neuer Beitrag geschrieben von ";
$_COM_A_NOTIFICATION1="In einem von Ihnen abonnierten Thema wurde ein neuer Beitrag geschrieben.";
$_COM_A_NOTIFICATION2="Sie k&ouml;nnen dieses Abo in Ihrem Profil abbestellen.";
$_COM_A_NOTIFICATION3="Bitte nicht auf diese E-Mail antworten, da diese automatisch vom System generiert wurde.";
$_COM_A_NOT_MOD1="In dem von Ihnen moderierten Forum wurde ein neuer Beitrag geschrieben. ";
$_COM_A_NOT_MOD2="Sie k&ouml;nnen den Beitrag lesen (ansehen), wenn Sie angemeldet sind.";
...
DEFINE('_COM_A_USERNAME_DESC','W&auml;hlen Sie &quot;Ja&quot;, wenn Sie m&ouml;chten, dass der Anmeldename des Benutzers verwendet wird (wie bei der Systemanmeldung), anstatt des realen Namens.');
DEFINE('_COM_A_CHANGENAME','Namens&auml;nderung erlauben');
DEFINE('_COM_A_CHANGENAME_DESC','W&auml;hlen Sie &quot;Ja&quot;, wenn Sie m&ouml;chten, dass registrierte Benutzer ihren Namen f&uuml;r einen Beitrag &auml;ndern k&ouml;nnen. Stellen Sie es auf &quot;Nein&quot;, wenn registrierte Benutzer ihren Namen nicht &auml;ndern sollen.');
//admin; changes 0.9.1 to 0.9.2
DEFINE('_COM_A_BOARD_OFFLINE','Forum offline stellen');
DEFINE('_COM_A_BOARD_OFFLINE_DESC','W&auml;hlen Sie &quot;Ja&quot;, wenn Sie das Forum offline stellen m&ouml;chten. (Super)Administratoren k&ouml;nnen das Forum immer noch anschauen.');
...
DEFINE('_COM_A_PRUNE_USERS_DESC', 'Diese Funktion erlaubt es Ihnen, alle Benutzer aus dem Kunena zu entfernen, die auch nicht mehr auf Ihrer Joomla!-Seite registriert sind. Es werden die Benutzertabellen von Kunena und von Joomla! verglichen. Profile von Kunena-Benutzern werden gel&ouml;scht, wenn sie nicht mehr in Ihrem Joomla!-System vorhanden sind. Wenn Sie sicher sind, dass Sie weitermachen m&ouml;chten, klicken Sie "Prune" in der Men&uuml;leiste oben.'); // <=FB 1.0.3
//general
...
DEFINE('_UPLOAD_SUBMIT','Ihren neuen Avatar senden');
...
DEFINE('_UPLOAD_ERROR_CHOOSE',"Sie d&uuml;rfen kein Bild aus der Gallerie w&auml;hlen");
DEFINE('_UPLOAD_UPLOADED','Ihr Avatar wurde hochgeladen');
DEFINE('_UPLOAD_GALLERY','Ein Avatar aus der Gallerie ausw&auml;hlen');
...
DEFINE('_LISTCAT_DO','Sie sollten wissen, was zu tun ist ');
DEFINE('_LISTCAT_INFORM','Informieren Sie bitte die Administration!');
...
DEFINE('_POST_ABOUT_DELETE','<strong>Hinweise:</strong><br/> - L&ouml;schen Sie den ersten Beitrag in einem Thema, wird das ganze Thema gel&ouml;scht ... <br /> Entscheiden Sie, ob Sie den ganzen Beitrag und den Benutzernamen l&ouml;schen wollen, oder nur der Inhalt entfernen werden soll ... <br />Alle Antworten eines gel&ouml;schten normalen Beitrags werden im Thema eine Position nach oben verschoben.');
DEFINE('_POST_CLICK','klicken Sie hier');
DEFINE('_POST_ERROR','Kann den Benutzernamen/E-Mail nicht finden. Nicht gelisteter Datenbank-Fehler');
DEFINE('_POST_ERROR_MESSAGE','Ein unbekannter SQL-Fehler wurde festgestellt, Ihre Nachricht wurde nicht gesendet. Versuchen Sie es erneut. Wenn der Fehler weiter besteht, kontaktieren Sie bitte den Administrator.');
DEFINE('_POST_ERROR_MESSAGE_OCCURED','Ein Fehler ist festgestellt worden, die Nachricht wurde nicht aktualisiert. Versuchen Sie es erneut. Wenn der Fehler weiter besteht, kontaktieren Sie bitte den Administrator.');
DEFINE('_POST_ERROR_TOPIC','Ein Fehler wurde festgestellt. Pr&uuml;fen Sie folgenden Fehler:');
DEFINE('_POST_FORGOT_NAME','Sie haben vergessen, einen Namen einzugeben. Klicken Sie im Browser auf den Zur&uuml;ck-Button um ihn einzugeben.');
DEFINE('_POST_FORGOT_SUBJECT','Sie haben vergessen, eine &Uuml;berschrift einzugeben. Klicken Sie im Browser auf den Zur&uuml;ck-Button um sie einzugeben.');
DEFINE('_POST_FORGOT_MESSAGE','Sie haben vergessen eine Nachricht einzugeben. Klicken Sie im Browser auf den Zur&uuml;ck-Button um sie einzugeben.');
...
DEFINE('_POST_MOVE_TOPIC','verschieben Sie dieses Thema nach');
DEFINE('_POST_NEW','Schreiben Sie eine neue Nachricht in: ');
DEFINE('_POST_NO_SUBSCRIBED_TOPIC','Dieses Thema ist nicht zu abonnieren.');
DEFINE('_POST_NOTIFIED','Machen Sie hier ein H&auml;kchen, wenn Sie per E-Mail &uuml;ber jede Anwort informiert werden m&ouml;chten.');
...
DEFINE('_POST_SUBSCRIBED_TOPIC','Sie haben dieses Thema jetzt abonniert');
DEFINE('_POST_SUCCESS','Ihre Nachricht wurde erfolgreich gespeichert');
DEFINE('_POST_SUCCES_REVIEW','Ihr Eintrag wurde erfolgreich gespeichert, sobald ein Moderator ihn freigegeben hat, wird er ver&ouml;ffentlicht');
DEFINE('_POST_SUCCESS_REQUEST','Ihre Anfrage wurde gesendet. Falls Sie in K&uuml;rze nicht zur&uuml;ck zum Beitrag geleitet werden,');
...
DEFINE('_POST_TOPIC_NOT_MOVED','Ihr Thema kann nicht verschoben werden. Um zum Thema zur&uuml;ckzukehren:');
DEFINE('_POST_TOPIC_FLOOD1','Der Administrator hat Anti-Flooding aktiviert, deshalb m&uuml;ssen Sie');
DEFINE('_POST_TOPIC_FLOOD2',' Sekunden zwischen den Beitr&auml;gen bevor Sie den n&auml;chsten schreiben k&ouml;nnen.');
DEFINE('_POST_TOPIC_FLOOD3','Bitte klicken Sie in Ihren Browser den Zur&uuml;ck-Button, um zur Nachricht zur&uuml;ckzukommen.');
DEFINE('_POST_EMAIL_NEVER','Ihre E-Mail-Adresse ist f&uuml;r andere nicht sichtbar.');
DEFINE('_POST_EMAIL_REGISTERED','Ihre E-Mail ist nur f&uuml;r registrierte Benutzer erreichbar.');
...
DEFINE('_POST_NO_PUBACCESS2','Sie k&ouml;nnen das Forum zwar sehen, aber<br/>nur registrierte Benutzer d&uuml;rfen Beitr&auml;ge schreiben!');
// showcat.php
DEFINE('_SHOWCAT_NO_TOPICS','>> In diesem Forum gibt es noch kein Thema  <<');
DEFINE('_SHOWCAT_PENDING','wartende Beitr&auml;ge');
// userprofile.php
DEFINE('_USER_DELETE','Um Ihr Profil zu l&ouml;schen, bitte hier ein H&auml;kchen setzen.');
DEFINE('_USER_ERROR_A','Sie kamen durch einen Fehler auf diese Seite. Wenn das &ouml;fter passiert, informieren Sie bitte den Administrator und senden ihm den Fehlercode ');
DEFINE('_USER_ERROR_B','Sie haben geklickt und hier gelandet. Sie k&ouml;nen einen Fehler-Report senden.');
...
DEFINE('_USER_MODERATOR','Sie sind Moderator von');
DEFINE('_USER_MODERATOR_NONE','Sie sind kein Moderator');
...
DEFINE('_USER_PROFILE_NOT_A','Ihr Profil kann&#32;');
DEFINE('_USER_PROFILE_NOT_B','nicht');
DEFINE('_USER_PROFILE_NOT_C','&#32;aktualisiert werden');
DEFINE('_USER_PROFILE_UPDATED','Ihr Profil wurde aktualisiert!');
DEFINE('_USER_RETURN_A','Sie werden gleich weitergeleitet...');
DEFINE('_USER_RETURN_B','Klicken Sie hier!');
DEFINE('_USER_SUBSCRIPTIONS','Ihre Abos');
DEFINE('_USER_UNSUBSCRIBE','Abo beenden');
DEFINE('_USER_UNSUBSCRIBE_A','Sie k&ouml;nnen');
...
DEFINE('_YOUR_AVATAR', '<b>Ihr Avatar</b>');
...
DEFINE('_FORUM_UNAUTHORIZIED2','Wenn Sie bereits registriert sind, m&uuml;ssen Sie sich zuerst anmelden.');
...
DEFINE('_COM_A_EMAIL_DESC', 'Das ist die E-Mail-Adresse des Forums. Stellen Sie sicher, dass die Adresse stimmt!');
DEFINE('_COM_A_WRAP','W&ouml;rter teilen, die l&auml;nger sind als:');
DEFINE('_COM_A_WRAP_DESC','Geben Sie hier ein, wie viele Zeichen ein Wort max. haben darf. Das erm&ouml;glicht Ihnen die Ausgabe f&uuml;r Ihr Template anzupassen. 70 Zeichen sind das maximale, was f&uuml;r feste Templates genommen werden sollte, aber Sie k&ouml;nnen nat&uuml;rlich  ein wenig experimentieren. URLs, egal wie lang, werden nicht durch diese Einstellung beeinflusst.');
...
DEFINE('_COM_A_BOARD_OFSET_DESC', 'Einige Foren sind auf einem Server, der eine andere Zeitzone als der Benutzer hat. Definieren Sie die Zeitverschiebung f&uuml;r Kunena (Zeitangabe im Frontend) im Verh&auml;ltnis zur Serverzeit in Stunden. Positive und negative Werte k&ouml;nnen definiert werden.');
//New in RC2
...
DEFINE('_COM_A_PMS_DESC',
    'W&auml;hlen Sie das installierte &quot;Private Nachrichten&quot;-System aus, wenn Sie eines installiert haben. Falls Sie &quot;Clexus PM&quot; ausw&auml;hlen, werden auch die &quot;Clexus PM&quot;-Profiloptionen aktiviert (wie: ICQ, AIM, Yahoo, MSN und Links zu Profilen, wenn vom Kunena-Template unterst&uuml;tzt.');
DEFINE('_VIEW_PMS', 'Klicken Sie hier, um diesem Benutzer eine private Nachricht zu schicken');
//new in RC3
DEFINE('_POST_RE', 'Aw: ');
...
DEFINE('_COM_A_TAWIDTH_DESC', 'Hier k&ouml;nnen Sie die Breite des Textbereichs &auml;ndern, um sie an Ihr Template anzupassen. <br/>Die Smiley-Toolbar wird auf zwei Reihen verteilt; wenn die Gr&ouml;&szlig;e <= 420 Pixel ist.');
DEFINE('_COM_A_TAHEIGHT', 'Textbereich: H&ouml;he in px');
DEFINE('_COM_A_TAHEIGHT_DESC', 'Hier k&ouml;nnen Sie die H&ouml;he des Textbereichs &auml;ndern, um sie an Ihr Template anzupassen.');
DEFINE('_COM_A_ASK_EMAIL', 'E-Mail ist Pflicht');
DEFINE('_COM_A_ASK_EMAIL_DESC', 'Ist eine E-Mail-Adresse erforderlich, wenn ein Benutzer oder Besucher einen Beitrag schreiben will? Stellen Sie &quot;Nein&quot; ein, wenn Sie das nicht wollen. Der Benutzer wird dann nicht nach seiner E-Mail-Adresse gefragt.');
