        ...
        <td>
            <div>
                ...
                while ($parent_ids)
                {
                    ...
                    $sname = "<a href='" . JRoute::_(JB_LIVEURLREL . '&amp;func=showcat&amp;catid=' . $catids) . "'>" . @mysql_result($results, 0, 'name') . "</a>";
                ...
                $shome = '<a href="' . JRoute::_(JB_LIVEURLREL) . '">' . _GEN_FORUMLIST . '</a> ';
                ...
                /*      echo '<a href="'.JRoute::_(JB_LIVEURLREL).'">';
                      ...
                      echo ' <a href="'.JRoute::_(JB_LIVEURLREL.'&amp;func=showcat&amp;catid='.$objCatParentInfo->id).'">'.$objCatParentInfo->name.'</a> ';
                      if (file_exists($mosConfig_absolute_path.'/templates/'.$mainframe->getTemplate().'/images/arrow.png')) {
                      echo '<img src="'.JB_JLIVEURL.'/templates/'.$mainframe->getTemplate().'/images/arrow.png" alt="" />';
                      } else {
                      echo '<img src="'.JB_JLIVEURL.'/images/M_images/arrow.png" alt="" /> ';
