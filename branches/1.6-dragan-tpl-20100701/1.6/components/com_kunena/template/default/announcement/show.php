...
<table class="kannouncement">
	<tbody id="kannouncement_body">
		...
		<tr class="krow<?php echo $k;?>">
			<td class="kfirst kcol kcol-annid"><?php echo $ann->id; ?></td>
			<td class="kmiddle kcol kcol-anndate"><?php echo CKunenaTimeformat::showDate($ann->created, 'date_today'); ?></td>
			<td class="kmiddle kcol kcol-anntitle">
			...
			<td class="kmiddle kcol kcol-annpublish">
				<?php
				if ($ann->published > 0) {
