...
class KunenaModelTopics extends KunenaModel
{
	...
	/**
	 * Method to get list of KunenaForumTopic objects
	 *
	...
	/**
	 * Method to prepare the list of recent topics
	 *
	 * @return void
	 */
	...
	/**
	 * Method to prepare the user topics before to display
	 *
	 * @return void
	 */
	...
	/**
	 * Method to prefecth the topics to display
	 *
	 * @param   array  $userlist  List of users in the topic
	 * @param   array  $postlist  List of post
	 *
	 * @return void
	 */
	...
	/**
	 * Method get lists of KunenaForumMessage objects
	 *
	...
	/**
	 *  Method to get number total of topics
	 *
	 * @return int
	 */
	...
	/**
	 * Method to get topic moderation actions
	 *
	 * @return string
	 */
	...
	/**
	 * Method to return HTML select list for moderation actions
	 *
	 * @return string
	 */
