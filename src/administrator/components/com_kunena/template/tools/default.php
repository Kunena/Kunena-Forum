		...
		<div id="j-main-container" class="col-md-12" role="main">
			<div class="card card-block bg-faded p-2">
				...
				<div id="dashboard-icons" class="btn-group">
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=report')?>">
						<i class="icon-big icon-support"></i><br/>
						<span><?php echo Text::_('COM_KUNENA_REPORT_SYSTEM'); ?></span>
					</a>
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=prune')?>">
						<i class="icon-big icon-list-view"></i><br/>
						<span><?php echo Text::_('COM_KUNENA_C_PRUNETAB'); ?></span>
					</a>
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=syncusers')?>">
						<i class="icon-big icon-shuffle"></i><br/>
						<span><?php echo Text::_('COM_KUNENA_SYNC_USERS'); ?></span>
					</a>
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=recount')?>">
						<i class="icon-big icon-loop"></i><br/>
						<span><?php echo Text::_('COM_KUNENA_A_RECOUNT'); ?></span>
					</a>
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=menu')?>">
					...
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=cleanupip')?>">
						<i class="icon-big icon-location"></i><br/>
						<span><?php echo Text::_('COM_KUNENA_CPANEL_LABEL_CLEANUP_IP'); ?></span>
					</a>
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=diagnostics')?>">
						<i class="icon-big icon-health"></i><br/>
						<span><?php echo Text::_('COM_KUNENA_DIAGNOSTICS_LABEL_DIAGNOSTICS'); ?></span>
					</a>
					<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=tools&layout=uninstall')?>">
					...
					<?php if (KunenaForum::isDev())
						:
						?>
						<a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_kunena&view=install')?>">
