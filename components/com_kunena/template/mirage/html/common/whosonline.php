...
<div class="block-wrapper box-color box-border box-border_radius box-shadow">
	<div id="whosonline" class="block">
		<div class="headerbox-wrapper">
			...
			<div class="header fr">
				<a href="<?php echo $this->usersURL ?>" class="kheader-link"><?php echo JText::_('COM_KUNENA_VIEW_COMMON_WHO_LINK') ?> </a>
			</div>
		</div>
		<div class="detailsbox-wrapper">
			<div class="detailsbox whosonline-details box-hover box-border_radius box-shadow" id="whosonline-detailsbox" >
