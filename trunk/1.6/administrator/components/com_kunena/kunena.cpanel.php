  ...
  <table class = "thisform">
    <tr class = "thisform">
      <td width = "100%" valign = "top" class = "thisform"><div id = "cpanel">
          ...
          <div style = "float:left;">
            <div class = "icon"> <a href = "index.php?option=com_kunena&amp;task=showsystemreport" style = "text-decoration:none;" title = "<?php echo JText::_('COM_KUNENA_REPORT_SYSTEM');?>"> <img src = "components/com_kunena/images/report_conf.png"  align = "middle" border = "0"/> <span> <?php echo JText::_('COM_KUNENA_REPORT_SYSTEM'); ?> </span></a> </div>
          </div>
          <?php
