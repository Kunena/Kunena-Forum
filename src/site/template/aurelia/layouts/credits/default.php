...
<div class="card">
    ...
    <div class="card-body" id="credits">
        <div class="kintro">
            <img loading=lazy class="float-start" src="<?php echo $this->logo; ?>" width="48" height="48" alt="Kunena"/>
            <p class="intro">
                <?php echo $this->intro; ?>
            </p>
        </div>
        ...
        <div class="credits">
            ...
            <p class="center">
                <?php echo Text::_('COM_KUNENA_COPYRIGHT'); ?> &copy; 2008 - 2023 <a href="https://www.kunena.org"
