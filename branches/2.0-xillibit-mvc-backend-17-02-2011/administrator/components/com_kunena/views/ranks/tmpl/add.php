...
$document->addScriptDeclaration('function update_rank(newimage)
			{
				...
				kescape(KURL_SITE . $this->rankpath).'" + newimage;
			}');
?>
<div id="kadmin">
		...
		<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" method="post" name="adminForm">
			<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminform">
				...
				<tr>
					...
					<?php else: ?><img name="rank_image" src="<?php echo kescape(KURL_SITE .$this->template->getRankPath( $this->rank_selected->rank_image)); ?>" border="0" alt="" /><?php endif; ?>
					</td>
				</tr>
				<tr>
					<td width="100"><?php
