			...
			<tr>
				<td class="kpostbuttons">
					<ul id="kbbcode-toolbar">
						<li>
							<script
								type="text/javascript">document.write('<?php echo JText::_('COM_KUNENA_BBCODE_EDITOR_JAVASCRIPT_LOADING', true) ?>')</script>
				...
				<td class="kpostbuttons">
					...
					<div id="kbbcode-link-options" style="display: none;">
						...
						<input type="button" name="insterLink"
							value="<?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?>"
					...
					<div id="kbbcode-image-options" style="display: none;">
						...
						<input type="button" name="Link" value="<?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?>"
					...
					<?php if (!$this->message->parent && isset($this->poll)) : ?>
						<div id="kbbcode-poll-options" style="display: none;">
							...
							<img id="kbutton-poll-add"
								...
								onmouseover="document.id('helpbox').set('value', '<?php echo JText::_('COM_KUNENA_EDITOR_HELPLINE_ADDPOLLOPTION', true); ?>')"
								alt="<?php echo JText::_('COM_KUNENA_POLL_ADD_POLL_OPTION'); ?>" />
							<img id="kbutton-poll-rem"
								src="<?php echo $this->ktemplate->getImagePath('icons/poll_rem_options.png') ?>"
								onmouseover="document.id('helpbox').set('value', '<?php echo JText::_('COM_KUNENA_EDITOR_HELPLINE_REMPOLLOPTION', true); ?>')"
								alt="<?php echo JText::_('COM_KUNENA_POLL_REMOVE_POLL_OPTION'); ?>" />
...
<tr id="kpost-message" class="krow<?php echo 1 + $this->k ^= 1; ?>">
	...
	<td class="kcol-last kcol-editor-field">
		<textarea class="ktxtarea required" name="message" id="kbbcode-message" rows="10" cols="50"
			tabindex="3"><?php echo $this->escape($this->message->message); ?></textarea>
