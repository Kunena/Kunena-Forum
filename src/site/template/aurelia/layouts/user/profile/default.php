...
if ($user->userid > 1)
    ...
    <div class="profile-expand center">
		<span class="heading btn btn-outline-primary border btn-xs heading-less hasTooltip"
              style="display:none;"
              title="<?php echo Text::_('COM_KUNENA_USER_PROFILE_TOOLTIP_LABEL_SCSS') ?>"><?php echo KunenaIcons::arrowup(); ?><?php echo Text::_('COM_KUNENA_USER_PROFILE_BUTTON_LABEL_SCSS') ?></span>
