<?php
/**
* @version $Id: kunena.english.php 229 2009-01-30 07:44:17Z fxstein $
* Kunena Component
* @package Kunena
...
DEFINE('_KUNENA_HIDETEXT','Please login to view this content!');
...
DEFINE('_KUNENA_ADMIN_CONFIG_USERLIST_EMAIL','Show Email');
...
DEFINE('_KUNENA_SHOWWHOIS', 'Show Whois Online');
...
DEFINE('_KUNENA_NOUSERSFOUND', 'No userprofiles found.');
...
DEFINE('_KUNENA_ANN_MODID_DESC', 'Add user ids for announcements moderation. e.g. 62,63,73 . Announcement moderators can add, edit, delete the announcements.');
//
