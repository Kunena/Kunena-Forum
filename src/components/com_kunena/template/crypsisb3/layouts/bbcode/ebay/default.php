...
<?php if($this->ack == 'Success') : ?>
	<div class="kunena_ebay_widget" style="border: 1px solid #e5e5e5;margin:10px;padding:10px;border-radius:5px;">
		...
		<div style="text-align: center;"><a href="<?php echo $this->naturalurl; ?>" target="_blank" rel="noopener noreferrer"> <img  src="<?php echo $this->pictureurl; ?>" /></a></div>
		<div style="margin:10px 0;" /></div>
		<a href="<?php echo $this->naturalurl; ?>" target="_blank" rel="noopener noreferrer"><?php echo $this->title; ?></a>
		<div style="margin:10px 0;" /></div>
		<div style="margin:10px 0;" /></div>
		<?php if ($this->status == "Active") : ?>
			<a class="btn" href="<?php echo $this->naturalurl; ?>" target="_blank" rel="noopener noreferrer"><?php echo JText::_('COM_KUNENA_LIB_BBCODE_EBAY_LABEL_BUY_IT_NOW') ?></a>
		<?php else: ?>
