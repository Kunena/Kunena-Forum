...
<li class="klatest-item">
	<ul class="klatest-itemdetails">
		...
		<li class="klatest-author"><?php echo JText::_ ( 'MOD_KUNENALATEST_LAST_POST_BY' ) .' '. CKunenaLink::GetProfileLink ( $item->userid, $this->username ? $item->username : $item->name ); ?></li>
