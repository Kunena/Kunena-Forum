...
DEFINE('_COM_A_RSS_TIMELIMIT_DESC', 'Select how much history should be included in the global RSS feeds. The default is one month, but it is recommended to limit it to one week on high volume sites.');
...
DEFINE('_COM_A_RSS_ALLOW_HTML', 'Global RSS: Render HTML &amp; bbcode in RSS feeds');
DEFINE('_COM_A_RSS_ALLOW_HTML_DESC', 'Allowing HTML in RSS feeds can be seen as a security threat, as hackers sometimes try to smuggle evil javascripts and images into forum-messages.<br />However, Kunena has a good security in this matter, and it recommended to allow HTML in RSS feeds for maximum user experience.');
DEFINE('_COM_A_RSS_AUTHOR_FORMAT', 'Global RSS: Author format');
DEFINE('_COM_A_RSS_AUTHOR_FORMAT_DESC', 'How shall Kunena render the authors in RSS feeds? Select between author name or email.');
DEFINE('_COM_A_RSS_AUTHOR_FORMAT_NAME', 'Name');
DEFINE('_COM_A_RSS_AUTHOR_FORMAT_EMAIL', 'Email');
DEFINE('_COM_A_RSS_WORD_COUNT', 'Global RSS: Number of words in postings');
DEFINE('_COM_A_RSS_WORD_COUNT_DESC', 'How many words shall each post in feed contain?<br/>Note: This feature may cut off bbcode. Most feedviewers can handle this though.');
DEFINE('_COM_A_RSS_WORD_COUNT_ALL', 'All');
DEFINE('_COM_A_RSS_OLD_TITLES', 'Global RSS: Use oldstyle titles?');
DEFINE('_COM_A_RSS_OLD_TITLES_DESC', '<u>No</u> - Titles will be kept intact, looking like this: \'#post title#\'<br/><u>Yes</u> - Titles will look likethis: \'Subject: #post title# - By: #author#\'');
...
DEFINE('_KUNENA_EDITOR_IMAGELINK', 'Image link');
DEFINE('_KUNENA_EDITOR_HIDE','Hide text from Guests');
DEFINE('_KUNENA_EDITOR_SPOILER', 'Spoiler');
DEFINE('_KUNENA_EDITOR_COLOR', 'Color');
DEFINE('_KUNENA_EDITOR_FONTSIZE', 'Font size');
DEFINE('_KUNENA_EDITOR_FONTSIZESELECTION', 'Select font size');
DEFINE('_KUNENA_EDITOR_TABLE', 'Table');
DEFINE('_KUNENA_EDITOR_HELPLINE_TABLE', 'Create an embedded table: [table][tr][td]line1[/td][/tr][tr][td]lines[/td][/tr][/table]');
DEFINE('_KUNENA_EDITOR_MODULE', 'Module');
DEFINE('_KUNENA_EDITOR_HELPLINE_MODULE', 'Insert a Module: [module]Module Name[/module]');
DEFINE('_KUNENA_EDITOR_EBAY', 'eBay Item');
DEFINE('_KUNENA_EDITOR_VIDEO', 'Video');
DEFINE('_KUNENA_EDITOR_ATTACH', 'Attachment');
DEFINE('_KUNENA_EDITOR_HELPLINE_ATTACH', 'Attach a file or image to this message');
DEFINE('_KUNENA_EDITOR_GALLERY', 'Gallery');
DEFINE('_KUNENA_EDITOR_HELPLINE_GALLERY', 'Insert an image from the photo gallery');
DEFINE('_KUNENA_EDITOR_POLL', 'Poll');
DEFINE('_KUNENA_EDITOR_HELPLINE_POLL', 'Add or edit a poll to this message');
DEFINE('_KUNENA_EDITOR_MAP', 'Map');
DEFINE('_KUNENA_EDITOR_HELPLINE_MAP', 'Insert an Map into the message: [map]Address[/map]');
DEFINE('_KUNENA_EDITOR_PREVIEWBOTTOM', 'Preview Pane Below');
DEFINE('_KUNENA_EDITOR_HELPLINE_PREVIEWBOTTOM', 'Display a live message preview pane below the edit area');
...
DEFINE('_KUNENA_EDITOR_SIZE_SAMPLETEXT', 'Sample Text');
...
DEFINE('_KUNENA_MYPROFILE_TWITTER_DESC', 'This is your Twitter username.');
DEFINE('_KUNENA_MYPROFILE_FACEBOOK', 'Facebook');
DEFINE('_KUNENA_MYPROFILE_FACEBOOK_DESC', 'This is your full Facebook URL.');
...
DEFINE('_KUNENA_MYPROFILE_DELICIOUS_DESC', 'This is your Delicious username.');
...
DEFINE('_KUNENA_MYPROFILE_BLOGSPOT_DESC', 'This is your Blogger username.');
DEFINE('_KUNENA_MYPROFILE_FLICKR', 'Flickr');
DEFINE('_KUNENA_MYPROFILE_FLICKR_DESC', 'This is your Flickr username.');
...
define('_KUNENA_A_POLL_CATEGORIES_ALLOWED', 'Enable poll in these categories');
define('_KUNENA_A_POLL_CATEGORIES_ALLOWED_DESC', 'A comma separated list of category ids that you woud like to allow poll functionality.');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGEINSERT', 'Image link: Insert image link');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE', 'Fontsize: Select Fontsize and Apply to current selection');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE_XS', 'Fontsize: [size=1]text size[/size] - Tip: sizes range from 1 to 6');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE_S', 'Fontsize: [size=2]text size[/size] - Tip: sizes range from 1 to 6');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE_M', 'Fontsize: [size=3]text size[/size] - Tip: sizes range from 1 to 6');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE_L', 'Fontsize: [size=4]text size[/size] - Tip: sizes range from 1 to 6');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE_XL', 'Fontsize: [size=5]text size[/size] - Tip: sizes range from 1 to 6');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE_XXL', 'Fontsize: [size=6]text size[/size] - Tip: sizes range from 1 to 6');
...
DEFINE('_KUNENA_EDITOR_IMAGELINK_SIZE', 'Size');
DEFINE('_KUNENA_EDITOR_IMAGELINK_URL', 'URL');
DEFINE('_KUNENA_EDITOR_IMAGELINK_INSERT', 'Insert');
...
DEFINE('_KUNENA_MYPROFILE_TIMEZONE', 'Time Zone');
...
DEFINE('_KUNENA_MYPROFILE_PROFILEVIEW', 'Profile Views');
DEFINE('_KUNENA_MYPROFILE_PERSONALTEXT', 'Personal Text');
DEFINE('_KUNENA_MYPROFILE_ABOUTME', 'About Me');
DEFINE('_KUNENA_MYPROFILE_GENDER', 'Gender');
DEFINE('_KUNENA_MYPROFILE_BIRTHDATE', 'Birthdate');
DEFINE('_KUNENA_MYPROFILE_BIRTHDAYREMIND', 'Remind me of this birthday');
