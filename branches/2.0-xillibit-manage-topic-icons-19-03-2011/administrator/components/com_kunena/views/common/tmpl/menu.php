...
<div id="kadmin-menu">
	...
	<a class="kadmin-mainmenu icon-topicicons-sm" href="<?php echo KunenaRoute::_('index.php?option=com_kunena&view=topicons') ?>"><?php echo JText::_('COM_KUNENA_A_TOPICICONS_MANAGER'); ?></a>
