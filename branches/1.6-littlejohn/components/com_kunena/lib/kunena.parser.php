		...
		if ($task->in_code) {
			switch (JString::strtolower ( $tag->name )) {
				...
				case 'code' :
					...
					$code_start_html = '<div class="kmsgtext_code"><table cellspacing="1" cellpadding="3" border="0"><tr><td><b>' . _KUNENA_MSG_CODE . '</b></td></tr><tr><td><hr />';
