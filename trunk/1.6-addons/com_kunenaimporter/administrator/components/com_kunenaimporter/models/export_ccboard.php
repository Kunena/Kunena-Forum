 ...
 *
 * @version $Id: export_ccboard.php 2311 2010-04-18 10:43:48Z mahagr $
 * @author Kunena Team
 * @package Joomla
 * @subpackage Kunena Forum Importer
 * @license GNU/GPL
 *
 * Imports forum data from ccBoard
 *
...
class KunenaimporterModelExport_ccBoard extends KunenaimporterModelExport {
	...
	function checkConfig() {
		...
		if ($version != 1.2 ) $this->error = "Unsupported forum: ccBoard ".$this->version;
		if ($this->error) {
