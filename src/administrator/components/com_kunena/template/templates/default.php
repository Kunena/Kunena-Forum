		...
		<form action="<?php echo KunenaRoute::_('administrator/index.php?option=com_kunena&view=templates') ?>" method="post" id="adminForm" name="adminForm">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php echo $this->escape($row->authorUrl); ?>" target="_blank"><?php echo $this->escape($row->authorUrl); ?></a>
					</td>
				</tr>
				<?php endforeach; ?>
			</tbody>
			...
			<table class="table table-striped" style="padding-top: 200px">
				...
				<tbody>
					...
					<tr>
						...
						<td style="width: 7%">
							<?php $img_path = 'https://www.kunena.org/components/com_rdsubs/images/product-3.png'; ?>
