	...
	<div class="inner">
		<span class="corners-top"><span></span></span>
			<ul class="topiclist">
				<li class="header">
					<dl class="icon">
						<dt><a rel="ksection-categories" title="<?php echo $this->header ?>"><?php echo $this->header ?></a></dt>
						<dd>&nbsp;</dd>
					</dl>
				</li>
			</ul>
		...
		<div class="kpost-buttons">
			<button class="tk-add-button" onclick="javascript: submitbutton('add')" title="<?php echo JText::_('COM_KUNENA_NEW_CATEGORY_LONG') ?>"><?php echo JText::_('COM_KUNENA_NEW_CATEGORY') ?></button>
		</div>
...
<div class="forumlist tk-clear tk-latestx">
	<div class="catinner">
		...
		<button class="tk-submit-button" onclick="javascript: submitbutton(this.form.batch.value)"><?php echo JText::_('COM_KUNENA_SUBMIT') ?></button>
						</dd>
						<dd class="tk-pagination">
	<div class="ksection-pagination">
		<div class="kpagination-limitbox"><?php echo JText::_('COM_KUNENA_A_DISPLAY') ?> <?php echo $this->navigation->getLimitBox () ?>
		<?php echo $this->navigation->getPagesLinks () ?>
		<?php echo $this->navigation->getResultsCounter () ?></div>
	</div>
						</dd>
					</dl>
				</li>
