...
class plgKunenaJoomlaInstallerScript extends InstallerScript
{
    ...
    public function preflight($type, $parent): bool
    {
        ...
        // Delete kunena.php
        $this->deleteFiles[] = '/plugins/kunena/joomla/joomla.php';
        $this->deleteFiles[] = '/plugins/kunena/joomla/KunenaAccessKunena.php';
        $this->deleteFiles[] = '/plugins/kunena/joomla/KunenaLoginKunena.php';
        $this->removeFiles();
