								...
								<tr <?php echo 'class = "row' . $k . '"'; ?>>
									...
									<td class="center">
										<?php if ($row->published == 1) { ?>
											<img src="<?php echo JUri::base(true); ?>/components/com_kunena/media/icons/small/icons/default.png" alt="<?php echo JText::_( 'COM_KUNENA_A_TEMPLATE_MANAGER_DEFAULT' ); ?>" />
										<?php } else { ?>
											<a href="javascript: void(0);" onclick="return listItemTask('cb<?php echo urlencode($row->directory);?>','publish')">
												<img src="<?php echo JUri::base(true); ?>/components/com_kunena/media/icons/small/icons/default_off.png" alt="<?php echo JText::_( 'COM_KUNENA_A_TEMPLATE_MANAGER_NO_DEFAULT' ); ?>" />
											</a>
										<?php } ?>
									</td>
									<td>
