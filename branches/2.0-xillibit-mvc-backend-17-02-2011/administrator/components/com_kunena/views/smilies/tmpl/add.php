...
$document->addScriptDeclaration('function update_smiley(newimage)
			{
				...
				kescape(KURL_SITE . $this->smileypath).'" + newimage;
			}');
?>
<div id="kadmin">
			...
			<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminform">
				<tr align="center">
					...
					<td rowspan="3" width="50"><img name="smiley_image"
						src="<?php echo isset($this->smiley_selected) ? kescape(KURL_SITE.$this->template->getSmileyPath($this->smiley_selected->location)) : '' ?>" border="0" alt="" /> &nbsp;</td>
					<td rowspan="3">&nbsp;</td>
				</tr>
				<tr align="center">
					<td width="100"><?php
