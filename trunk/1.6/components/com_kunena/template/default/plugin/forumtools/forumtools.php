...
//                }
                ...
                {
				 if ($kunenaConfig->rules_inkunena) {
                    echo '<li>';
					...
					echo '<li>';
                    echo '<a href="' . $kunenaConfig->rules_link . '" >';
                    echo _GEN_RULES;
                    echo '</a></li>';
					}
                }
                if ($kunenaConfig->enablehelppage)
                {
				 if ($kunenaConfig->help_inkunena) {
					...
					echo '<li>';
					echo '<a href="' . $kunenaConfig->help_link . '" >';
					echo _GEN_HELP;
					echo '</a></li>';
					}
				}
