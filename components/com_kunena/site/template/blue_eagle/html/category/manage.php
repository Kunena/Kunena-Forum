		...
		<div class="kbody">
			<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena&view=category&layout=manage') ?>"
				...
				<input type="hidden" name="filter_order_Dir"
				       value="<?php echo intval($this->state->get('list.direction')) ?>"/>
				...
				<table class="kadmin-sort">
					<tr>
						<td class="kleft">
							...
							<button
								onclick="document.getElementById('search').value='';this.form.submit();"><?php echo JText::_('COM_KUNENA_RESET'); ?></button>
						</td>
						<td class="kright">
							...
							<button
								onclick="submitbutton('remove')"><?php echo JText::_('COM_KUNENA_DELETE'); ?></button>
						</td>
					</tr>
				</table>
					...
					<tr>
						<td colspan="14">
							<div class="pagination">
								<div
									class="limit"><?php echo JText::_('COM_KUNENA_A_DISPLAY'); ?><?php echo $this->navigation->getLimitBox(); ?></div>
					...
					foreach ($this->categories as $category)
					{
						...
						<tr <?php echo 'class = "row' . $k . '"'; ?>>
							...
							<?php else : ?>
								...
								<td class="kleft" width="70%"><a href="#edit"
