...
<div class="card">
	...
	<div class="card-body" id="credits">
		<div class="kintro">
			<img loading=lazy class="float-left" src="<?php echo $this->logo; ?>" width="48" height="48" alt="Kunena"/>
			<p class="intro">
				<?php echo $this->intro; ?>
			</p>
		</div>
		...
		<div class="credits">
			...
			<dl class="row">
				...
				<dd class="col-md-9">
					<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
						...
						<img loading=lazy width="1" height="1" alt="" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif"
							 border="0">
					</form>
				</dd>
				<hr class="hr-condensed">
			...
			<p class="center">
				<?php echo Text::_('COM_KUNENA_COPYRIGHT'); ?> &copy; 2008 - 2021 <a href="https://www.kunena.org"
