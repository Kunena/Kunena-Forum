			...
			<tr>
				<th colspan = "2">
					<div class = "kunena_title_cover">
						<span class = "kunena_title"><?php echo _GEN_SIGNATURE; ?></span>
					</div>
				</th>
			</tr>
		</thead>
		...
		<tr>
			...
			<tr >
				<td ><strong><?php echo _GEN_SIGNATURE; ?></strong>:
					...
					<i><?php echo $kunenaConfig->maxsig; ?> <?php echo _CHARS; ?></i>
...
<?php echo _HTML_YES; ?>
				...
				<td ><textarea style = "width: <?php echo $kunenaConfig->rtewidth-150?>px; height: 60px;" class = "inputbox"
							onmouseover = "textCounter(this.form.message,this.form.counter,<?php echo $kunenaConfig->maxsig;?>);" onclick = "textCounter(this.form.message,this.form.counter,<?php echo $kunenaConfig->maxsig;?>);"
							onkeydown = "textCounter(this.form.message,this.form.counter,<?php echo $kunenaConfig->maxsig;?>);" onkeyup = "textCounter(this.form.message,this.form.counter,<?php echo $kunenaConfig->maxsig;?>);"
					...
					<br />
					<div id="kunena_color_palette" style="margin-top: 14px; border: 1px; display: none;">
					...
					<div class="<?php echo $boardclass;?>posthint">
						<input class = "kunena_bbcode" type = "text" name = "helpbox" size = "45" class = "<?php echo $boardclass;?>inputbox" maxlength = "100" value = "<?php @print(_KUNENA_EDITOR_HELPLINE_HINT);?>" style="width: 99%;" />
					</div>
