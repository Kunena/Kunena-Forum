	...
	<div class="btn-toolbar btn-marging kmessagepadding">
		...
		<div class="btn-group">
			<a class="btn btn-default" data-toggle="dropdown"><i
					class="glyphicon glyphicon-pencil"></i> <?php echo JText::_('COM_KUNENA_MESSAGE_ACTIONS_LABEL_ACTION'); ?>
			</a>
		...
		<?php if ($this->messageButtons->get('moderate')) : ?>
			<div class="btn-group">
				<a class="btn btn-default" data-toggle="dropdown"><i
						class="glyphicon glyphicon-random"></i> <?php echo JText::_('COM_KUNENA_MESSAGE_ACTIONS_LABEL_MODERATE'); ?>
				</a>
				<a class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></a>
				<ul class="dropdown-menu" role="menu">
