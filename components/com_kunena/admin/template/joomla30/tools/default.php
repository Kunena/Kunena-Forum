		...
		<div class="well well-small">
			...
			<div id="dashboard-icons" class="btn-group">
				...
				<a class="btn" href="index.php?option=com_kunena&view=tools&layout=purgerestatements">
					<i class="icon-big icon-filter"
						alt="<?php echo JText::_('COM_KUNENA_A_PURGE_RE_STATEMENTS'); ?>"></i><br />
				...
				<a class="btn" href="index.php?option=com_kunena&view=tools&layout=cleanupip">
					<i class="icon-big icon-location"
						alt="<?php echo JText::_('COM_KUNENA_CPANEL_LABEL_CLEANUP_IP'); ?>"></i><br />
				...
				<a class="btn" href="index.php?option=com_kunena&view=tools&layout=uninstall">
					<i class="icon-big icon-remove"
						alt="<?php echo JText::_('COM_KUNENA_TOOLS_LABEL_UNINSTALL_PROCESS'); ?>"></i><br />
