...
<div
	class="badger-left badger-info <?php if ($this->topic->icon_id == 8) : ?> badger-solved <?php endif; ?> message-<?php echo $this->message->getState(); ?>"
				...
				<div class="col-md-9">
					<a href="#report<?php echo $this->message->id; ?>" role="button" class="btn-link report"
					   data-toggle="modal" data-backdrop="false"><i
							class="glyphicon glyphicon-warning-sign"></i> <?php echo JText::_('COM_KUNENA_REPORT') ?>
					</a>
