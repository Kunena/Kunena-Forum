...
//get the database prefixe
$prefix = explode('_',$databasetables[0]->Tables_in_konedotfivedoteight);
$prefixfinal = $prefix[0].'_fb_polls_datas';

$pollupgrade = 0;
for ($i=0;$i < sizeof($databasetables);$i++)
{
  if ($databasetables[$i]->Tables_in_konedotfivedoteight == $prefixfinal)
  {
    $pollupgrade = 1;
  }
}
