...
abstract class JHtmlKunenaGrid
{
	...
	public static function task($i, $img, $alt, $task, $prefix='') {
		$href ='<a href="'.KunenaRoute::_('index.php?option=com_kunena&view=announcement&do='.$task.'&id='.$i.'&'. JUtility::getToken() .'=1' ).'"><img src="'. KunenaFactory::getTemplate()->getImagePath($img) .'" alt="'. $alt .'" title="'. $alt .'" /></a>';
