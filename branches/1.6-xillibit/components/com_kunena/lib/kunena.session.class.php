...
class CKunenaSession extends JTable
{
	...
	function __construct(&$kunena_db)
	{
		...
		$this->lasttime = time() + $kunenaConfig->board_ofset - KUNENA_SECONDS_IN_YEAR;
		$this->currvisit = time() + $kunenaConfig->board_ofset;
	}
	...
	function store( $updateNulls=false )
	{
		...
		$this->currvisit = time() + $kunenaConfig->board_ofset * KUNENA_SECONDS_IN_HOUR;
	...
	function markAllCategoriesRead()
	{
		...
		$this->lasttime = time() + $kunenaConfig->board_ofset * KUNENA_SECONDS_IN_HOUR;
		$this->readtopics = '';
	}
	...
	function updateSessionInfo()
	{
		...
		$this->_sessiontimeout = ($this->currvisit + $kunenaConfig->kunenasessiontimeout) < time() + $kunenaConfig->board_ofset * KUNENA_SECONDS_IN_HOUR;
