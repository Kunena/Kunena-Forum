						...
						<tr id="kpost-attachments" class="krow<?php echo 1 + $this->k ^= 1; ?>">
							...
							<td class="kcol-mid">
								<div id="kattachment-id" class="kattachment">
									...
									<div class="kfile-hide hasTip"
										title="<?php echo JText::_('COM_KUNENA_FILE_EXTENSIONS_ALLOWED') ?>::<?php echo $this->escape(implode(', ', $this->allowedExtensions)) ?>">
										<input type="button"
											value="<?php echo JText::_('COM_KUNENA_EDITOR_ADD_FILE'); ?>"
											class="kfile-input-button kbutton" />
										<input id="kupload" class="kfile-input" name="kattachment" type="file" />
									</div>
									<a href="#" class="kattachment-remove kbutton"
										style="display: none"><?php echo JText::_('COM_KUNENA_GEN_REMOVE_FILE'); ?></a>
									<a href="#" class="kattachment-insert kbutton"
					...
					<?php if ($this->canSubscribe()) : ?>
						<tr id="kpost-subscribe" class="krow<?php echo 1 + $this->k ^= 1; ?>">
							...
							<td class="kcol-mid">
								...
								<label
									for="subscribeMe"><i><?php echo JText::_('COM_KUNENA_POST_NOTIFIED'); ?></i></label>
							</td>
						</tr>
					<?php endif; ?>
