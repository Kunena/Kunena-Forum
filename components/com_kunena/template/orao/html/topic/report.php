			...
			<?php echo JHTML::_( 'form.token' ); ?>
				...
				<div class=kdetailsbox>
					<ul class="kform clearfix">
						...
						<li class="krow-odd">
							<div class="kform-field"><input class="tk-submit-button" type="submit" name="Submit" value="<?php echo JText::_('COM_KUNENA_REPORT_SEND') ?>"/>
							<input onclick="javascript:window.history.back();" title="<?php echo JText::_ ( 'COM_KUNENA_CANCEL_DESC') ?>" class="tk-submit-button" type="button" name="back" value="<?php echo JText::_('COM_KUNENA_CANCEL') ?>"/></div>
						</li>
					</ul>
				</div>
