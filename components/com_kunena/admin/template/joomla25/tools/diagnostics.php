	...
	<div id="kadmin">
		...
		<div class="kadmin-right">
			...
			if ($task) :
				...
				<div
					class="kadmin-functitle icon-config"><?php echo JText::sprintf('COM_KUNENA_DIAGNOSTICS_LABEL_DIAG_ON', $task); ?></div>
			...
			<div
				class="kadmin-functitle icon-config"><?php echo JText::_('COM_KUNENA_DIAGNOSTICS_LABEL_DIAGNOSTICS'); ?></div>
			<table class="adminform">
				<?php foreach (KunenaForumDiagnostics::getList() as $item) : ?>
					...
					<tr>
						...
						<?php if ($count) : ?>
							...
							<td>
								<a href="<?php echo KunenaRoute::_("administrator/index.php?option=com_kunena&view=tools&layout=diagnostics&test={$item}"); ?>"><?php echo JText::sprintf('COM_KUNENA_DIAGNOSTICS_LABEL_NUMBER_OF_ISSUES', "<b>{$count}</b>") ?></a>
							</td>
							<td>
