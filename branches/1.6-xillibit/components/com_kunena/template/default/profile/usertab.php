	...
	<dl class="tabs">
		...
		<dd class="kprofile-modtools">
			...
			<form id="kform-ban" name="kformban" action="index.php" method="post">
				...
				<label>
				<li id="ban-fields" style="display:none;"><ul><span><?php echo JText::_('COM_KUNENA_BAN_EXPIRY'); ?></span><input class="inputbox" type="text" maxlength="15"
				name="banexpiry" id="banexpiry"	 /> <img src="templates/system/images/calendar.png" alt="Calendar" onclick="showCalendar('banexpiry','%Y-%m-%d');"
				 /></ul>
				<ul><span><?php echo JText::_('COM_KUNENA_BAN_MESSAGE'); ?></span><input type="text" name="banmessage" /></ul></li></label>
