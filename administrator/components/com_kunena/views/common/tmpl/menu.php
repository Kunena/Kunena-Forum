...
<div id="kadmin-menu">
	...
	<a class="kadmin-mainmenu icon-pluginsmanager-sm" href="<?php echo JRoute::_('administrator/index.php?option=com_plugins&view=plugins&filter_'.(version_compare(JVERSION, '1.6', '>') ? 'folder' : 'type').'=kunena') ?>"><?php echo JText::_('COM_KUNENA_PLUGINS_MANAGER'); ?></a>
