	...
	<table class="kpostbuttonset">
		...
		<tr>
			...
			<span class="kmsgtext-xs" title='[size=1]'
				...
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_FONTSIZE_XS');?>')">&nbsp;<?php
				echo JText::_('COM_KUNENA_EDITOR_SIZE_SAMPLETEXT');
				?>&nbsp;</span>
			<span class="kmsgtext-s" title='[size=2]'
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_FONTSIZE_S');?>')">&nbsp;<?php
				echo JText::_('COM_KUNENA_EDITOR_SIZE_SAMPLETEXT');
				?>&nbsp;</span>
			<span class="kmsgtext-m" title='[size=3]'
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_FONTSIZE_M');?>')">&nbsp;<?php
				echo JText::_('COM_KUNENA_EDITOR_SIZE_SAMPLETEXT');
				?>&nbsp;</span>
			<span class="kmsgtext-l" title='[size=4]'
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_FONTSIZE_L');?>')">&nbsp;<?php
				echo JText::_('COM_KUNENA_EDITOR_SIZE_SAMPLETEXT');
				?>&nbsp;</span>
			<span class="kmsgtext-xl" title='[size=5]'
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_FONTSIZE_XL');?>')">&nbsp;<?php
				echo JText::_('COM_KUNENA_EDITOR_SIZE_SAMPLETEXT');
				?>&nbsp;</span>
			<span class="kmsgtext-xxl" title='[size=6]'
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_FONTSIZE_XXL');?>')">&nbsp;<?php
				echo JText::_('COM_KUNENA_EDITOR_SIZE_SAMPLETEXT');
				?>&nbsp;</span>
			</div>
			...
			<div id="kbbcode-link-options" style="display: none;">
				...
				<input id="kbbcode-link_url" name="url" type="text" size="40" value="http://"
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_LINKURL'); ?>')" />
				<?php echo JText::_('COM_KUNENA_EDITOR_LINK_TEXT'); ?>&nbsp;
				<input name="text2" id="kbbcode-link_text" type="text" size="30" maxlength="150"
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_LINKTEXT'); ?>')" />
				<input type="button" name="insterLink" value="<?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?>"
					...
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_LINKAPPLY'); ?>')" />
			</div>
			...
			<div id="kbbcode-image-options" style="display: none;">
				...
				<input id="kbbcode-image_size" name="size" type="text" size="10" maxlength="10"
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_IMAGELINKSIZE'); ?>')" />
				<?php echo JText::_('COM_KUNENA_EDITOR_IMAGELINK_URL'); ?>&nbsp;
				<input name="url2" id="kbbcode-image_url" type="text" size="40" value="http://"
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_IMAGELINKURL'); ?>')" />&nbsp;
				<input type="button" name="Link" value="<?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?>" onclick="kInsertImageLink()"
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_IMAGELINKAPPLY'); ?>')" />
			</div>
			...
			<div id="kpoll-hide-not-allowed" <?php if(!$display_poll) { ?> style="display:none;" <?php } ?> >
				...
				<input type="text" class="inputbox" name="poll_title" id="kpoll-title"
					...
					onmouseover="javascript:$('helpbox').set('value', '<?php
					echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_POLLTITLE'); ?>')" />

				<img id="kbutton-poll-add"
					src="<?php echo JURI::root(); ?>/components/com_kunena/template/default/images/icons/poll_add_options.png"
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_ADDPOLLOPTION'); ?>')" />
				<img id="kbutton-poll-rem"
					src="<?php echo JURI::root(); ?>/components/com_kunena/template/default/images/icons/poll_rem_options.png"
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_REMPOLLOPTION'); ?>')" />
				...
				<input class="inputbox" type="text" maxlength="15"
					...
					onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_POLLLIFESPAN'); ?>')" />
				...
				if ( file_exists($path) ) {
					...
					<div id="kbbcode-code-options" style="display: none;">
						...
						<select id="kcodetype" name="kcode_type" class="kbutton"
							onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_CODETYPE'); ?>')">
						<?php
					...
					<input id="kbutton_addcode" type="button" name="Code" onclick="kInsertCode()" value="<?php echo JText::_('COM_KUNENA_EDITOR_CODE_INSERT'); ?>"
						onmouseover="javascript:$('helpbox').set('value', '<?php echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_CODEAPPLY'); ?>')" />
					</div>
			<?php }
			}
			?>
			...
			?><input id="kvideosize"
				...
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOSIZE');
				?>')" />
			<?php
			...
			?><input id="kvideowidth" name="videowidth"
				...
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOWIDTH');
				?>')" />
			<?php
			...
			?><input id="kvideoheight"
				...
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOHEIGHT');
				?>')" /> <br />
			<?php
			...
			?> <select id="kvideoprovider"
				...
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOPROVIDER');
				?>')">
				<?php
			...
			?><input id="kvideoid"
				...
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOID');
				?>')" />
			<input id="kbutton_addvideo1" type="button" name="Video" accesskey="p"
				...
				value="<?php
						...
						?>"
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY1');
				?>')" /><br />
			<?php
			...
			?><input id="kvideourl" name="videourl"
				...
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOURL');
				?>')" />
			<input id="kbutton_addvideo2" type="button" name="Video" accesskey="p"
				...
				value="<?php
						...
						?>"
				onmouseover="javascript:$('helpbox').set('value', '<?php
				echo KunenaParser::KText('COM_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY2');
				?>')" />
			</div>
			</td>
		</tr>
