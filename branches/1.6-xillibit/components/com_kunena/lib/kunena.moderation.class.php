...
define ( 'KN_DEL_MESSAGE_PERMANENTLY', 1 );
...
class CKunenaModeration {
	...
	protected function _Delete($MessageID, $DeleteAttachments = false, $mode = KN_DEL_MESSAGE) {
		...
		if ( $currentMessage->parent == 0 ) {
				...
				break;
			case KN_DEL_MESSAGE_PERMANENTLY : // Delete the message from the database
	...
	public function deleteMessagePermanently($MessageID, $DeleteAttachments = false) {
