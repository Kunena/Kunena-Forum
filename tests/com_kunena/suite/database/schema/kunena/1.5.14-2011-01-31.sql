...
KEY `mesid` (`mesid`) ) DEFAULT CHARSET=utf8;
...
PRIMARY KEY  (`mesid`) ) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__fb_moderation` (
	...
	`future2` int(11) default '0',
PRIMARY KEY  (`catid`,`userid`) ) DEFAULT CHARSET=utf8;
...
KEY `posts` (`posts`),
KEY `uhits` (`uhits`) ) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__fb_ranks` (
	`rank_id` mediumint(8) unsigned NOT NULL auto_increment,
	`rank_title` varchar(255) NOT NULL default '',
	`rank_min` mediumint(8) unsigned NOT NULL default '0',
	`rank_special` tinyint(1) unsigned NOT NULL default '0',
	`rank_image` varchar(255) NOT NULL default '',
PRIMARY KEY  (`rank_id`) ) DEFAULT CHARSET=utf8;
...
INSERT INTO `#__fb_groups`(`id`,`title`) values (1,'"._KUNENA_REGISTERED."');

INSERT INTO `#__fb_smileys`(`id`,`code`,`location`,`greylocation`,`emoticonbar`) VALUES
