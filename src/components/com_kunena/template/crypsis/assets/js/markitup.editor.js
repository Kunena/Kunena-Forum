bbcodeSettings = {
		previewParserPath:	'',
		markupSet: [{className: 'boldbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_BOLD'),key: 'B',openWith: '[b]',closeWith: '[/b]'},{className: 'italicbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_ITALIC'),key: 'I',openWith: '[i]',closeWith: '[/i]'},{className: 'underlinebutton',name: Joomla.JText._('COM_KUNENA_EDITOR_UNDERL'),key: 'U',openWith: '[u]',closeWith: '[/u]'},{className: 'strokebutton',name: Joomla.JText._('COM_KUNENA_EDITOR_STRIKE'),key: 'T',openWith: '[strike]',closeWith: '[/strike]'},{className: 'subscriptbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_SUB'),key: 'T',openWith: '[sub]',closeWith: '[/sub]'},{className: 'supscriptbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_SUP'),key: 'T',openWith: '[sup]',closeWith: '[/sup]'},{ className: 'sizebutton', name: Joomla.JText._('COM_KUNENA_EDITOR_FONTSIZE_SELECTION'), key:'S', openWith:'[size=[![Text size]!]]', closeWith:'[/size]',	dropMenu :[
						...
						]},{separator:'|' },{className: 'bulletedlistbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_ULIST'),openWith: '[ul]\n  [li]',closeWith: '[/li]\n  [li][/li]\n[/ul]'},{className: 'numericlistbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_OLIST'),openWith: '[ol]\n  [li]',closeWith: '[/li]\n  [li][/li]\n[/ol]'},{className: 'listitembutton',name: Joomla.JText._('COM_KUNENA_EDITOR_LIST'),openWith: '\n  [li]',closeWith: '[/li]'},{className: 'hrbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_HR'),openWith: '[hr]'},{className: 'alignleftbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_LEFT'),openWith: '[left]',closeWith: '[/left]'},{className: 'centerbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_CENTER'),openWith: '[center]',closeWith: '[/center]'},{className: 'alignrightbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_RIGHT'),openWith: '[right]',closeWith: '[/right]'},{separator:'|' },{className: 'quotebutton',name: Joomla.JText._('COM_KUNENA_EDITOR_QUOTE'),openWith: '[quote]',closeWith: '[/quote]'},{className: 'codesimplebutton',name: Joomla.JText._('COM_KUNENA_EDITOR_CODE'),openWith: '[code]',closeWith: '[/code]'},{name:'code', className: 'codemodalboxbutton', beforeInsert:function() {
					...
					},{className: 'tablebutton',name: Joomla.JText._('COM_KUNENA_EDITOR_TABLE'),openWith: '[table]\n  [tr]\n   [td][/td]\n   [td][/td]\n  [/tr]',closeWith: '\n  [tr]\n   [td][/td]\n   [td][/td]\n [/tr]\n[/table] \n'},{className: 'spoilerbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_SPOILER'),openWith: '[spoiler]',closeWith: '[/spoiler]'},{className: 'hiddentextbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_HIDE'),openWith: '[hide]',closeWith: '[/hide]'},{className: 'confidentialbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_CONFIDENTIAL'),openWith: '[confidential]',closeWith: '[/confidential]'},{separator:'|' },{name: Joomla.JText._('COM_KUNENA_EDITOR_IMAGELINK'), className: 'picturebutton', beforeInsert:function() {
					...
					},{className: 'tweetbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_TWEET'),openWith: '[tweet]',closeWith: '[/tweet]'},{className: 'soundcloudbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_SOUNDCLOUD'),openWith: '[soundcloud]',closeWith: '[/soundcloud]'},{className: 'instagrambutton',name: Joomla.JText._('COM_KUNENA_EDITOR_INSTAGRAM'),openWith: '[instagram]',closeWith: '[/instagram]'},{name: Joomla.JText._('COM_KUNENA_EDITOR_EMOTICONS'), className: 'emoticonsbutton', beforeInsert:function() {
