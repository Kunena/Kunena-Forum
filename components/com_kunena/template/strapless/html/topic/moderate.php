  ...
  <div class="well" id="kmod-container">
    <form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" method="post" name="myform" id="myform">
      ...
      <div class="center">
        ...
        <a href="javascript:history.back();" class="btn" ><span class="kbutton-back"><?php echo JText::_ ( 'COM_KUNENA_BACK' ); ?></span></a> </div>
    </form>
  </div>
</div>
