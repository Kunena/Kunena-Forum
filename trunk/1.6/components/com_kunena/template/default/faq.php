...
$document->setTitle(_GEN_HELP . ' - ' . stripslashes($kunenaConfig->board_title));
...
<table class = "kunena_blocktable" id ="kunena_forumfaq" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
            <thead>
                <tr>
                    <th>
                        ...
                        <span class="kunena_title kunenal" ><?php echo _COM_FORUM_HELP; ?></span>
                        </div>
                    </th>
                </tr>
            </thead>
        ...
        <?php
          $kunena_db->setQuery("SELECT introtext, id FROM #__content WHERE id='{$kunenaConfig->help_cid}'");
