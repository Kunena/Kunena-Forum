			...
			if ($this->config->shownew && $this->my->id != 0) {
				...
				if ($subcat->new) {
					...
					if (is_file ( KUNENA_ABSCATIMAGESPATH . $subcat->id . "_on.gif" )) {
						...
						$allsubcats [$i]->categoryicon .= CKunenaTools::showIcon ( 'kunreadforum', JText::_('COM_KUNENA_GEN_FORUM_NEWPOST'), JText::_('COM_KUNENA_GEN_FORUM_NEWPOST') );
					}
				} else {
					...
					if (is_file ( KUNENA_ABSCATIMAGESPATH . $subcat->id . "_off.gif" )) {
						...
						$allsubcats [$i]->categoryicon .= CKunenaTools::showIcon ( 'kreadforum', JText::_('COM_KUNENA_GEN_FORUM_NOTNEW'), JText::_('COM_KUNENA_GEN_FORUM_NOTNEW') );
					}
				}
			} else {
				if (is_file ( KUNENA_ABSCATIMAGESPATH . $subcat->id . "_notlogin.gif" )) {
					...
					$allsubcats [$i]->categoryicon .= CKunenaTools::showIcon ( 'knotloginforum', JText::_('COM_KUNENA_GEN_FORUM_NOTNEW'), JText::_('COM_KUNENA_GEN_FORUM_NOTNEW') );
				}
			}
