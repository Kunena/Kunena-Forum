...
<table border="0" cellpadding="5" class="<?php echo isset ( $this->objCatInfo->class_sfx ) ? ' kblocktable' . $this->objCatInfo->class_sfx : ''; ?>">
	...
	<tbody>
		<tr class="ksectiontableentry<?php echo ($i^=1)+1;?>">
			<td style="text-align:center;padding: 1 10px;" width="1%"><a href="#"> <?php echo $banned->id; ?> </a></td>
			<td style="white-space:nowrap;text-align:center;padding: 0 10px;"><a href="#"><?php echo CKunenaLink::GetProfileLink ( $banned->userid, $banned->username ); ?> </a></td>
			<td style="white-space:nowrap;text-align:center;padding: 0 10px;;">
				<span><?php if ($banned->bantype == '1') { echo JText::_('Blue Ban'); } else { echo JText::_('Red Ban'); } ?></span>
			</td>
			<td style="white-space:nowrap;text-align:center;padding: 0 10px;"><span><?php echo $banned->created; ?></span></td>
			<td style="white-space:nowrap;text-align:center;padding: 0 10px;"><span><?php echo $banned->expiry; ?></span></td>
			<td style="white-space:nowrap;text-align:center;padding: 0 10px;"><span><a href="#"><?php echo $banned->ip; ?></a></span></td>
			...
			<td style="text-align:center;padding: 0 1px;">
				<img class="deleteicon" src="<?php echo KUNENA_URLICONSPATH . 'edit.png';?>"  alt="<?php echo JText::_('Edit ban'); ?>" title="<?php echo JText::_('Edit ban'); ?>" />
			</td>
			<td style="white-space:nowrap;text-align:center;padding: 0 1px;">
				<img class="deleteicon" src="<?php echo KUNENA_URLICONSPATH . 'block.png';?>"  alt="<?php echo JText::_('Block user'); ?>" title="<?php echo JText::_('Block user'); ?>" />
			</td>
			<td style="white-space:nowrap;text-align:center;padding: 0 1px;">
				<img class="deleteicon" src="<?php echo KUNENA_URLICONSPATH . 'logout.png';?>"  alt="<?php echo JText::_('Logout user'); ?>" title="<?php echo JText::_('Logout user'); ?>" />
			</td>
			<td style="white-space:nowrap;text-align:center;padding: 0 1px;"><a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','userUnban')">
