		...
		if (!isset($this->_shorttype)) {
			...
			switch (strtolower ( $this->_shorttype )) {
				case 'image' :
					...
					if ($config->use_lazyload)  $img = '<img class="lazy" title="' . $this->escape ( $this->filename ) . '" ' . $imgsize . ' src="' . JUri::root() . 'media/kunena/images/grey.gif" data-original="'. JUri::root() . $thumb .'" alt="' . $this->escape ( $this->filename ) . '" />';
					...
					if ($config->use_lazyload) $img = '<img class="lazy" title="' . $this->escape ( $this->filename ) . '" src="' . JUri::root() . 'media/kunena/images/grey.gif" data-original="' . JUri::root () . $this->escape ( $this->folder ) . '/' . $this->escape ( $this->filename ) . '" alt="' . $this->escape ( $this->filename ) . '" />';
