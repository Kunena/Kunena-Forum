        ...
        <table class="table table-striped">
          <thead>
            <tr>
              ...
              <th class="center span1"><small> <?php echo JHtml::_('grid.sort', JText::_('COM_KUNENA_REORDER'), 'ordering', $this->state->get('list.direction'), $this->state->get('list.ordering') ); ?> <?php echo JHtml::_('grid.order', $this->state->get('list.count.admin') ); ?></small> </th>
          ...
          <tr <?php echo 'class = "row' . $k . '"';?>>
            <td class="span1"><?php echo $j + $this->navigation->limitstart + 1; ?></td>
            ...
            <td class="span1" width="70%"><a href="#edit" onclick="return listItemTask('cb<?php echo $i ?>','edit')"><?php echo str_repeat  ( '...', $category->level  ).' '.$category->name; ?></a></td>
            <?php endif; ?>
            <td class="span1"><?php echo intval($category->id); ?></td>
            <?php if (!$category->authorise('admin')): ?>
            <td colspan="6"></td>
            <?php elseif ($category->isSection()): ?>
            <td class="span1"> <span><?php echo $this->navigation->orderUpIcon ( $i, $category->up, 'orderup', 'Move Up', 1 ); ?></span> <span><?php echo $this->navigation->orderDownIcon ( $i, $n, $category->down, 'orderdown', 'Move Down', 1 ); ?></span>
