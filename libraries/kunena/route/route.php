...
abstract class KunenaRoute
{
	...
	public static function initialize()
	{
		...
		foreach (JFactory::getApplication()->input->get('post') as $key => $value)
		{
		...
		foreach (JFactory::getApplication()->input->get('get') as $key => $value)
		{
