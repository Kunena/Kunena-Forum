...
<table>
	<tbody class="kmyprofile_general">
		<tr class="krow2">
			...
			<td class="kcol-mid">
				<input type="text" name="username" id="username" value="<?php echo $this->escape($this->user->get('username'));?>" <?php echo !$this->config->usernamechange && !$this->com_users->change_login_name ? 'disabled="disabled" ' : ''?>/>
			</td>
		</tr>
		<tr class="krow1">
			<td class="kcol-first">
