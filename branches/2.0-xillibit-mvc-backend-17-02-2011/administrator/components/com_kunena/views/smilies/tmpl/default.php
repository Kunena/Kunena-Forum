			...
			<tfoot>
				...
				<tr class="row<?php echo $k; ?>" align="center">
					...
					<td width="50" align="center"><a href="#edit"
						...
						?>','edit')"><img
						src="<?php
						echo kescape( KURL_SITE . $this->template->getSmileyPath($row->location) )
						?>"
						alt="<?php
						echo kescape($row->location);
						?>" border="0" /></a></td>
					<td width="50" align="center"><?php echo kescape($row->code); ?>&nbsp;</td>
					<td width="80%" align="left"><?php echo kescape($row->location); ?>&nbsp;</td>
				</tr>
				<?php
					}
					?>
