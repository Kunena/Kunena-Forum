...
if ($this->msg->modified_time) {
	$datehover = 'title="'.CKunenaTimeformat::showDate($this->escape($this->msg->modified_time), 'config_post_dateformat_hover').'"';
	$dateshown =  CKunenaTimeformat::showDate($this->escape($this->msg->modified_time), 'config_post_dateformat' ).' ';
}
?>
