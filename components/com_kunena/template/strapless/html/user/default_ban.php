        ...
        <tbody>
          ...
          <tr class="krow<?php echo ($i^=1)+1;?>">
            <td class="kcol-first"><b><?php echo JText::_('COM_KUNENA_BAN_EXPIRETIME'); ?></b><br />
              <span class="ks"><?php echo JText::_('COM_KUNENA_BAN_STARTEXPIRETIME_DESC'); ?></span> </td>
            <td class="kcol-mid"> <?php echo JHtml::_('calendar', $this->escape($this->baninfo->expiration), 'expiration', 'expiration', '%Y-%m-%d',array('onclick'=>'$(\'expiration\').setStyle(\'display\')')); ?> </td>
          </tr>
          <tr class="krow<?php echo ($i^=1)+1;?>">
            <td class="kcol-first"><b><?php echo JText::_('COM_KUNENA_BAN_PUBLICREASON'); ?></b><br />
              <span class="ks"><?php echo JText::_('COM_KUNENA_BAN_PUBLICREASON_DESC'); ?></span> </td>
            <td class="kcol-mid">
          ...
          <tr class="krow<?php echo ($i^=1)+1;?>">
            <td class="kcol-first"><b><?php echo JText::_('COM_KUNENA_BAN_PRIVATEREASON'); ?></b><br />
              <span class="ks"><?php echo JText::_('COM_KUNENA_BAN_PRIVATEREASON_DESC'); ?></span> </td>
            <td class="kcol-mid">
          ...
          <tr class="krow<?php echo ($i^=1)+1;?>">
            <td class="kcol-first"><b><?php echo JText::_('COM_KUNENA_BAN_ADDCOMMENT'); ?></b><br />
              <span class="ks"><?php echo JText::_('COM_KUNENA_BAN_ADDCOMMENT_DESC'); ?></span> </td>
            <td class="kcol-mid">
