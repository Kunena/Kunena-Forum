...
<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" method="post" name="ktopicsform" id="ktopicsform">
  ...
  <div class="well"> <span class="pull-right"> <?php echo $this->getPagination (5); // odd number here (# - 5) ?> </span> <span class="pull-right">
    ...
    <div class="row-fluid column-row kunena-row">
      <div class="span12 column-item">
        <table class="table table-striped table-hover">
          ...
          <tr>
            <td><?php echo JText::_('COM_KUNENA_VIEW_NO_TOPICS') ?></td>
          </tr>
          <?php else : ?>
