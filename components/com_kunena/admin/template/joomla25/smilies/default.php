				...
				<div id="j-main-container" class="span10">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab1"
								data-toggle="tab"><?php echo JText::_('COM_KUNENA_A_EMOTICONS'); ?></a>
						</li>
						<li><a href="#tab2"
								data-toggle="tab"><?php echo JText::_('COM_KUNENA_A_EMOTICONS_UPLOAD'); ?></a></li>
					</ul>
					<div class="tab-content">
						<div id="tab1" class="tab-pane active">
							<form action="<?php echo KunenaRoute::_('administrator/index.php?option=com_kunena') ?>"
								...
								<div id="filter-bar" class="btn-toolbar">
									...
									<div class="btn-group pull-right">
										...
										<select name="sortTable" id="sortTable" class="input-medium"
											onchange="Joomla.orderTable()">
											<option
												value=""><?php echo JText::_('COM_KUNENA_SORT_TABLE_BY'); ?></option>
								...
								<table class="table table-striped">
									<thead>
									<tr>
										<th class="nowrap center" width="1%"><input type="checkbox" name="toggle"
												value=""
												onclick="checkAll(<?php echo count($this->items); ?>);" />
										</th>
										<th class="nowrap center"
											width="5%"><?php echo JText::_('COM_KUNENA_EMOTICON'); ?></th>
										<th class="nowrap"
											width="8%"><?php echo JHtml::_('grid.sort', 'COM_KUNENA_EMOTICONS_CODE', 'code', $this->listDirection, $this->listOrdering); ?></th>
									...
									<tr>
										...
										<td class="nowrap center">
											<label for="filter_code"
												class="element-invisible"><?php echo JText::_('COM_KUNENA_FIELD_LABEL_SEARCHIN') ?>
												:</label>
										...
										<td class="nowrap center">
											<label for="filter_location"
												...
												:</label>
											<input class="input-block-level input-filter filter" type="text"
												name="filter_location" id="filter_location"
												placeholder="<?php echo JText::_('COM_KUNENA_SYS_BUTTON_FILTERSUBMIT') ?>"
									...
									if ($this->pagination->total > 0) :
										foreach ($this->items as $id => $row)
										{
											...
											<tr class="row<?php echo $k; ?>" align="center">
												...
												<td class="center">
													<a href="#edit"
														onclick="return listItemTask('cb<?php echo $id; ?>','edit')"><img
						...
						<div id="tab2" class="tab-pane">
							<form action="<?php echo KunenaRoute::_('administrator/index.php?option=com_kunena') ?>"
								...
								<input type="submit" id="file-upload-submit"
