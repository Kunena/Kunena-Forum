...
<form action = "<?php echo JRoute::_(JB_LIVEURLREL.'&amp;func=myprofile&amp;do=unfavorite'); ?>" method = "post" name = "postform">
			...
			if ($cfavslist > 0)
			{
				...
				{ //get all message details for each favorite
					...
					foreach ($favdet as $fav)
					{
						...
						echo '<td class="td-1" width="73%" align="left">' . $enum . ': <a href="' . JRoute::_(JB_LIVEURLREL . '&amp;func=view&amp;catid=' . $fav->catid . '&amp;id=' . $fav->id) . '">' . $fav->subject;
			?>
