		...
		<div class="btn-toolbar btn-marging">
			<div class="kmessage-buttons-cover">
				<div class="kmessage-buttons-row">
					<input type="button" class="btn kreply-form-reply" name="kreply-form" value="Quick Reply" onclick="document.getElementById('kreply<?php echo intval($this->message->id) ?>_form').style.display = 'block';" />
					<div class="btn-group">
