<?php
/**
 * @version $Id: edit.php 4416 2011-02-16 08:43:29Z xillibit $
 * Kunena Component
 * @package Kunena
 *
			...
			<fieldset class="adminform">
				...
				<tr>
					...
					<td><?php $path = KUNENA_PATH_TEMPLATE.'/'.$this->templatename. '/images/template_thumbnail.png';
						if (file_exists ( $path )) : ?>
						<div class="tpl-thumbnail"><img src ="<?php echo JURI::root (); ?>/components/com_kunena/template/<?php echo kescape($this->templatename); ?>/images/template_thumbnail.png" alt="" /></div>
						<?php endif; ?>
