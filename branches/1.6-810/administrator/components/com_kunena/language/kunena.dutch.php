<?php
/**
* @version $Id: dutch.php 933 2009-02-08 01:00:00
* Kunena Component
* @package Kunena
...
// 1.6 
 DEFINE('_KUNENA_NEW_SMILIE', 'Nieuwe Smilie'); 
// 1.0.11 and 1.5.4
DEFINE('_KUNENA_BACK', 'Back');
DEFINE('_KUNENA_MOVED', 'Verplaatst');
...
// 1.0.11 and 1.5.3
DEFINE('_KUNENA_VERSION_SVN', 'SVN Revisie');
DEFINE('_KUNENA_VERSION_DEV', 'Development Snapshot');
DEFINE('_KUNENA_VERSION_ALPHA', 'Alpha versie');
DEFINE('_KUNENA_VERSION_BETA', 'Beta versie');
DEFINE('_KUNENA_VERSION_RC', 'Release Candidate');
DEFINE('_KUNENA_VERSION_INSTALLED', 'Geinstalleerde Kunena Versie: %s (%s).');
DEFINE('_KUNENA_VERSION_SVN_WARNING', 'Gebruik nooit een SVN revisie anders dan om te testen van de software!');
DEFINE('_KUNENA_VERSION_DEV_WARNING', 'Deze interne versie mag alleen worden gebruikt door developers en testers!');
DEFINE('_KUNENA_VERSION_ALPHA_WARNING', 'Deze versie mag niet worden gebruikt op een live site.');
DEFINE('_KUNENA_VERSION_BETA_WARNING', 'Deze versie mag niet worden gebruikt op een live site.');	
DEFINE('_KUNENA_VERSION_RC_WARNING', 'Deze versie bevat nog fouten, en zal worden gerepareerd in de eind versie.');	
DEFINE('_KUNENA_ERROR_UPGRADE', 'Upgrading naar Kunena versie is mislukt!');
DEFINE('_KUNENA_ERROR_UPGRADE_WARN', 'Je forum mist een aantal belangrijke updates en sommige functies werken niet naar behoren.');
DEFINE('_KUNENA_ERROR_UPGRADE_AGAIN', 'A.U.B probeer nogmaals de upgrade. Als je niet kunt upgraden naar Kunena %s, kan je gemakkelijk downgraden naar de laatste werkende versie.');
DEFINE('_KUNENA_PAGE', 'Pagina');
DEFINE('_KUNENA_RANK_NO_ASSIGNED', 'Geen Rank Toegewezen');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_GENERAL', 'Problemen gevonden in Community Builder integratie:');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_INSTALL', 'Community Builder integratie werkt alleen als je Community Builder versie %s of hoger hebt geinstalleerd.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_PUBLISH', 'Community Builder Profiel integratie werkt alleen als je Community Builder User profiel hebt  gepubliseerd');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_UPDATE', 'Community Builder integratie werkt alleen als je Community Builder versie %s of hoger hebt geinstalleerd.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_XHTML', 'Community Builder integratie werkt alleen als je Community Builder in W3C XHTML 1.0 Trans. compliance mode hebt ingesteld.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_INTEGRATION', 'Community Builder Profiel integratie werkt alleen als je de forum integratie plugin hebt ingesteld in Community Builder.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_HIDE', 'Opslaan van Kunena configuratie zal integratie uitzetten en zal dit bericht verbergen.');

// Joni Edition - Plugins
DEFINE('_COM_A_PLUGINS', 'Hacks');
DEFINE('_KUNENA_JONI_ACTIVADO', 'Activeer:');
DEFINE('_KUNENA_JONI_PLUGINS', 'Kunena NL Ultimate Instellingen');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_CODE', 'Code weergaven: [code]code[/code]');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINK', 'Fotolink: [img size=(01-499)]http://www.google.com/images/web_logo_left.gif[/img]');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_LINK', 'Link: [url=http://www.zzz.com/]Dit is een link[/url]');
...
DEFINE('_KUNENA_BBCODE_HIDDENTEXT', '<span class="fb_quote">Er is iets verborgen voor gasten. Alstublieft Login of registreer
je om de verborgen tekst te zien.</span>');

DEFINE('_KUNENA_PROFILE_BIRTHDAY', 'Verjaardag');
DEFINE('_KUNENA_DT_MONTHDAY_FMT','%d.%m');
DEFINE('_KUNENA_CFC_FILENAME','CSS file aangepast');
DEFINE('_KUNENA_CFC_SAVED','CSS file opgeslagen.');
DEFINE('_KUNENA_CFC_NOTSAVED','CSS file niet opgeslagen.');
DEFINE('_KUNENA_JS_WARN_NAME_MISSING','Je naam ontbreekt');
DEFINE('_KUNENA_JS_WARN_UNAME_MISSING','Je gebruikersnaam ontbreekt');
DEFINE('_KUNENA_JS_WARN_VALID_AZ09','Veld bevat ongewenste karakters');
DEFINE('_KUNENA_JS_WARN_MAIL_MISSING','Je e-mail adres ontbreekt');
DEFINE('_KUNENA_JS_WARN_PASSWORD2','Voer een geldige wachtwoord in');
DEFINE('_KUNENA_JS_PROMPT_UNAME','Herschrijf je Gebruikersnaam');
DEFINE('_KUNENA_JS_PROMPT_PASS','Herschrijf je wachtwoord');
DEFINE('_KUNENA_DT_LMON_DEC', 'December');
DEFINE('_KUNENA_DT_MON_DEC', 'Dec');
DEFINE('_KUNENA_NOGENDER', 'Onbekend');
DEFINE('_KUNENA_ERROR_INCOMPLETE_ERROR', 'De Installatie is mislukt!');
...
DEFINE('_KUNENA_ERROR_INCOMPLETE_REASONS', 'Vermoedelijke reden voor fout:');
DEFINE('_KUNENA_ERROR_INCOMPLETE_1', '1) Kunena installatie proces is niet goed geinstalleerd (Probeer het nog eens)');
DEFINE('_KUNENA_ERROR_INCOMPLETE_2', '2) Je hebt een aantal tabbellen verwijderd in je database');
DEFINE('_KUNENA_ERROR_INCOMPLETE_3', '3) Je database is niet goed');
DEFINE('_KUNENA_ERROR_INCOMPLETE_SUPPORT', 'Onze support kan je hier vinden:');

// Search
DEFINE('_KUNENA_SEARCH_RESULTS', 'Zoekresultaten');
DEFINE('_KUNENA_SEARCH_ADVSEARCH', 'Geavanceerd zoeken');
DEFINE('_KUNENA_SEARCH_SEARCHBY_KEYWORD', 'Zoek op trefwoord');
DEFINE('_KUNENA_SEARCH_KEYWORDS', 'Trefwoorden');
DEFINE('_KUNENA_SEARCH_SEARCH_POSTS', 'Zoeken in alle berichten');
DEFINE('_KUNENA_SEARCH_SEARCH_TITLES', 'Alleen zoeken in titels');
DEFINE('_KUNENA_SEARCH_SEARCHBY_USER', 'Zoeken op gebruikersnaam');
DEFINE('_KUNENA_SEARCH_UNAME', 'Gebruikersnaam');
DEFINE('_KUNENA_SEARCH_EXACT', 'Exacte naam');
DEFINE('_KUNENA_SEARCH_USER_POSTED', 'Berichten gepost door');
DEFINE('_KUNENA_SEARCH_USER_STARTED', 'Onderwerpen gestart door');
DEFINE('_KUNENA_SEARCH_USER_ACTIVE', 'Activiteit in onderwerpen');
DEFINE('_KUNENA_SEARCH_OPTIONS', 'Zoekopties');
DEFINE('_KUNENA_SEARCH_FIND_WITH', 'Zoek onderwerpen met');
DEFINE('_KUNENA_SEARCH_LEAST', 'tenminste');
DEFINE('_KUNENA_SEARCH_MOST', 'hooguit');
DEFINE('_KUNENA_SEARCH_ANSWERS', 'antwoorden');
DEFINE('_KUNENA_SEARCH_FIND_POSTS', 'Zoek berichten van');
DEFINE('_KUNENA_SEARCH_DATE_ANY', 'elke datum');
DEFINE('_KUNENA_SEARCH_DATE_LASTVISIT', 'Laatste bezoek');
DEFINE('_KUNENA_SEARCH_DATE_YESTERDAY', 'Gisteren');
DEFINE('_KUNENA_SEARCH_DATE_WEEK', 'Een week geleden');
...
DEFINE('_KUNENA_SEARCH_SORTBY', 'Sorteer resultaten op');
DEFINE('_KUNENA_SEARCH_SORTBY_TITLE', 'Titel');
DEFINE('_KUNENA_SEARCH_SORTBY_POSTS', 'Aantal berichten');
DEFINE('_KUNENA_SEARCH_SORTBY_VIEWS', 'Aantal keren bekeken');
DEFINE('_KUNENA_SEARCH_SORTBY_START', 'Startdatum onderwerp');
DEFINE('_KUNENA_SEARCH_SORTBY_POST', 'datum posten');
DEFINE('_KUNENA_SEARCH_SORTBY_USER', 'Gebruikersnaam');
DEFINE('_KUNENA_SEARCH_SORTBY_FORUM', 'Forum');
DEFINE('_KUNENA_SEARCH_SORTBY_INC', 'Vergroot volgorde');
DEFINE('_KUNENA_SEARCH_SORTBY_DEC', 'Verklein volgorde');
DEFINE('_KUNENA_SEARCH_START', 'Ga naar resultaatnummer');
DEFINE('_KUNENA_SEARCH_LIMIT5', 'Toon 5 zoekresultaten');
DEFINE('_KUNENA_SEARCH_LIMIT10', 'Toon 10 zoekresultaten');
DEFINE('_KUNENA_SEARCH_LIMIT15', 'Toon 15 zoekresultaten');
DEFINE('_KUNENA_SEARCH_LIMIT20', 'Toon 20 zoekresultaten');
DEFINE('_KUNENA_SEARCH_SEARCHIN', 'Zoeken in categorieën');
DEFINE('_KUNENA_SEARCH_SEARCHIN_ALLCATS', 'Alle categorieën');
DEFINE('_KUNENA_SEARCH_SEARCHIN_CHILDREN', 'Zoek ook in subforums');
DEFINE('_KUNENA_SEARCH_SEND', 'zoek');
DEFINE('_KUNENA_SEARCH_CANCEL', 'Annuleren');
DEFINE('_KUNENA_SEARCH_ERR_NOPOSTS', 'Er zijn berichten gevonden die alle zoektermen bevatten.');
...
DEFINE('_KUNENA_SAMPLE_MAIN_CATEGORY_TITLE', 'Hoofdforum');
DEFINE('_KUNENA_SAMPLE_MAIN_CATEGORY_DESC', 'Dit is de hoofdforum categorie. Als een hoofdniveau categorie biedt het een container voor individuele boards of fora. Het wordt ook aangemerkt als een niveau 1 categorie en is een vereiste om elk Kunena fora instelling.');
DEFINE('_KUNENA_SAMPLE_MAIN_CATEGORY_HEADER', 'Om extra informatie aan uw gasten en leden te kunnen bieden, kan de forum header gebruikt worden op een tekst weer te geven bovenaan een bepaalde categorie.');
DEFINE('_KUNENA_SAMPLE_FORUM1_TITLE', 'Welkom');
DEFINE('_KUNENA_SAMPLE_FORUM1_DESC', 'We moedigen nieuwe leden aan om een korte introductie over zichzelf te posten in deze forum categorie. Leer elkaar kennen en deel uw interesses.');
DEFINE('_KUNENA_SAMPLE_FORUM1_HEADER', 'Welkom op het Kunena forum! Vertel onze leden wie u bent, waar u van houdt en waarom u lid bent geworden van deze site.We heten alle nieuwe leden van harte welkom en hopen u regelmatig weer te zien!');
DEFINE('_KUNENA_SAMPLE_FORUM2_TITLE', 'Ideeënbus');
DEFINE('_KUNENA_SAMPLE_FORUM2_DESC', 'Hebt u feedback of ideeën die u wilt delen? Aarzel niet en laat het ons weten. We horen het graag van u en streven er naar onze site beter en gebruikersvriendelijker te maken voor onze gasten en leden.');
DEFINE('_KUNENA_SAMPLE_FORUM2_HEADER', 'Dit is de optionele forumheader voor de ideeënbus.<br>');
DEFINE('_KUNENA_SAMPLE_POST1_SUBJECT', 'Welkom bij Kunena!');
DEFINE('_KUNENA_SAMPLE_POST1_TEXT', 'Welkom bij Kunena!

Dankuwel voor het kiezen voor Kunena als forum voor uw community in Joomla.

Kunena, vertaald uit het Swahili betekent "spreken", is gebouwd door een team van open source professionals met als doel het bieden van een forum oplossing van topkwaliteit voor Joomla. Kunena ondersteund tevens sociale netwerkcomponenten zoals Community Builder en JomSocial.


[size=4][b]Extra Kunena bronnen[/b][/size]

[b]Kunena Documentatie:[/b] [url]http://www.kunena.com/docs[/url
]
...
[b]Voeg uw ideeën voor mogelijkheden toe:[/b] [url]http://www.kunena.com/uservoice[/url
]

[url]http://www.kunena.com/twitter[/url]');
...
DEFINE('_COM_A_FBDEFAULT_PAGE_CATEGORIES', 'Categori&euml;n');
...
DEFINE('_KUNENA_SYNC', 'Synchronizeer');
...
DEFINE('_KUNENA_A_MAIL_ADMIN_DESC',
    'Zet op &quot;Ja&quot; indien u e-mail notificaties wilt ontvangen van iedere nieuwe post verzonden door de systeem administrator(s).');
DEFINE('_KUNENA_RANKS_EDIT', 'Wijzig Rang');
DEFINE('_KUNENA_USER_HIDEEMAIL', 'Verberg E-mail');
...
DEFINE('_KUNENA_AVATAR_GD2IMAGE_NOT','GD2 Library niet gevonden');
...
DEFINE('_KUNENA_MAILFULL','Voeg het volledige bericht toe bij e-mails verstuurd naar geabonneerden.');
...
DEFINE('_USER_SHOWEMAIL', 'Toon e-mail');
...
DEFINE('_KUNENA_MYPROFILE_MSN_DESC', 'Je MSN messenger e-mailadres.');
...
//
DEFINE('_KUNENA_FORUM_TOP','Board Categorien ');
...
DEFINE('_RECENT_CATEGORIES','categorie&euml;n');
...
DEFINE('_STAT_TOTAL_CATEGORIES','Totaal aantal categorie&euml;n');
...
DEFINE('_CODE','CODE');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_RIGHT','centreer rechts');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_CENTER','centreer centraal');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_LEFT','Links centreren');
...
DEFINE('_COM_A_SUBSCRIPTIONS_DESC','Zet op &quot;Ja&quot; om geregistreerde gebruikers toe te staan zich te abonneren op onderwerpen zodat ze op de hoogte gebracht worden van nieuwe reacties (per e-mail).');
...
$_COM_A_NOTIFICATION3="Beantwoord deze e-mail niet, dit is een automatisch gegenereerd bericht.";
...
DEFINE('_LISTCAT_NO_CATS','Er zijn nog geen categorie&euml;n gedefinieerd in dit forum.');
...
DEFINE('_VIEW_SUBSCRIBETXT','Abonneer op dit onderwerp om een e-mail te ontvangen als er een nieuw bericht is geplaatst');
...
DEFINE('_COM_A_EMAIL','Forum E-mail adres');
...
DEFINE('_COM_A_WRAP_DESC','Geef het max. aantal letters van een woord. Met deze optie kunt u de uitvoer van berichten aanpassen aan uw template.<br/> 70 karakters is het maximum voor vaste breedte van templates maar u moet hier wellicht even mee experimenteren.<br/>URLs, ongeacht hoe lang, worden niet be&iuml;nvloed door de wordwrap');
...
DEFINE('_KUNENA_POLL_ADD', 'Voeg een Nieuwe poll toe');
DEFINE('_KUNENA_POLL_TITLE', 'Poll titel');
DEFINE('_KUNENA_POLL_ADD_OPTION', 'Nieuwe Optie toevoegen');
DEFINE('_KUNENA_POLL_REM_OPTION', 'Verwijder een optie');
DEFINE('_KUNENA_POLL_OPTION_NAME', 'Opties');
DEFINE('_KUNENA_POLL_BUTTON_VOTE', 'Stem');
DEFINE('_KUNENA_POLL_BUTTON_RESULT', 'Stemmen weergeven');
DEFINE('_KUNENA_POLL_NO_VOTE', 'Geen stem');
DEFINE('_KUNENA_POLL_VOTERS_TOTAL', 'aantal stemmen: ');
DEFINE('_KUNENA_POLL_HITS_OPTIONS', 'Aantal stemmers voor deze optie:');
DEFINE('_KUNENA_A_HACK_POLL_TITLE', 'Hack poll');
DEFINE('_KUNENA_A_HACK_GUEST_TITLE', 'Hack Gasten');
DEFINE('_KUNENA_A_POLL_NUMBER_OPTIONS', 'Aantal opties:');
DEFINE('_KUNENA_A_POLL_NUMBER_OPTIONS_DESC', 'Maximale aantal opties:');
DEFINE('_KUNENA_POLL_SAVE_ALERT_OK', 'Je stem is opgeslagen');
DEFINE('_KUNENA_POLL_SAVE_ALERT_ERROR', 'Stem niet opgeslagen. Probeer het opnieuw');
DEFINE('_KUNENA_POLL_SAVE_VOTE_ALREADY', 'Je hebt al een stem gegeven !!');
DEFINE('_KUNENA_A_POLL_ALLOW_ONE_VOTE', 'Sta meer stemmen toe voor gebruikers');
DEFINE('_KUNENA_A_POLL_ALLOW_ONE_VOTE_DESC', 'sta gebruikers toe om meer dan 1 stem te geven');
DEFINE('_KUNENA_POLL_NUMBER_OPTIONS_MAX_NOW', 'maximale aantal bereikt');
DEFINE('_KUNENA_POLL_SAVE_ALERT_ERROR_NOT_CHECK', 'Je moet een optie aanvinken voor een stem te geven!!');

// Time Format
DEFINE('_KUNENA_BBCODE_HIDEIMG', 'Deze afbeelding is alleen beschikbaar voor gebruikers. Log-in of Registreer je.');
DEFINE('_KUNENA_BBCODE_HIDEFILE', 'Deze bijlage is alleen beschikbaar voor gebruikers. Log-in of Registreer je.');
DEFINE('_STAT_NUMBER_BIRTHDAY_TODAY', 'Aantal Jarig vandaag');
DEFINE('_STAT_NULL_BIRTHDAY_TODAY', '0');
DEFINE('JONI_PLUGINS', ' plugin');
DEFINE('_STAT_NAME_TODAY_USERS', 'Wie is er jarig vandaag');
DEFINE('_STAT_NULL_USER_BIRTHDAY', 'Vandaag is er niemand jarig');
DEFINE('_KUNENA_CREDITS_INTRO', 'Een open source project zoals Kunena vereist de inzet en veel vrije tijd van de schrijvers van Kunena en van de vele contribuanten. 
                           Deze versie van Kunena Forum is mogelijk gemaakt door de volgende contribuanten (in alfabetische volgorde):');
						  
DEFINE('_KUNENA_CREDITS_MORE', 'Speciale dank gaat uit naar Beat en de CB Test team, Ida en JoniJnm voor belangrijke bijdragen aan Kunena. Naast vele leden van Kunena.com hebben bijgedragen en geholpen om deze een meer stabiel en bugvrije versie. 
                           Onze dank gaat uit naar alle respondenten van Kunena! Groeten van het Kunena forum team!');

DEFINE('_KUNENA_CREDITS_RETURN', 'Om terug naar het forum te gaan');
DEFINE('_KUNENA_CREDITS_TEAM', 'Team credits');
