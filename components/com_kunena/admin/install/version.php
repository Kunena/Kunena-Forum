...
class KunenaVersion
{
	 ...
	 *
	 * @return string "© 2008 - 2015 Copyright: Kunena Team. All rights reserved. | License: GNU General Public License"
	 */
	static function getCopyrightHTML()
	{
		return ': &copy; 2008 - 2015 ' . JText::_('COM_KUNENA_VERSION_COPYRIGHT') . ': <a href = "http://www.kunena.org" target = "_blank">'
	 ...
	 *
	 * @return string "Kunena X.Y.Z | YYYY-MM-DD | © 2008 - 2015 Copyright: Kunena Team. All rights reserved. | License: GNU General Public License"
	 */
