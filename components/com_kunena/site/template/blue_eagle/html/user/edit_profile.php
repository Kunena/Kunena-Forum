		...
		<div class="kbody">
			<table
				...
				<tr class="krow2">
					...
					<td class="kcol-mid"><input type="text"
							maxlength="<?php echo intval($this->config->maxpersotext) ?>"
							name="personaltext"
							value="<?php echo $this->escape($this->profile->personalText); ?>" />
					</td>
				</tr>
				<tr class="krow1">
				...
				<span class="editlinktip hasTip"
					title="<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE_DESC'); ?>">
					<input type="text" size="4" maxlength="4" name="birthdate1"
						value="<?php echo $this->escape($bithdate[0]); ?>" />
					<input type="text" size="2" maxlength="2" name="birthdate2"
						value="<?php echo $this->escape($bithdate[1]); ?>" />
					<input type="text" size="2" maxlength="2" name="birthdate3"
						value="<?php echo $this->escape($bithdate[2]); ?>" />
				</span>
					</td>
				</tr>
				<tr class="krow2">
					<td class="kcol-first"><?php echo JText::_('COM_KUNENA_MYPROFILE_LOCATION'); ?></td>
					<td class="kcol-mid"><input type="text" name="location"
							value="<?php echo $this->escape($this->profile->location); ?>" /></td>
				</tr>
				<tr class="krow1">
				...
				<tr class="krow2">
					...
					<td class="kcol-mid">
				<span class="editlinktip hasTip"
					title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME_DESC'); ?>">
				...
				<tr class="krow1">
					...
					<td class="kcol-mid">
				<span class="editlinktip hasTip"
					title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL_DESC'); ?>">
				...
				foreach ($this->social as $social) : ?>
					<tr class="krow<?php echo (++$i & 1) + 1; ?>">
						...
						<td class="kcol-mid">
				<span class="editlinktip hasTip"
					title="<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}"); ?>::<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}_DESC"); ?>">
				...
				<tr class="krow<?php echo (++$i & 1) + 1; ?>">
					...
					<td class="kcol-mid">
				<span class="editlinktip hasTip"
					title="<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE_DESC'); ?>">
					<textarea class="ktxtarea" maxlength="<?php echo intval($this->config->maxsig) ?>" name="signature"
						id="kbbcode-message" rows="10"
