...
class KunenaTemplateCrypsis extends KunenaTemplate
{
	...
	public function initialize()
	{
		...
		if ($fontawesome)
		{
			$this->addScript('https://use.fontawesome.com/releases/v5.4.2/js/all.js', array(), array('defer' => true));
			$this->addScript('https://use.fontawesome.com/releases/v5.4.2/js/v4-shims.js', array(), array('defer' => true));
		}
