...
class KunenaModelSearch extends KunenaModel
{
	...
	/**
	 * Method to build the where for the search query
	 *
	 * @return string
	 */
	...
	/**
	 * Method to build the order by for the search query
	 *
	 * @return string
	 */
	 ...
	 *
	 * @param   string  $view        The view type to create URL
	 * @param   string  $searchword  The searchword to create URL
	 * @param   int     $limitstart  Limistart allow to get the correct page
	 * @param   int     $limit       Limit allow to get the correct page
	 * @param   string  $params      Add some parameters to URL
