...
<table class="kblocktable<?php echo isset ( $msg_cat->class_sfx ) ? ' kblocktable' . $this->escape($msg_cat->class_sfx) : ''?>" id="kpostmessage">
	...
	<tbody id="kpost-message">
		...
		<tr class="ksectiontableentry<?php echo 1 + $this->k^=1;?>">
			...
			<td>
				<div id="kattachment">
					<div class="editlinktip hasTip"
						title="<?php echo $this->escape(JText::_('COM_KUNENA_FILE_EXTENSIONS_ALLOWED') . ':: <b>' . $this->config->imagetypes . '</b><br /><b>' . $this->config->filetypes . '</b>'); ?>" >
						<span id="attach_list"></span>
						<input id="kupload" name="kattachment" type="file" />
						<a href="#" style="display: none"><?php echo  JText::_('COM_KUNENA_GEN_DELETE'); ?></a>
					</div>
				</div>
