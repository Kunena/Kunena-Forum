...
<?php
switch ($kunena_config->avposition) {
	case 'left' :
		?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tbody>
		...
		if (! isset ( $msg_html->closed )) {
			...
			// Finish captcha
			?> <input type="submit"
						class="fb_button fb_qr_fire" name="submit"
						value="<?php
			@print (_GEN_CONTINUE) ;
			?>" /> <input
						type="button" class="fb_button fb_qm_cncl_btn"
						id="cancel__<?php
			echo $msg_html->id;
			?>" name="cancel"
						value="<?php
		...
		<tr>
			<td class="fb-msgview-left-b-l">&nbsp;</td>
			<td class="fb-msgview-right-b-l">
