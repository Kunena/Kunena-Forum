...
<div id="kunena_search_results" class="row">
	...
	<div class="col-md-10">
		...
		<div class="badger-left badger-info khistory" data-badger="<?php echo (!$isReply) ? $name . ' created the topic: ' : $name . ' replied the topic: '; ?><?php echo $message->displayField('subject'); ?>">
			<h3>
