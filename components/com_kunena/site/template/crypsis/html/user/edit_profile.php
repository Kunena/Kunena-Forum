...
<div>
  <h3><span><?php echo JText::_('COM_KUNENA_PROFILE_EDIT_PROFILE_TITLE'); ?></span></h3>
</div>
<div>
  <div>
    <table class="<?php
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_PERSONALTEXT'); ?></td>
          <td>
        ...
        <tr>
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE'); ?></td>
          <?php $bithdate = explode('-',$this->profile->birthdate); ?>
          <td> <span class="hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_BIRTHDATE_DESC'); ?>" >
        ...
        <tr>
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_LOCATION'); ?></td>
          <td>
            <input type="text" name="location" value="<?php echo $this->escape($this->profile->location); ?>" />
          </td>
        </tr>
        <tr>
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_GENDER'); ?></td>
          <td>
            <?php
        ...
        <tr>
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME'); ?></td>
          <td> <span class="hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_NAME_DESC'); ?>" >
            <input type="text" name="websitename" value="<?php echo $this->escape($this->profile->websitename); ?>" />
            </span> </td>
        </tr>
        <tr>
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL'); ?></td>
          <td> <span class="hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_WEBSITE_URL_DESC'); ?>" >
        ...
        <tr class="krow<?php echo (++$i & 1)+1;?>">
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_'.$social); ?></td>
          <td> <span class="hasTip" title="<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}"); ?>::<?php echo JText::_("COM_KUNENA_MYPROFILE_{$social}_DESC"); ?>" >
            <input type="text" name="<?php echo $social ?>" value="<?php echo $this->escape($this->profile->$social); ?>" />
            </span> </td>
        </tr>
        <?php endforeach ?>
        <tr class="krow<?php echo (++$i & 1)+1;?>">
          <td><?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE'); ?></td>
          <?php // TODO: Add some bbcode functions ?>
          <td> <span class="hasTip" title="<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE'); ?>::<?php echo JText::_('COM_KUNENA_MYPROFILE_SIGNATURE_DESC'); ?>" >
