...
<tr class="k<?php echo $tabclass [$k ^= 1] ?>">
	...
	<td class="kcol-mid kcol-ktopicviews">
		<!-- Views -->
		<span
			class="ktopic-views-number"><?php echo $this->formatLargeNumber(( int ) $this->category->numTopics); ?></span>
	...
	<td class="kcol-mid kmycount">
		<!-- Posts -->
		<span
			class="ktopic-views-number"><?php echo $this->formatLargeNumber(( int ) $this->category->numPosts); ?></span>
	...
	{ ?>
		<td class="kcol-mid kcol-kcatlastpost">
			<?php if ($this->config->avataroncat > 0) : ?>
				...
				if ($useravatar) : ?>
					<span
						class="klatest-avatar"> <?php echo $last->getLastPostAuthor()->getLink($useravatar, null, 'nofollow', '', null, $this->category->id); ?></span>
				<?php endif; ?>
				<!-- /Avatar -->
			<?php endif; ?>
