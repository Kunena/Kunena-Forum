bbcodeSettings = {
	...
	markupSet: [{
		...
		openWith: '[b]',
		closeWith: '[/b]'
	}, {className: 'italicbutton', name: 'Italic', key: 'I', openWith: '[i]', closeWith: '[/i]'}, {
		className: 'underlinebutton',
		name: 'Underline',
		key: 'U',
		openWith: '[u]',
		closeWith: '[/u]'
	}, {className: 'strokebutton', name: 'Stroke', key: 'T', openWith: '[strike]', closeWith: '[/strike]'}, {
		className: 'subscriptbutton',
		name: 'Subscript',
		key: 'T',
		openWith: '[sub]',
		closeWith: '[/sub]'
	}, {className: 'supscriptbutton', name: 'Supscript', key: 'T', openWith: '[sup]', closeWith: '[/sup]'}, {
		className: 'sizebutton', name: 'Size', key: 'S', openWith: '[size=[![Text size]!]]', closeWith: '[/size]', dropMenu: [
		...
		openWith: '[ol]\n  [li]',
		closeWith: '[/li]\n  [li][/li]\n[/ol]'
	}, {className: 'listitembutton', name: 'Li', openWith: '\n  [li]', closeWith: '[/li]'}, {
		className: 'hrbutton',
		name: 'HR',
		openWith: '[hr]'
	}, {className: 'alignleftbutton', name: 'Left', openWith: '[left]', closeWith: '[/left]'}, {
		className: 'centerbutton',
		name: 'Center',
		openWith: '[center]',
		closeWith: '[/center]'
	}, {className: 'alignrightbutton', name: 'Right', openWith: '[right]', closeWith: '[/right]'}, {separator: '|'}, {
