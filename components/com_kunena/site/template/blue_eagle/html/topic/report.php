	...
	<div class="kcontainer">
		<div class="kbody">
			<div id="kreport-container">
				<form method="post" action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>"
				      class="kform-report">
					...
					<input class="kbutton ks" type="submit" name="Submit"
					       value="<?php echo JText::_('COM_KUNENA_REPORT_SEND') ?>"/>
					<input class="kbutton ks" onclick="history.back()" type="button" name="button"
