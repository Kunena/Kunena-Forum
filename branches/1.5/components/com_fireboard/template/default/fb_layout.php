 ...
 *             The menu :-)
 */
function jb_get_menu($cbitemid, $fbConfig, $fbIcons, $my_id, $type, $view = "", $catid = 0, $id = 0, $thread = 0, $is_moderator = 
false, $numPending = 0)
{
include_once (FB_FABSPATH_ADMINSRC  . "/fb_link.class.php");
    ...
    switch ($type)
    {
        case 3:
            /* DISABLE MENU
            $header.= '<a href="'.JRoute::_(JB_LIVEURLREL.'&amp;func=post&amp;do=reply&amp;replyto='.$thread.'&amp;catid='.$catid).'" >';
...
{
    $return = '<div id="fb_searchbox"><form action="' . JRoute::_( JB_LIVEURLREL . '&amp;func=search') . '" name="searchFB" method="post">';
