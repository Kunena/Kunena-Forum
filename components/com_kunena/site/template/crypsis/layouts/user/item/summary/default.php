				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<div class="span3 pull-right">
							...
							<?php endif; ?>
							<?php if ($email) : ?>
								<a class="btn btn-small" href="mailto:<?php echo $profile->email; ?>"><i
										class="icon-mail"></i></a>
							<?php endif; ?>
							<?php if (!empty($websiteName) && $websiteURL != 'http://') : ?>
								<a class="btn btn-small" href="<?php echo $websiteURL ?>"><i
										class="icon-bookmark"></i> <?php echo $websiteName ?></a>
							<?php elseif (empty($websiteName) && $websiteURL != 'http://'): ?>
								<a class="btn btn-small" href="<?php echo $websiteURL ?>"><i
										class="icon-bookmark"></i> <?php echo $websiteURL ?></a>
							<?php elseif (!empty($websiteName) && $websiteURL == 'http://'): ?>
								<button class="btn btn-small"><i class="icon-bookmark"></i> <?php echo $websiteName ?>
								</button>
							<?php endif; ?>
						</div>
					</div>
