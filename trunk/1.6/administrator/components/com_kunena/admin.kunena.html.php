...
<div id="fbadmin"><!-- Header -->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="170" valign="top"><!-- Begin: AdminLeft -->
		...
		if ($stask == 'showconfig') {
			...
			echo _COM_A_FRONTEND;
			?></a> <a class="fbsubmenu" href="#security"><?php
			echo _COM_A_SECURITY;
		...
		echo _KUNENA_EMOTICONS_EDIT_SMILIES;
		?></a> <a class="fbmainmenu"
			href="index.php?option=com_kunena&task=ranks"><?php
		echo _KUNENA_RANKS_MANAGE;
		?></a> <a class="fbmainmenu"
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	...
	<tr>
		...
		<th><small><?php
		echo _KUNENA_PUBLICACCESS;
		?></small></th>

		<th><small><?php
		echo _KUNENA_ADMINACCESS;
		?></small></th>

		<th><small><?php
		echo _KUNENA_CHECKEDOUT;
		?></small></th>

		<th colspan="2"><small><?php
		echo _KUNENA_REORDER;
		?></small></th>
	</tr>
...
<div class="fbfunctitle"><?php
		echo $row->id ? _KUNENA_EDIT : _KUNENA_ADD;
		?>
<?php
...
<table cellpadding="4" cellspacing="0" border="0" width="100%">
	...
	<tr>
		...
		<br />
		<?php
		echo _KUNENA_PARENTDESC;
		?></td>
	</tr>

	<tr>
		<td width="200"><?php
		echo _KUNENA_NAMEADD;
		?></td>
	...
	<tr>
		<td valign="top"><?php
		echo _KUNENA_DESCRIPTIONADD;
		?></td>

		<td><textarea class="inputbox" cols="50" rows="3" name="description"
			id="description" style="width: 500px"><?php
	...
	<tr>
		<td valign="top"><?php
		echo _KUNENA_HEADERADD;
		?></td>

		<td><textarea class="inputbox" cols="50" rows="3" name="headerdesc"
			id="headerdesc" style="width: 500px"><?php
		echo stripslashes ( $row->headerdesc );
		?></textarea></td>
	</tr>
</table>
</fieldset>
<div class="fbfuncsubtitle"><?php
		echo _KUNENA_ADVANCEDDESC;
		?></div>
<fieldset><legend> <?php
		echo _KUNENA_ADVANCEDDESCINFO;
		?></legend>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%">
	...
	<tr>
		<td><?php
		echo _KUNENA_LOCKED1;
		?></td>

		<td><?php
		echo $lists ['forumLocked'];
		?></td>

		<td><?php
		echo _KUNENA_LOCKEDDESC;
		?></td>
	</tr>
	...
	<tr>
		...
		<td valign="top"><?php
		echo $accessLists ['pub_access'];
		?></td>

		<td><?php
		echo _KUNENA_PUBACCDESC;
		?></td>
	</tr>

	<tr>
		<td nowrap="nowrap" valign="top"><?php
		echo _KUNENA_CGROUPS;
		?></td>

		<td valign="top"><?php
		echo $lists ['pub_recurse'];
		?></td>

		<td valign="top"><?php
		echo _KUNENA_CGROUPSDESC;
		?></td>
	</tr>

	<tr>
		<td valign="top"><?php
		echo _KUNENA_ADMINLEVEL;
		?></td>

		<td valign="top"><?php
		echo $accessLists ['admin_access'];
		?></td>

		<td valign="top"><?php
		echo _KUNENA_ADMINLEVELDESC;
		?></td>
	</tr>

	<tr>
		<td nowrap="nowrap" valign="top"><?php
		echo _KUNENA_CGROUPS1;
		?>
		</td>

		<td valign="top"><?php
		echo $lists ['admin_recurse'];
		?></td>

		<td valign="top"><?php
		echo _KUNENA_CGROUPS1DESC;
		?></td>
	</tr>
...
<div class="fbfuncsubtitle"><?php
		echo _KUNENA_MODNEWDESC;
		?></div>
<fieldset><legend> <?php
		echo _KUNENA_MODHEADER;
		?></legend>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%">
	...
	<tr>
		...
		<td valign="top"><?php
		echo $lists ['forumModerated'];
		?></td>

		<td valign="top"><?php
		echo _KUNENA_MODDESC;
		?></td>
	</tr>
</table>
...
<div class="fbfunctitle"><?php
		echo _COM_A_CONFIG?></div>
<form action="index.php" method="post" name="adminForm">
<div class="fbfuncsubtitle"><?php
		echo _COM_A_BASICS?><a name="basics" id="basics"> </a></div>

<fieldset><legend> <?php
		echo _COM_A_BASIC_SETTINGS?></legend>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	...
	<tr align="center" valign="middle">
		...
		echo _COM_A_BOARD_TITLE?>
		</td>

		<td align="left" valign="top" width="25%"><input type="text"
			name="cfg_board_title"
			value="<?php
		echo stripslashes ( $kunena_config->board_title );
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_BOARD_TITLE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_EMAIL?></td>

		<td align="left" valign="top"><input type="text" name="cfg_email"
			value="<?php
		echo $kunena_config->email;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_EMAIL_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_BOARD_OFFLINE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['board_offline'];
		?>
		</td>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_KUNENA_SESSION_TIMEOUT?>
		</td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_KUNENA_SESSION_TIMEOUT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_BOARD_OFFLINE_MES?>
		</td>

		<td align="left" valign="top" colspan="2"><textarea
			name="cfg_offline_message" rows="3" cols="50"><?php
	...
	<tr align="center" valign="middle">
		...
		?>/images/M_images/livemarks.png"
			alt="" /> <?php
		echo _COM_A_RSS_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_RSS_TYPE?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_RSS_TYPE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_RSS_HISTORY?></td>
	...
	<tr align="center" valign="middle">
		...
		?>/images/M_images/pdf_button.png"
			alt="" /> <?php
		echo _COM_A_PDF_DESC?></td>
	</tr>
</table>
</fieldset>

<fieldset><legend> <?php
		echo _KUNENA_SEO_SETTINGS?></legend>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top"><?php
		echo _KUNENA_SEF_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_SEF_CATS?>
		</td>
		...
		<td align="left" valign="top"><?php
		echo _KUNENA_SEF_CATS_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_SEF_UTF8?>
		</td>
...
<div class="fbfuncsubtitle"><?php
		echo _COM_A_FRONTEND?> <a name="frontend" id="frontend"> </a></div>

<fieldset><legend> <?php
		echo _COM_A_LOOKS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top" width="25%"><input type="text"
			...
			value="<?php
		echo $kunena_config->threads_per_page;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_THREADS_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_MESSAGES?></td>

		<td align="left" valign="top"><input type="text"
			name="cfg_messages_per_page"
			value="<?php
		echo $kunena_config->messages_per_page;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_MESSAGES_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_MESSAGES_SEARCH?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_messages_per_page_search"
			value="<?php
		echo $kunena_config->messages_per_page_search;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_MESSAGES_DESC_SEARCH?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_HISTORY?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_HISTORY_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_HISTLIM?></td>

		<td align="left" valign="top"><input type="text"
			name="cfg_historylimit"
			value="<?php
		echo $kunena_config->historylimit;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_HISTLIM_DESC?></td>
	</tr>
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top"><?php
		echo _COM_A_SHOWNEW_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_NEWCHAR?></td>

		<td align="left" valign="top"><input type="text" name="cfg_newchar"
			value="<?php
		echo stripslashes ( $kunena_config->newchar );
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_NEWCHAR_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_MAMBOT_SUPPORT?>
		</td>
		...
		<td align="left" valign="top"><?php
		echo _KUNENA_MAMBOT_SUPPORT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_DISEMOTICONS?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_DISEMOTICONS_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_TEMPLATE?></td>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_FBDEFAULT_PAGE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['fbdefaultpage'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_FBDEFAULT_PAGE_DESC?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top"><?php
		echo $lists ['showannouncement'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_ANNOUNCEMENT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_AVATAR_ON_CAT?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['avataroncat'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_AVATAR_ON_CAT_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_CATIMAGEPATH?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_catimagepath"
			value="<?php
		echo $kunena_config->catimagepath;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_CATIMAGEPATH_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top"><?php
		echo $lists ['showchildcaticon'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_CHILD_CATEGORY_ON_LIST_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ANN_MODID?></td>

		<td align="left" valign="top"><input type="text" name="cfg_annmodid"
			value="<?php
		echo $kunena_config->annmodid;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ANN_MODID_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_TAWIDTH?></td>

		<td align="left" valign="top"><input type="text" name="cfg_rtewidth"
			value="<?php
		echo $kunena_config->rtewidth;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_TAWIDTH_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_TAHEIGHT?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_TAHEIGHT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE?></td>
		...
		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE_IN_FB?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['rules_infb'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE_IN_KUNENA_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE_CID?>
		</td>

		<td align="left" valign="top"><input type="text" name="cfg_rules_cid"
			value="<?php
		echo $kunena_config->rules_cid;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE_CID_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE_LINK?>
		</td>

		<td align="left" valign="top"><input type="text" name="cfg_rules_link"
			value="<?php
		echo $kunena_config->rules_link;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_RULESPAGE_LINK_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE?></td>
		...
		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE_IN_FB?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['help_infb'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE_IN_KUNENA_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE_CID?>
		</td>

		<td align="left" valign="top"><input type="text" name="cfg_help_cid"
			value="<?php
		echo $kunena_config->help_cid;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE_CID_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE_LINK?>
		</td>

		<td align="left" valign="top"><input type="text" name="cfg_help_link"
			value="<?php
		echo $kunena_config->help_link;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_HELPPAGE_LINK_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_FORUM_JUMP?></td>
...
<fieldset><legend> <?php
		echo _COM_A_USERS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_USERNAME?>
		</td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_USERNAME_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_ASK_EMAIL?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_ASK_EMAIL_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_SHOWMAIL?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_SHOWMAIL_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_USERSTATS?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_USERSTATS_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_POSTSTATSBAR?></td>

		<td align="left" valign="top"><?php
		echo $lists ['poststats'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_POSTSTATSBAR_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_POSTSTATSCOLOR?>
		</td>

		<td align="left" valign="top"><input type="text" name="cfg_statscolor"
			value="<?php
		echo $kunena_config->statscolor;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_POSTSTATSCOLOR_DESC?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		...
		<table width=100%>
			<tr>
				<td>1: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col1m.png"
					width="15" height="4" alt=""></td>
				<td>2: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col2m.png"
					width="15" height="4" alt=""></td>
				<td>3: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col3m.png"
					width="15" height="4" alt=""></td>
				<td>4: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col4m.png"
					width="15" height="4" alt=""></td>
				<td>5: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col5m.png"
					width="15" height="4" alt=""></td>
				<td>6: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col6m.png"
					width="15" height="4" alt=""></td>
			</tr>
		...
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col7m.png"
					width="15" height="4" alt=""></td>
				<td>8: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col8m.png"
					width="15" height="4" alt=""></td>
				<td>9: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col9m.png"
					width="15" height="4" alt=""></td>
				<td>10: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col10m.png"
					width="15" height="4" alt=""></td>
				<td>11: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col11m.png"
					width="15" height="4" alt=""></td>
				<td>12: <img
					src="<?php
		echo JURI::root ();
		?>/components/com_kunena/template/<?php
		echo $kunena_config->template;
		?>/images/english/graph/col12m.png"
					width="15" height="4" alt=""></td>
			</tr>
		</table>
		</td>
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top"><?php
		echo _COM_A_KARMA_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_USER_EDIT?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_USER_EDIT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_USER_EDIT_TIME?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_useredittime"
			value="<?php
		echo $kunena_config->useredittime;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_USER_EDIT_TIME_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_USER_EDIT_TIMEGRACE?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_useredittimegrace"
			value="<?php
		echo $kunena_config->useredittimegrace;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_USER_EDIT_TIMEGRACE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_USER_MARKUP?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_USER_MARKUP_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_SUBSCRIPTIONS?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['allowsubscriptions'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_SUBSCRIPTIONS_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SUBSCRIPTIONSCHECKED?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['subscriptionschecked'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SUBSCRIPTIONSCHECKED_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_FAVORITES?></td>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top"><?php
		echo _COM_A_SUBJECTLENGTH_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_SIGNATURE?></td>
...
<div class="fbfuncsubtitle"><?php
		echo _COM_A_SECURITY?> <a name="security" id="security"> </a></div>
<fieldset><legend> <?php
		echo _COM_A_SECURITY_SETTINGS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_REGISTERED_ONLY?>
		</td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_REG_ONLY_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_CHANGENAME?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_CHANGENAME_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_PUBWRITE?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_PUBWRITE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_FLOOD?></td>

		<td align="left" valign="top"><input type="text"
			name="cfg_floodprotection"
			value="<?php
		echo $kunena_config->floodprotection;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_FLOOD_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_MODERATION?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_MODERATION_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_A_MAIL_ADMIN?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['mailadmin'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_A_MAIL_ADMIN_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_CAPTCHA_ON?></td>
		...
		<td align="left" valign="top"><?php
		echo _KUNENA_CAPTCHA_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_MAILFULL;
		?></td>
		<td align="left" valign="top"><?php
		echo $lists ['mailfull'];
		?></td>
		<td align="left" valign="top"><?php
		echo _KUNENA_MAILFULL_DESC;
		?>
		</td>
	</tr>
</table>
...
<div class="fbfuncsubtitle"><?php
		echo _COM_A_AVATARS?><a name="avatars" id="avatars"> </a></div>
<fieldset><legend> <?php
		echo _COM_A_AVATAR_SETTINGS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top" width="25%"><?php
		echo $lists ['allowavatar'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_AVATAR_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_AVATARUPLOAD?></td>
		...
		<td align="left" valign="top"><?php
		echo _COM_A_AVATARUPLOAD_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_AVATARGALLERY?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['allowavatargallery'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_AVATARGALLERY_DESC?>
		</td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_IMAGE_PROCESSOR?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['imageprocessor'];
		?>
		</td>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_AVATAR_SMALL_HEIGHT?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_avatarsmallheight"
			value="<?php
		echo $kunena_config->avatarsmallheight;
		?>" /></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_AVATAR_SMALL_WIDTH?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_avatarsmallwidth"
			value="<?php
		echo $kunena_config->avatarsmallwidth;
		?>" /></td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_AVATAR_MEDIUM_HEIGHT?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_avatarheight"
			value="<?php
		echo $kunena_config->avatarheight;
		?>" /></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_AVATAR_MEDIUM_WIDTH?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_avatarwidth"
			value="<?php
		echo $kunena_config->avatarwidth;
		?>" /></td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_AVATAR_LARGE_HEIGHT?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_avatarlargeheight"
			value="<?php
		echo $kunena_config->avatarlargeheight;
		?>" /></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_AVATAR_LARGE_WIDTH?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_avatarlargewidth"
			value="<?php
		echo $kunena_config->avatarlargewidth;
		?>" /></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_AVSIZE?></td>

		<td align="left" valign="top"><input type="text" name="cfg_avatarsize"
			value="<?php
		echo $kunena_config->avatarsize;
		?>" /></td>
	</tr>
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_AVATAR_QUALITY?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_avatarquality"
			value="<?php
		echo $kunena_config->avatarquality;
		?>" /> %</td>
	</tr>
</table>
</fieldset>
<div class="fbfuncsubtitle"><?php
		echo _COM_A_UPLOADS?><a name="uploads" id="uploads"> </a></div>
<fieldset><legend> <?php
		echo _COM_A_IMAGE?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_IMAGEUPLOAD?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['allowimageupload'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_IMAGEUPLOAD_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_IMAGEREGUPLOAD?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['allowimageregupload'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_IMAGEREGUPLOAD_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_SHOWIMGFORGUEST?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showimgforguest'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOWIMGFORGUEST_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_IMGHEIGHT?></td>

		<td align="left" valign="top"><input type="text"
			name="cfg_imageheight"
			value="<?php
		echo $kunena_config->imageheight;
		?>" /></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_IMGWIDTH?></td>

		<td align="left" valign="top"><input type="text" name="cfg_imagewidth"
			value="<?php
		echo $kunena_config->imagewidth;
		?>" /></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_IMGSIZE?></td>

		<td align="left" valign="top"><input type="text" name="cfg_imagesize"
			value="<?php
		echo $kunena_config->imagesize;
		?>" /></td>
	</tr>
</table>
</fieldset>
<fieldset><legend> <?php
		echo _COM_A_FILE?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_FILEUPLOAD?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['allowfileupload'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_FILEUPLOAD_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_FILEREGUPLOAD?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['allowfileregupload'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_FILEREGUPLOAD_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_SHOWFILEFORGUEST?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showfileforguest'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOWFILEFORGUEST_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_FILEALLOWEDTYPES?>
		</td>

		<td align="left" valign="top"><input type="text" name="cfg_filetypes"
			value="<?php
		echo $kunena_config->filetypes;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_FILEALLOWEDTYPES_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_FILESIZE?></td>

		<td align="left" valign="top"><input type="text" name="cfg_filesize"
			value="<?php
		echo $kunena_config->filesize;
		?>" /></td>
	</tr>
</table>
...
<div class="fbfuncsubtitle"><?php
		echo _COM_A_RANKING?><a name="ranking" id="ranking"> </a></div>

<fieldset><legend> <?php
		echo _COM_A_RANKING_SETTINGS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		...
		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showranking'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_RANKING_DESC?></td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_RANKINGIMAGES?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['rankimages'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_RANKINGIMAGES_DESC?>
		</td>
	</tr>
</table>
</fieldset>
...
<div class="fbfuncsubtitle"><?php
		echo _COM_A_BBCODE?><a name="bbcode" id="bbcode"> </a></div>

<fieldset><legend> <?php
		echo _COM_A_BBCODE_SETTINGS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_SHOWSPOILERTAG?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showspoilertag'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_SHOWSPOILERTAG_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_SHOWVIDEOTAG?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showvideotag'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_SHOWVIDEOTAG_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_SHOWEBAYTAG?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showebaytag'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_SHOWEBAYTAG_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_EBAYLANGUAGECODE?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_ebaylanguagecode"
			value="<?php
		echo $kunena_config->ebaylanguagecode;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_EBAYLANGUAGECODE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_TRIMLONGURLS?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['trimlongurls'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_TRIMLONGURLS_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_TRIMLONGURLSFRONT?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_trimlongurlsfront"
			value="<?php
		echo $kunena_config->trimlongurlsfront;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_TRIMLONGURLSFRONT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_TRIMLONGURLSBACK?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_trimlongurlsback"
			value="<?php
		echo $kunena_config->trimlongurlsback;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _COM_A_TRIMLONGURLSBACK_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_AUTOEMBEDYOUTUBE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['autoembedyoutube'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_AUTOEMBEDYOUTUBE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_AUTOEMBEDEBAY?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['autoembedebay'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_AUTOEMBEDEBAY_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _COM_A_HIGHLIGHTCODE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['highlightcode'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_HIGHLIGHTCODE_DESC?>
		</td>
	</tr>
...
<div class="fbfuncsubtitle"><?php
		echo _COM_A_INTEGRATION?><a name="integration" id="integration"> </a></div>
<fieldset><legend> <?php
		echo _COM_A_AVATAR_INTEGRATION?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _COM_A_AVATAR_SRC?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['avatar_src'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_AVATAR_SRC_DESC?>
		</td>
	</tr>
</table>
</fieldset>
<fieldset><legend> <?php
		echo _KUNENA_FORUMPRF_TITLE?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_FORUMPRF?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['fb_profile'];
		?>
		</td>


		<td align="left" valign="top"><?php
		echo _KUNENA_FORUMPRRDESC?>
		</td>
	</tr>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top" width="25%"><?php
		echo $lists ['pm_component'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_PMS_DESC?></td>
	</tr>
</table>
</fieldset>
<fieldset><legend> <?php
		echo _KUNENA_AUP_ALPHAUSERPOINTS;
		?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_AUP_ENABLED_POINTS_IN_PROFILE;
		?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['alphauserpoints'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_AUP_ENABLED_POINTS_IN_PROFILE_DESC;
		?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_AUP_ENABLED_RULES;
		?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['alphauserpointsrules']?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_AUP_ENABLED_RULES_DESC;
		?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_AUP_MINIMUM_POINTS_ON_REPLY;
		?>
		</td>
		...
		<td align="left" valign="top" width="25%"><input type="text"
			...
			value="<?php
		echo $kunena_config->alphauserpointsnumchars;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_AUP_MINIMUM_POINTS_ON_REPLY_DESC;
		?>
		</td>
	</tr>
...
<fieldset><legend> <?php
		echo _COM_A_MOSBOT_TITLE?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top" width="25%"><?php
		echo $lists ['discussbot'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _COM_A_MOSBOT_DESC?></td>
	</tr>
</table>
</fieldset>
...
<div class="fbfuncsubtitle"><?php
		echo _KUNENA_ADMIN_CONFIG_PLUGINS?><a name="plugins" id="plugins"> </a></div>
<fieldset><legend> <?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_ROWS?>
		</td>

		<td align="left" valign="top" width="25%"><input type="text"
			name="cfg_userlist_rows"
			value="<?php
		echo $kunena_config->userlist_rows;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_ROWS_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_USERONLINE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_online'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_USERONLINE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_AVATAR?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_avatar'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_USERLIST_AVATAR_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_NAME?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_name'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_name_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_USERNAME?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_username'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_USERNAME_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_POSTS?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_posts'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_POSTS_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_KARMA?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_karma'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_KARMA_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_EMAIL?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_email'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_EMAIL_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_USERTYPE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_usertype'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_USERTYPE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_JOINDATE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_joindate'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_JOINDATE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_LASTVISITDATE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_lastvisitdate'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_LASTVISITDATE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_HITS?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['userlist_userhits'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_ADMIN_CONFIG_USERLIST_HITS_DESC?>
		</td>
	</tr>
</table>
</fieldset>
<fieldset><legend> <?php
		echo _KUNENA_RECENT_POSTS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">

	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_SHOW_LATEST_MESSAGES?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showlatest'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_MESSAGES_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_NUMBER_OF_LATEST_MESSAGES?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_latestcount"
			value="<?php
		echo $kunena_config->latestcount;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_NUMBER_OF_LATEST_MESSAGES_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_COUNT_PER_PAGE_LATEST_MESSAGES?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_latestcountperpage"
			value="<?php
		echo $kunena_config->latestcountperpage;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_COUNT_PER_PAGE_LATEST_MESSAGES_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_LATEST_CATEGORY?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_latestcategory"
			value="<?php
		echo $kunena_config->latestcategory;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_LATEST_CATEGORY_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_SINGLE_SUBJECT?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['latestsinglesubject'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_SINGLE_SUBJECT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_REPLY_SUBJECT?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['latestreplysubject'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_REPLY_SUBJECT_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_LATEST_SUBJECT_LENGTH?>
		</td>

		<td align="left" valign="top"><input type="text"
			name="cfg_latestsubjectlength"
			value="<?php
		echo $kunena_config->latestsubjectlength;
		?>" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_LATEST_SUBJECT_LENGTH_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_DATE?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['latestshowdate'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_DATE_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_HITS?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['latestshowhits'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_LATEST_HITS_DESC?>
		</td>
	</tr>

	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_AUTHOR?></td>

		<td align="left" valign="top"><input type="text"
			name="cfg_latestshowauthor"
			value="<?php
		echo $kunena_config->latestshowauthor;
		?>" size="1" /></td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOW_AUTHOR_DESC?>
		</td>
	</tr>
</table>
</fieldset>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_SHOWSTATS;
		?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['showstats'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOWSTATSDESC;
		?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_SHOWWHOIS;
		?></td>

		<td align="left" valign="top"><?php
		echo $lists ['showwhoisonline'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_SHOWWHOISDESC;
		?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_STATSGENERAL;
		?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['showgenstats'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_STATSGENERALDESC;
		?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_USERSTATS;
		?></td>

		<td align="left" valign="top"><?php
		echo $lists ['showpopuserstats'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_USERSTATSDESC;
		?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_USERNUM;
		?></td>

		<td align="left" valign="top"><input type="text"
			name="cfg_popusercount"
			value="<?php
		echo $kunena_config->popusercount;
		?>" /></td>
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top"><?php
		echo _KUNENA_USERPOPULAR;
		?>
		</td>

		<td align="left" valign="top"><?php
		echo $lists ['showpopsubjectstats'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_USERPOPULARDESC;
		?>
		</td>
	</tr>
	...
	<tr align="center" valign="middle">
		...
		<td align="left" valign="top"><input type="text"
			...
			value="<?php
		echo $kunena_config->popsubjectcount;
		?>" /></td>
...
<fieldset><legend> <?php
		echo _KUNENA_MYPROFILE_PLUGIN_SETTINGS?></legend>
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="fbadminform">
	...
	<tr align="center" valign="middle">
		<td align="left" valign="top" width="25%"><?php
		echo _KUNENA_USERNAMECANCHANGE;
		?>
		</td>

		<td align="left" valign="top" width="25%"><?php
		echo $lists ['usernamechange'];
		?>
		</td>

		<td align="left" valign="top"><?php
		echo _KUNENA_USERNAMECANCHANGE_DESC;
		?>
		</td>
	</tr>
...
<input type="hidden" name="task" value="showConfig" /> <input
	type="hidden" name="option" value="<?php
		echo $option;
		?>" /></form>
</div>
<!-- closed div#fnconfigcover -->
<?php
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	...
	<tr>
		<td><textarea cols="100" rows="20" name="csscontent"><?php
		echo $content;
		?></textarea></td>
	</tr>
...
<table class="adminlist" border=0 cellspacing=0 cellpadding=3
	...
	<tr class="row<?php
		...
		<td width="*"><?php
				echo html_entity_decode_utf8 ( stripslashes ( $pl->signature ) );
				?>&nbsp;
		</td>
	</tr>
...
<input type="hidden" name="order" value="<?php
	...
	value="<?php
		echo $option;
		?>"> <input type="hidden" name="task" value="showprofiles"> <input
	type="hidden" name="boxchecked" value="0"> <input type="hidden"
	name="limitstart" value="0"></form>
<?php
...
<form action="index.php" method="post" name="adminForm">
<table cellpadding="4" class="adminheading" cellspacing="0" border="0"
	width="100%">
	<tr>
...
<table class="adminlist" border=0 cellspacing=0 cellpadding=3
	...
	<tr class="row<?php
		...
		<td width="20"><a
			href="index.php?option=com_kunena&task=userprofile&do=show&user_id=<?php
				echo $pl->id;
				?>"><?php
				echo $pl->id;
				?></a>&nbsp;</td>
...
<input type="hidden" name="option" value="<?php
	...
	type="hidden" name="task" value="newmoderator"> <input type="hidden"
	name="limitstart" value="0"></form>
...
<table border=0 cellspacing=0 width="100%" align="center"
	...
	<tr>
		...
		<td align="left" valign="top" class="contentpane"><textarea rows="6"
			class="inputbox"
...
<input type="hidden" name="uid" value="<?php
		echo $uid;
		?>"> <input type="hidden" name="task" value="" /> <input type="hidden"
	name="option" value="com_kunena" /></form>
...
<table class="adminform" cellpadding="4" cellspacing="0" border="0"
	...
	<tr>
		<td colspan="2"><?php
		echo _COM_A_PRUNE_DESC?></td>
	</tr>
	<tr>
		<td nowrap width="10%"><?php
		echo _COM_A_PRUNE_NAME?></td>
		<td nowrap><?php
		echo $forumList ['forum']?></td>
	</tr>
	<tr>
		<td nowrap width="10%"><?php
		echo _COM_A_PRUNE_NOPOSTS?></td>

		<td nowrap><input type="text" name="prune_days" value="30">
		<?php
		echo _COM_A_PRUNE_DAYS?></td>
	</tr>
</table>
<input type="hidden" name="task" value="" /> <input type="hidden"
	name="option" value="<?php
		echo $option;
		?>" /></form>
<?php
	}
...
<form action="index.php" method="post" name="adminForm">
<fieldset><legend><?php
		echo _KUNENA_SYNC_USERS_OPTIONS;
		?></legend>
<table cellpadding="4" class="fbadminform" cellspacing="0" border="0"
	width="100%">
	<tr>
		<td><?php
		echo _KUNENA_SYNC_USERS_CACHE;
		?></td>
		<td><input type="checkbox" name="usercache" value="1"
			checked="checked" /></td>
		<td><?php
		echo _KUNENA_SYNC_USERS_CACHE_DESC;
		?></td>
	</tr>

	<tr>
		<td><?php
		echo _KUNENA_SYNC_USERS_ADD;
		?></td>
		<td><input type="checkbox" name="useradd" value="1" /></td>
		<td><?php
		echo _KUNENA_SYNC_USERS_ADD_DESC;
		?></td>
	</tr>
	<tr>
		<td><?php
		echo _KUNENA_SYNC_USERS_DEL;
		?></td>
		<td><input type="checkbox" name="userdel" value="1" /></td>
		<td><?php
		echo _KUNENA_SYNC_USERS_DEL_DESC;
		?></td>
	</tr>
	<tr>
		<td><?php
		echo _KUNENA_SYNC_USERS_RENAME;
		?></td>
		<td><input type="checkbox" name="userrename" value="1" /></td>
		<td><?php
		echo _KUNENA_SYNC_USERS_RENAME_DESC;
		?></td>
	</tr>
</table>
</fieldset>
...
<?php
		...
		for($i = 0; $i < count ( $uploaded ); $i ++) {
			...
			echo $type ? '<a href="javascript:decision(\'' . _COM_A_IMGB_CONFIRM . '\',\'index.php?option=' . $option . '&task=replaceImage&OxP=2&img=' . $uploaded [$i] . '\')">' . _COM_A_IMGB_REMOVE . '</a><br />' : '<a href="javascript:decision(\'' . _COM_A_IMGB_CONFIRM . '\',\'index.php?option=' . $option . '&task=deleteFile&fileName=' . $uploaded [$i] . '\')">' . _COM_A_IMGB_REMOVE . '</a><br />';
...
<div class="fbfunctitle"><?php
		echo _KUNENA_EMOTICONS_EDIT_SMILEY;
		?></div>
<form action="index.php" method="POST" name="adminForm">
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="adminform">
	...
	<tr>
		<td width="100"><?php
		echo _KUNENA_EMOTICONS_EMOTICONBAR;
		?></td>
...
<div class="fbfunctitle"><?php
		echo _KUNENA_EMOTICONS_NEW_SMILEY;
		?></div>
<form action="index.php" method="POST" name="adminForm">
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="adminform">
...
<table class="adminlist" border=0 cellspacing=0 cellpadding=3
	...
	<tr>
		...
		?>);" /></th>
		<th align="left"><?php
		echo _KUNENA_RANKSIMAGE;
		?></th>
		<th align="left" nowrap="nowrap"><?php
		echo _KUNENA_RANKS;
		?></th>
		<th align="left" nowrap="nowrap"><?php
		echo _KUNENA_RANKS_SPECIAL;
		?></th>
		<th align="center" nowrap="nowrap"><?php
		echo _KUNENA_RANKSMIN;
		?></th>
		<th width="100%">&nbsp;</th>
	</tr>
	<?php
...
<input type="hidden" name="option" value="<?php
		echo $option;
		?>"> <input type="hidden" name="boxchecked" value="0"> <input
	type="hidden" name="task" value="ranks"> <input type="hidden"
	name="limitstart" value="0"></form>
