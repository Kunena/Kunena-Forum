...
/**
 * The HTML Kunena Smilies View
 *
 * @package		Kunena
 * @subpackage	com_kunena
 * @version		1.0
 */
class KunenaViewSmilies extends JView
{
	/**
	 * Display the view
	 *
	...
	function buildDefaultToolBar()
	{
		...
		JToolBarHelper::custom('smiley.unpublish', 'unpublish.png', 'unpublish_f2.png', 'Unpublish', true);
		JToolBarHelper::deleteList('', 'smiley.delete');
		JToolBarHelper::custom('smiley.edit', 'edit.png', 'edit_f2.png', 'Edit', true);
		JToolBarHelper::custom('smiley.new', 'new.png', 'new_f2.png', 'New', false);
	}
}
