...
class CKunenaViewMessage {
	...
	function display() {
		...
		if (CKunenaTools::isModerator ( $this->my->id, $this->catid )) {
			...
			$this->message_moderate = CKunenaLink::GetTopicPostLink ( 'moderatecommon', $this->catid, $this->id, CKunenaTools::showButton ( 'moderate', JText::_('COM_KUNENA_BUTTON_MODERATE') ), 'nofollow', 'buttonmod btn-left', JText::_('COM_KUNENA_BUTTON_MODERATE_LONG') );
			if ($message->hold == 1) {
...
class CKunenaView {
	...
	function getView() {
		...
		if (CKunenaTools::isModerator ( $this->my->id, $this->catid )) {
			...
			$this->thread_moderate = CKunenaLink::GetTopicPostLink ( 'moderatecommon', $this->catid, $this->id, CKunenaTools::showButton ( 'moderate', JText::_('COM_KUNENA_BUTTON_MODERATE') ), 'nofollow', 'buttonmod btn-left', JText::_('COM_KUNENA_BUTTON_MODERATE') );
		}
