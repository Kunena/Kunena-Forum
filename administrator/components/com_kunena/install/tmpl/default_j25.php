...
<div id="kunena" style="max-width:530px">
	...
	<div>
		<button id="kunena-toggle" class="btn">Details</button>
	...
	var kunenaRequest = new Request.JSON({
		...
		onSuccess: function(responseJSON, responseText) {
			...
			if (responseJSON.success) {
				...
				kunenaInstall.set('html', '<h2>Kunena Installation Failed!</h2><div>Sorry, installation failed with following error:</div><div>' + responseJSON.html + '</div>');
			}
		...
		onError: function(responseText) {
			...
			kunenaInstall.set('html', '<h2>Kunena Installation Failed!</h2><div>Sorry, installation failed with following error:</div><div>' + responseText + '</div>');
			$$('.kunena-close').removeProperty('disabled');
		},
		onFailure: function() {
