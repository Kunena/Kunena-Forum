	...
	<div class="inner">
		<span class="corners-top"><span></span></span>
			<ul class="topiclist">
				<li class="header">
					<dl class="icon">
						<dt><?php echo $this->category->id? JText::_('COM_KUNENA_EDIT_CATEGORY') : JText::_('COM_KUNENA_NEW_CATEGORY') ?></dt>
						<dd>&nbsp;</dd>
					</dl>
				</li>
			</ul>
...
<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" enctype="multipart/form-data" name="adminForm" method="post" id="categoryform" class="adminForm form-validate">
	...
	<?php echo JHTML::_( 'form.token' ); ?>
		...
		<div class="kpost-buttons">
			<button class="tk-submit-button" onclick="javascript: submitbutton('apply')" title="<?php echo JText::_( 'COM_KUNENA_APPLY_DESC') ?>"><?php echo JText::_( 'COM_KUNENA_APPLY' ) ?></button>
			<button class="tk-save-button" onclick="javascript: submitbutton('save')" title="<?php echo JText::_( 'COM_KUNENA_SAVE_DESC') ?>"><?php echo JText::_( 'COM_KUNENA_SAVE' ) ?></button>
			<button class="tk-cancel-button" onclick="javascript: submitbutton('cancel')" title="<?php echo JText::_( 'COM_KUNENA_CANCEL_DESC') ?>"><?php echo JText::_( 'COM_KUNENA_CANCEL' ) ?></button>
		</div>
