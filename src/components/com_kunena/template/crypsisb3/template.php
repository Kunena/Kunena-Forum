...
class KunenaTemplateCrypsisb3 extends KunenaTemplate
{
	...
	public function initialize()
	{
		...
		if ($fontawesome)
		{
			...
			$this->addScript('https://use.fontawesome.com/releases/v5.3.0/js/all.js', array(), array('defer' => true));
			$this->addScript('https://use.fontawesome.com/releases/v5.3.0/js/v4-shims.js', array(), array('defer' => true));
		}
