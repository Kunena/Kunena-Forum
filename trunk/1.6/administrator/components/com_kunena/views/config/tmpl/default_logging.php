...
$settings .= JHtml::_('kconfig.setting', $config->get('exclude_ips'), 'exclude_ips', 'Exclude IPs', 'Comma seperated list of IPs to exclude.', 'text', 40);
$settings .= JHtml::_('kconfig.setting', $config->get('exclude_useragents'), 'exclude_useragents', 'Exclude Useragents', 'Comma seperated list of useragents to exclude.', 'text', 40);
