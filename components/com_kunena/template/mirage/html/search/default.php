				...
				<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" name="adminForm" id="searchform" method="post">
					...
					<div class="ksearchform-leftcol">
						<fieldset class="fieldset">
							...
							<input type="text" value="<?php echo $this->escape($this->state->get('searchwords')) ?>" size="30" name="q" class="box-width ks input" id="keywords" />
					...
					<div class="ksearchform-rightcol">
						<fieldset class="fieldset">
							...
							<label class="searchlabel"><?php echo JText::_('COM_KUNENA_SEARCH_UNAME') ?>:
								<input type="text" value="<?php echo $this->escape($this->state->get('query.searchuser')); ?>" name="searchuser" class="box-width ks input kautocomplete-off" id="kusername" />
							</label>
							<br />
