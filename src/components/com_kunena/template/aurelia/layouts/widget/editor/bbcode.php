		...
		<div class="md-form form-group">
			<div class="controls tabs shadow-textarea">
				<ul id="tabs_kunena_editor" class="nav nav-tabs">
					...
					<li class="nav-link"><a id="tab-private" href="#secure_reply" data-toggle="tab"><i class="icon-locked"></i><?php echo 'Private' ?></a></li>
				</ul>
				...
				<textarea class="md-textarea form-control" name="private" id="editor-private" style="display: none;" rows="12" tabindex="7"
				         placeholder="<?php echo 'Enter your private message here' ?>"><?php if (!empty($this->message->getCategory()->topictemplate) && !$this->message->getTopic()->first_post_id && $topictemplate)
					{
						echo $this->message->getCategory()->topictemplate;
					}
					else
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p><?php echo Text::_('COM_KUNENA_EDITOR_MODAL_MAP_SETTINGS_TYPE') ?>: <select id="modal-map-type">
					...
					<?php echo Text::_('COM_KUNENA_EDITOR_MODAL_MAP_SETTINGS_CITY') ?>:
					<input name="modal-map-city" id="modal-map-city"
					       type="text" value=""
					       placeholder="<?php echo Text::_('COM_KUNENA_EDITOR_MODAL_MAP_SETTINGS_CITY_DESC') ?>"/></p>
			</div>
