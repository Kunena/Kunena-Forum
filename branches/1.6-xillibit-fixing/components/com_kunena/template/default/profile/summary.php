		...
		<div id="kprofile-leftcol">
			...
			<div id="kprofile-stats">
				<ul>
					...
					<li><a href="<?php echo CKunenaLink::GetProfileSettingsURL($this->_config, $this->user->id, '', $rel='nofollow', $redirect=false,'editjoomlaprofile'); ?>"><?php echo JText::_('COM_KUNENA_EDIT_TITLE'); ?></a></li>
