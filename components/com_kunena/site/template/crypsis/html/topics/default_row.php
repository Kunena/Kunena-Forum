...
<tr >
	...
	<td class="kcol-mid kcol-ktopictitle span6">
		...
		<div class="hasTooltip"> <span class="label label-info">Question</span>
			...
			?>
			in <?php echo $this->getCategoryLink ( $this->topic->getCategory() ,null, null, 'hasTooltip' ) ?>
		</div>
	...
	<td class="span2">
		<span class="ktopic-latest-post hasTooltip" title="<?php echo $this->topic->getLastPostAuthor() ;?>">
			<?php
