...
<form enctype="multipart/form-data" name="postform" method="post" id="postform" class="postform form-validate" action="#">
	...
	<div class="ksection">
		<h2 class="kheader"><span>Edit Post: Post Name</span></h2>
		...
		<ul class="kform kpostmessage clearfix">
			...
			<li class="kpostmessage-row krow-even">
				...
				<div class="kform-field">
					<textarea cols="50" rows="10" id="kbbcode-message" name="message" class="ktxtarea required hasTip" title="Message :: Enter your message here">Post Message</textarea>
					<!-- Hidden preview placeholder -->
					<div style="display: none;" id="kbbcode-preview"></div>
					<fieldset>
						<legend>Reason for Editing</legend>
						<input class="kinputbox hasTip" name="modified_reason" size="95" maxlength="200" type="text" title="Reason for Editing :: Enter Reason for Editing" />
					</fieldset>
				</div>
			</li>
