	...
	<div class="ksectionbody">
		<div class="fltlft">
			<div class="fltlft">
				...
				<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" name="markAllForumsRead"
					method="post">
					<input type="hidden" name="view" value="category" />
					<input type="hidden" name="task" value="markread" />
					<?php echo JHtml::_('form.token'); ?>

					<input type="submit" class="kbutton ks"
						value="<?php echo JText::_('COM_KUNENA_GEN_MARK_ALL_FORUMS_READ'); ?>" />
				</form>
			</div>
			<div class="kmessage-buttons-row">
				<?php endif; ?>
				<?php if (!empty($this->category_manage))
				{
					echo $this->category_manage;
				} ?>
			</div>
		</div>
		<div class="fltrt">
