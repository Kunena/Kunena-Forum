		...
		<tr class = "thisform">
			<td width = "100%" valign = "top" class = "thisform">
				<div id = "cpanel">
					  ...
					  <div class="icon-container">
						<div class = "icon"> <a href = "index.php?option=com_kunena&amp;task=showTemplates" title = "<?php echo JText::_('COM_KUNENA_REPORT_SYSTEM');?>"> <img src = "components/com_kunena/images/templatemanager.png"  align = "middle" border = "0"/> <span> <?php echo JText::_('Templaate Manager'); ?> </span></a> </div>
					  </div>
					  <div class="icon-container">
