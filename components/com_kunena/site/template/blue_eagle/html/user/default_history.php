...
<div class="kblock banhistory">
	<div class="kheader">
		<h2>
			<span><?php echo JText::sprintf('COM_KUNENA_BAN_BANHISTORYFOR', $this->escape($this->profile->name)); ?></span>
		</h2>
	</div>
			...
			<table class="kblock-ban">
				...
				if (!empty($this->banhistory)) :
					foreach ($this->banhistory as $userban) :
						...
						<tr class="krow2">
							<td colspan="2" class="kcol-first kpublic-reason-label">
					...
					<?php endif; ?>
						...
						<tr class="krow2">
							<td colspan="2" class="kcol-first kprivate-reason-label">
