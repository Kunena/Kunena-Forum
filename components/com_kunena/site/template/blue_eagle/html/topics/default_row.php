...
<?php if ($this->spacing) : ?>
	<tr class="hidden-phone">
		<td class="kcontenttablespacer hidden-phone" colspan="<?php echo empty($this->topicActions) ? 5 : 6 ?>">
			&nbsp;</td>
	</tr>
<?php endif; ?>
...
<tr class="<?php echo $this->getTopicClass('k', 'row') ?>">
	...
	<td class="kcol-mid kcol-ktopictitle">
		...
		<div class="ktopic-details">
			<span
				class="ktopic-category"> <?php echo JText::sprintf('COM_KUNENA_CATEGORY_X', $this->getCategoryLink($this->topic->getCategory())) ?></span>
		</div>
		<div class="ktopic-details-kcategory" style="clear:both;">
			...
			<span
				class="ktopic-by ks"><?php echo JText::_('COM_KUNENA_BY') . ' ' . $this->topic->getFirstPostAuthor()->getLink(null, null, 'nofollow', '', null, $this->topic->getCategory()->id) ?></span>
		</div>
		<div class="ktopic-details-kcategory" style="clear:both;">
			<?php if ($this->pages > 1) : ?>
	...
	<td class="kcol-mid kcol-ktopiclastpost">
		<div class="klatest-post-info">
			<?php if (!empty($this->topic->avatar)) : ?>
				<span
					class="ktopic-latest-post-avatar hidden-phone"> <?php echo $this->topic->getLastPostAuthor()->getLink($this->topic->avatar) ?></span>
			<?php endif; ?>
