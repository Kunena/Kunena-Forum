...
<form method="post" action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" class="form-horizontal">
	...
	<input type="hidden" name="id" value="<?php echo intval($this->topic->id); ?>"/>
	<?php if ($this->message) : ?>
	...
	<div class="well well-small">
		<div class="control-group">
			<label class="control-label" for="kreport-reason"><?php echo JText::_('COM_KUNENA_REPORT_REASON') ?></label>
			<div class="controls">
				<input class="input-xxlarge" type="text" name="reason" size="30" id="kreport-reason"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="kreport-msg"><?php echo JText::_('COM_KUNENA_REPORT_MESSAGE') ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<div class="controls">
				<input class="btn btn-primary" type="submit" name="Submit" value="<?php echo JText::_('COM_KUNENA_REPORT_SEND') ?>"/>
				<input class="btn" onclick="history.back()" type="button" name="button" value="<?php echo JText::_('COM_KUNENA_BACK') ?>"/>
			</div>
		</div>
	</div>
</form>
