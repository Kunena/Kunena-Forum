					...
					<td>
						<div class="kpolldesc">
							...
							<tr class="krow<?php echo (++$row)%2+1;?>">
								...
								<td class="kcol-bar"><img class="jr-forum-stat-bar" src="<?php echo $this->template->getImagePath('bar.png') ?>" height="10" width="<?php echo intval(($option->votes*300)/max($this->poll->getTotal(),1))+3; ?>" /></td>
