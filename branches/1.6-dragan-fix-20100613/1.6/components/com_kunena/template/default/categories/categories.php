	...
	<tbody id="catid_<?php
		...
		<tr
				...
				if ($this->config->shownew && $this->my->id != 0) {
					if ($subcat->new) {
						...
						if (is_file ( KUNENA_ABSCATIMAGESPATH . $subcat->id . "_on.gif" )) {
							...
							$tmpIcon = CKunenaTools::showIcon ( 'kunreadforum', JText::_('COM_KUNENA_GEN_FORUM_NEWPOST'), JText::_('COM_KUNENA_GEN_FORUM_NEWPOST') );
						}
					} else {
						...
						if (is_file ( KUNENA_ABSCATIMAGESPATH . $subcat->id . "_off.gif" )) {
							...
							$tmpIcon = CKunenaTools::showIcon ( 'kreadforum', JText::_('COM_KUNENA_GEN_FORUM_NOTNEW'), JText::_('COM_KUNENA_GEN_FORUM_NOTNEW') );
						}
					}
				} else {
					...
					if (is_file ( KUNENA_ABSCATIMAGESPATH . $subcat->id . "_notlogin.gif" )) {
						...
						$tmpIcon = CKunenaTools::showIcon ( 'knotloginforum', JText::_('COM_KUNENA_GEN_FORUM_NOTNEW'), JText::_('COM_KUNENA_GEN_FORUM_NOTNEW') );
					}
				}
			...
			<div class="kthead-title kl"><?php
				...
				if ($subcat->locked) {
					echo CKunenaTools::showIcon ( 'kforumlocked', JText::_('COM_KUNENA_GEN_LOCKED_FORUM'), JText::_('COM_KUNENA_GEN_LOCKED_FORUM') );
				}

				if ($subcat->review) {
					echo CKunenaTools::showIcon ( 'kforummoderated', JText::_('COM_KUNENA_GEN_MODERATED'), JText::_('COM_KUNENA_GEN_MODERATED') );
				}
				?>
			</div>
							...
							if ($this->config->shownew && $this->my->id != 0) {
								if ($childforum->new) {
									...
									if (is_file ( KUNENA_ABSCATIMAGESPATH . $childforum->id . "_on_childsmall.gif" )) {
										...
										echo CKunenaTools::showIcon ( 'kunreadforum-sm', JText::_('COM_KUNENA_GEN_FORUM_NEWPOST'), JText::_('COM_KUNENA_GEN_FORUM_NEWPOST') );
									}
								} else {
									// Check Read Cat Images
									if (is_file ( KUNENA_ABSCATIMAGESPATH . $childforum->id . "_off_childsmall.gif" )) {
										...
										echo CKunenaTools::showIcon ( 'kreadforum-sm', JText::_('COM_KUNENA_GEN_FORUM_NOTNEW'), JText::_('COM_KUNENA_GEN_FORUM_NOTNEW') );
									}
								}
							} // Not Login Cat Images
else {
								if (is_file ( KUNENA_ABSCATIMAGESPATH . $childforum->id . "_notlogin_childsmall.gif" )) {
									...
									echo CKunenaTools::showIcon ( 'knotloginforum-sm', JText::_('COM_KUNENA_GEN_FORUM_NOTNEW'), JText::_('COM_KUNENA_GEN_FORUM_NOTNEW') );
								}
								?>
