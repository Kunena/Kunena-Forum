...
class KunenaAdminModelConfig extends KunenaModel {
	function getConfiglists() {
		...
		$showstats_list[] = JHtml::_('select.option', '0', JText::_('COM_KUNENA_NOBODY'));
		$showstats_list[] = JHtml::_('select.option', '1', JText::_('COM_KUNENA_EVERYBODY'));
		$showstats_list[] = JHtml::_('select.option', '2', JText::_('COM_KUNENA_OPTION_USERS_ONLY'));
