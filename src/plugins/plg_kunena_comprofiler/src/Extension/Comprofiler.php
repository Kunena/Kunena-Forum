...
class Comprofiler extends CMSPlugin implements SubscriberInterface, DatabaseAwareInterface
{
     ...
     * @since   Kunena 6.0
     */
    public $minCBVersion = '2.11.0+build.2026.04.17.15.58.10.fe6bcab9e';
    ...
    public function __construct(array $config = [])
    {
        ...
        if (!(class_exists('Kunena\Forum\Libraries\Forum\KunenaForum') && KunenaForum::isCompatible('7.1') && KunenaForum::enabled())) {
            return;
        }
