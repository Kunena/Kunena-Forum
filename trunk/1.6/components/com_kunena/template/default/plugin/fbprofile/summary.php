  ...
  <thead>
    <tr>
      <th colspan = "2"> <div class = "fb_title_cover fbm"> <span class = "fb_title fbl"><?php echo _KUNENA_MYPROFILE_SUMMARY; ?></span> </div>
       <img id = "BoxSwitch_fbusersummary__<?php echo KUNENA_BOARD_CLASS ;?>fbusersummary_tbody" class = "hideshow" src = "<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt = ""/>
      </th>
    </tr>
  </thead>
  <tbody  class = "fb_myprofile_general" id = "<?php echo KUNENA_BOARD_CLASS ;?>fbusersummary_tbody">
    <tr class="fb_sth fbs">
      <th colspan="2" > <center>
