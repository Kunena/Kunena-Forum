							...
							<tr>
								<th width="5%" class="nowrap">
									<small>
										<?php if ($changeOrder)
										{
											echo JHtml::_('grid.order', $this->categories, 'filesave.png', 'saveorder');
										} ?>
										...
										<td class="center nowrap">
											<div class="input-prepend input-append order">
												<?php if ($changeOrder) : ?>
													...
													<?php endif ?>
													<input class="input-micro center" type="text"
														name="order[<?php echo intval($category->id) ?>]"
														value="<?php echo intval($category->ordering); ?>" />
													<?php if ($category->up) : ?>
														<a class="jgrid btn" type="button"
													...
													<?php endif ?>
												<?php else : ?>
													<input class="input-micro  center" disabled="disabled" type="text"
														name="order[<?php echo intval($category->id) ?>]"
														value="<?php echo intval($category->ordering); ?>" />
												<?php endif ?>
											</div>
