  ...
  <thead>
    <tr>
      <th colspan = "2"> <div class = "fb_title_cover fbm"> <span class = "fb_title fbl"><?php echo _KUNENA_MYPROFILE_SUMMARY; ?></span> </div>
       <img id = "BoxSwitch_fbusersummary__fb_fbusersummary_tbody" class = "hideshow" src = "<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt = ""/>
      </th>
    </tr>
  </thead>
  <tbody  class = "fb_myprofile_general" id = "fb_fbusersummary_tbody">
    <tr class="fb_sth fbs">
      <th colspan="2" > <center>
